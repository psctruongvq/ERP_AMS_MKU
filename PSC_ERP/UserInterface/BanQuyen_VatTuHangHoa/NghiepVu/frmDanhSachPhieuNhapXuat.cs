...
{
    //23/04/2013
    public partial class frmDanhSachPhieuNhapXuat : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmDanhSachPhieuNhapXuat()
        {
            InitializeComponent();

        }

        public frmDanhSachPhieuNhapXuat(bool laNhap, int loaiPhieu)
        {
            InitializeComponent();
            _laNhap = laNhap;
        ...
        private void btnThemMoi_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                frm = new frmPhieuNhapBanQuyen();
            }
            else if (_loaiPhieu == 1 && _laNhap == false)
            {
                frm = new FrmPhieuXuatBanQuyen();
            }
            else if (_loaiPhieu == 2 && _laNhap == true)
            {
                frm = new frmPhieuNhapVatTuHangHoa();
            }
            else if (_loaiPhieu == 2 && _laNhap == false)
            {
                frm = new FrmPhieuXuatVatTuHangHoa();
            }
            else if (_loaiPhieu == 3 && _laNhap == true)
            {
                frm = new frmPhieuNhapCongCuDungCu();
            }
            else if (_loaiPhieu == 3 && _laNhap == false)
            {
                frm = new frmPhieuXuatPhanBoCCDC();
            }
            else if (_loaiPhieu == 4 && _laNhap == true)
            {
                frm = new frmPhieuNhapBoSungGiaTri();
            }
            else if (_loaiPhieu == 4 && _laNhap == false)
            {
                frm = new frmPhieuXuatBoSungGiaTri();
            }
