...
using System.IO;
//12/06/2014 Copy tu Phieu Nhap Ban Quyen
namespace PSC_ERP
{
    public partial class frmPhieuNhapBoSungGiaTri : DevExpress.XtraEditors.XtraForm
    {
        ...
        DataView clone = null;//--
        //
        public frmPhieuNhapBoSungGiaTri()
        {
            InitializeComponent();
            KhoiTao();
            KhoiTaoPhieu();
        ...
        public frmPhieuNhapBoSungGiaTri(PhieuNhapXuat phieuNhapXuat)
        {
            InitializeComponent();
            KhoiTao();
        ...
        private void barBt_LapPhieuXuat_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            else
            {
                ...
                if (giaTri != 0)
                {
                    ...
                    frmPhieuXuatBoSungGiaTri frm = new frmPhieuXuatBoSungGiaTri(phieuNhapXuat, 1, true);
                    //frm.ShowDialog();//(1)
                    if (frm.ShowDialog() != System.Windows.Forms.DialogResult.OK)
                    {
                        CheckPhieuNhap();
                ...
                {
                    frmPhieuXuatBoSungGiaTri frm = new frmPhieuXuatBoSungGiaTri(_phieuNhapXuat, 2, true);
                    //frm.ShowDialog();//(1)
                    if (frm.ShowDialog() != System.Windows.Forms.DialogResult.OK)
                    {
                        CheckPhieuNhap();
