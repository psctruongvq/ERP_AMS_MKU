...
namespace PSC_ERP
{
    public partial class frmPhieuXuatPhanBoCCDC : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmPhieuXuatPhanBoCCDC(PhieuNhapXuat phieuNhapXuat, byte loai)
        {
            InitializeComponent();
            _loai = loai;
            KhoiTao();
