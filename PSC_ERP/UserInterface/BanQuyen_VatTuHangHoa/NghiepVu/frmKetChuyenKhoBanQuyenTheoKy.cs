...
namespace PSC_ERP
{
    public partial class frmKetChuyenKhoBanQuyenTheoKy : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmKetChuyenKhoBanQuyenTheoKy()
        {
            InitializeComponent();
                ...
                else
                {
                    ...
                    else//Khi DS Bo Phan chon k rong
                    {
                                        ...
                                        if (_kiemTraBoPhanKC)
                                        {
                                            ...
                                            if (_kiemTraKhoKC)
                                            {
                                                using (SqlCommand cm1 = cn.CreateCommand())
                                                {
                                                    ...
                                                    cm1.CommandText = "Spd_KetChuyenKhoBanQuyenTheoKy";
                        ...
                        if (dsBPchuaKetChuyen.Length > 1)
                        {
                            ...
                            MessageBox.Show(string.Format("Kết Chuyển [{0}] Thành Công!", dsBPchuaKetChuyen), "Thông Báo");
                        }
                        if (dsBPdaKetChuyen.Length > 1)
                        {
                            dsBPdaKetChuyen.Remove(dsBPdaKetChuyen.Length - 1, 1);
                            MessageBox.Show(string.Format("[{0}] đã Kết Chuyển trong kỳ này! Nếu muốn Kết Chuyển lại thì hãy hủy Kết Chuyển cũ", dsBPdaKetChuyen), "Thông Báo");
                        }
                    }
                        ...
                        if (KiemTraKhoaSo(_ngayKetThuc))
                        {
                            ...
                            if (kq == DialogResult.Yes)
                            {
                                        ...
                                        try
                                        {
                                            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
                                            {
                                                ...
                                                if (_kiemTraBoPhanKC)
                                                {
                                                    ...
                                                    {
                                                        MessageBox.Show(string.Format("[{0}] Đã Kết Chuyển Cho Kỳ Sau! Không Thể Hủy", pb.TenBoPhan), "Thông Báo");
                                                    }
                                                }
                                ...
                                if (dsBPHuyKetChuyenT.Length > 1)
                                {
                                    ...
                                    MessageBox.Show(string.Format("[{0}] Đã Hủy Kết Chuyển Cũ Thành Công!", dsBPHuyKetChuyenT), "Thông Báo");
                                }
                                if (dsBPHuyKetChuyenF.Length > 1)
                                {
                                    dsBPHuyKetChuyenT.Remove(dsBPHuyKetChuyenT.Length - 1, 1);
                                    MessageBox.Show(string.Format("[{0}] Hủy Kết Chuyển Cũ Thất Bại!", dsBPHuyKetChuyenF), "Thông Báo");
                                }
                            }
                            //
                        }
