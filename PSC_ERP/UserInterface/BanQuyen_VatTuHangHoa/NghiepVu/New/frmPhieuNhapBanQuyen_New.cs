...
namespace PSC_ERP
{
    public partial class frmPhieuNhapBanQuyen_New : DevExpress.XtraEditors.XtraForm
    {
        ...
        DataView clone = null;//--
        //
        public frmPhieuNhapBanQuyen_New()
        {
            InitializeComponent();
            KhoiTao();
            KhoiTaoPhieu();
        ...
        public frmPhieuNhapBanQuyen_New(PhieuNhapXuat phieuNhapXuat)
        {
            InitializeComponent();
            KhoiTao();
        ...
        private void barBt_LapPhieuXuat_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            else
            {
                ...
                if (giaTri != 0)
                {
                    ...
                    FrmPhieuXuatBanQuyen_New frm = new FrmPhieuXuatBanQuyen_New(phieuNhapXuat, 1, true);
                    //frm.ShowDialog();//(1)
                    if (frm.ShowDialog() != System.Windows.Forms.DialogResult.OK)
                    {
                        CheckPhieuNhap();
                ...
                {
                    FrmPhieuXuatBanQuyen_New frm = new FrmPhieuXuatBanQuyen_New(_phieuNhapXuat, 2, true);
                    //frm.ShowDialog();//(1)
                    if (frm.ShowDialog() != System.Windows.Forms.DialogResult.OK)
                    {
                        CheckPhieuNhap();
