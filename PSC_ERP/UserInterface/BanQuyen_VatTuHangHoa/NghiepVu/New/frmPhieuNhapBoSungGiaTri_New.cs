...
using System.IO;
//12/04/2013 Copy tu Phieu Nhap Ban Quyen
namespace PSC_ERP
{
    public partial class frmPhieuNhapBoSungGiaTri_New : DevExpress.XtraEditors.XtraForm
    {
        ...
        DataView clone = null;//--
        //
        public frmPhieuNhapBoSungGiaTri_New()
        {
            InitializeComponent();
            KhoiTao();
            KhoiTaoPhieu();
        ...
        #region frmPhieuNhapBoSungGiaTri(PhieuNhapXuat phieuNhapXuat)
        public frmPhieuNhapBoSungGiaTri_New(PhieuNhapXuat phieuNhapXuat)
        {
            InitializeComponent();
            KhoiTao();
        ...
        private void btnSaoChepChungTu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (_phieuNhapXuat.IsNew)
            {
                frmDSPhieuNhapXuatBanQuyen frm = new frmDSPhieuNhapXuatBanQuyen(4, true);
                if (frm.ShowDialog() != DialogResult.OK)
                {
                    _phieuNhapXuat = PhieuNhapXuat.NewPhieuNhapXuat(frm.PhieuNhapXuat, dateEdit_NgayLap.DateTime);
                    foreach(CT_PhieuNhap ct in _phieuNhapXuat.CT_PhieuNhapList)
                    {
                        ct.DonGia = 0;
                        ct.SoLuong = 0;
                    }
        ...
        private void barBt_LapPhieuXuat_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            else
            {
                ...
                if (giaTri != 0)
                {
                    ...
                    frmPhieuXuatBoSungGiaTri_New frm = new frmPhieuXuatBoSungGiaTri_New(phieuNhapXuat, 1, true);
                    //frm.ShowDialog();//(1)
                    if (frm.ShowDialog() != System.Windows.Forms.DialogResult.OK)
                    {
                        CheckPhieuNhap();
                ...
                {
                    frmPhieuXuatBoSungGiaTri_New frm = new frmPhieuXuatBoSungGiaTri_New(_phieuNhapXuat, 2, true);
                    //frm.ShowDialog();//(1)
                    if (frm.ShowDialog() != System.Windows.Forms.DialogResult.OK)
                    {
                        CheckPhieuNhap();
