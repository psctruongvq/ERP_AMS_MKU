...
namespace PSC_ERP
{
    public partial class FrmPhieuXuatBanQuyen_New : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FrmPhieuXuatBanQuyen_New()
        {
            InitializeComponent();
            KhoiTaoN();
            KhoiTaoPhieu();
        ...
        public FrmPhieuXuatBanQuyen_New(PhieuNhapXuat phieuNhap, int kieu)
        {
            InitializeComponent();
            KhoiTaoN();
        ...
        public FrmPhieuXuatBanQuyen_New(PhieuNhapXuat phieuNhap, int kieu, bool XuatThangtu1PhieuNhap)
        {
            InitializeComponent();
            KhoiTaoN();
            KhoiTaoPhieu(phieuNhap, kieu);
