...
namespace PSC_ERP
{
    public partial class frmCongThucMauBieuBaoCao : Form
    {
        BangKQHDKDH _bangKQ;
        ...
        public frmCongThucMauBieuBaoCao(int tt, int loaibm)
        {
            InitializeComponent();
        ...
        {
            frmCT_CongThucMauBieuBaoCao dlg = new frmCT_CongThucMauBieuBaoCao((BangKQHDKDH)(tblBangKQKDHD.Current));
            dlg.ShowDialog();
        }
        ...
        private void FormatForm()
        {
            if (_loaiBM == 8)
            {
                this.Text=this.Text+" Quyết Toán Kinh Phí Hoạt Động - Mẫu B01-BCQT";
            }
            else if (_loaiBM==9)
            {
                this.Text = this.Text + " Chi Tiết Kinh Phí Chương Trình, Dự Án - Mẫu F01-02/BCQT";
            }
        }
        ...
        private void menuItemThemCongThuc_Click(object sender, EventArgs e)
        {
            ...
            frmCT_CongThucMauBieuBaoCao frm = new frmCT_CongThucMauBieuBaoCao();
            BangKQHDKDH obj;
            if (MaChiTiet == 0) //node của bảng cha
            {
                obj = (BangKQHDKDH)(tblBangKQKDHD.Current);
                frm = new frmCT_CongThucMauBieuBaoCao(obj);
        ...
        private void menuItemSuaCongThuc_Click(object sender, EventArgs e)
        {
            ...
            else //node của bảng con
            {
                ...
                frm = new frmCT_CongThucMauBieuBaoCao(obj, "SUA", indexChildNode);
                frm.ShowDialog();
        ...
        private void frmCongThucMauBieuBaoCao_Load(object sender, EventArgs e)
        {
            treeList.ExpandAll();
        }
