...
namespace PSC_ERP
{
    public partial class FrmChungTuMuaNgoaiTe : XtraForm
    {
        #region Properties
        ...
        {
            Tab1_xtraTabPage2.PageVisible = true;//DenNghi
        ...
        private void TaoBindingDeNghiChuyenKhoan()
        {
            ...
            //}
            if (_ChungTu.LoaiChungTuDiKem == 4)
            {
        ...
        private void DesignGrid_ButToan()
        {
            ...
            HamDungChung.ShowFieldGridViewDev(gridView_ButToan, new string[] { "DienGiai", "NoTaiKhoan", "CoTaiKhoan", "SoTienNgoaiTe", "SoTien", "DoiTuongNo", "DoiTuongCo", "MaDonVi", "IDKhoanMuc", "MaHopDong" },
                                new string[] { "Nội dung", "Nợ Tài Khoản", "Có Tài Khoản", "Số tiền ngoại tệ", "Số Tiền", "Đối tượng nợ", "Đối tượng có", "Đơn vị", "Thuộc khoản mục", "Số hợp đồng" },
                                             new int[] { 150, 80, 80, 90, 90, 120, 120, 100, 100, 100 });
            ...
            HamDungChung.AlignHeaderColumnGridViewDev(gridView_ButToan, new string[] { "DienGiai", "NoTaiKhoan", "CoTaiKhoan", "SoTienNgoaiTe", "SoTien", "DoiTuongNo", "DoiTuongCo", "MaDonVi", "IDKhoanMuc", "MaHopDong" }, DevExpress.Utils.HorzAlignment.Center);
        ...
        private void DesignGrid_DSDeNghiChuyenKhoan()
        {
            ...
            HamDungChung.ShowFieldGridViewDev(gridView_DSDeNghi, new string[] { "SoChungTuRef", "TenDoiTuong", "NoiDung", "SoTienNgoaiTe", "SoTien" },
                                new string[] { "Số chứng từ", "Đối tượng", "Nội dung", "Số tiền ngoại tệ", "Số tiền" },
                                             new int[] { 80, 100, 140, 90, 90 });

            HamDungChung.AlignHeaderColumnGridViewDev(gridView_DSDeNghi, new string[] { "SoChungTuRef", "TenDoiTuong", "NoiDung", "SoTienNgoaiTe", "SoTien" }, DevExpress.Utils.HorzAlignment.Center);

            HamDungChung.FormatNumberTypeofColumnGridViewDev2(gridView_DSDeNghi, new string[] { "SoTien" }, "#,###.##");
            HamDungChung.ShowSummaryFooterofColumnGridViewDev2(gridView_DSDeNghi, new string[] { "SoTien" }, "{0:#,###.##}");

            HamDungChung.FormatNumberTypeofColumnGridViewDev2(gridView_DSDeNghi, new string[] { "SoTienNgoaiTe" }, "#,###.##");
            HamDungChung.ShowSummaryFooterofColumnGridViewDev2(gridView_DSDeNghi, new string[] { "SoTienNgoaiTe" }, "{0:#,###.##}");
            HamDungChung.NewRowGridViewDev(gridView_DSDeNghi);
        ...
        private void KhoiTaoChungTuMoi()
        {
            ...
            //_daLoadXong = false;
            {
                ...
                _ChungTu.BoSungChungTuKT.PhuongThucMuaNgoaiTe = 1;
                //gán bindingSource
                GanBindingSource();
                btnXoaChungTu.Visibility = DevExpress.XtraBars.BarItemVisibility.Never;
                _maDoiTuongDeNghi = 0;
            ...
            _ChungTu.BoSungChungTuKT.MucDichMuaNgoaiTe = 4;
            //đã load xong
            //_daLoadXong = true;
            //MucDichSuDungradioGroup.it
        ...
        private void LoadDoiTuongList()
        {
            try
            {
                if (this._daLoadXong == true) return;
        ...
        public bool Method_GiayDeNghiBanNgoaiTe()//Giấy Đề Nghị Bán Ngaoị Tệ
        {
            ...
            using (SqlConnection cn = new SqlConnection(ERP_Library.Database.ERP_Connection))
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "spd_Report_GiayDeNghiBanNgoaiTe";
                    cm.Parameters.AddWithValue("@MaChungTu", _ChungTu.MaChungTu);
                    SqlDataAdapter da = new SqlDataAdapter(cm);
                    DataTable dt = new DataTable();
                    da.Fill(dt);
        ...
        private void XuLyDoiTuongTheoDoi(ButToan currentButToan)
        {
            ...
            if (taiKhoanNo.MaTaiKhoan != 0)
            {
                ...
                {
                    currentButToan.DoiTuongNo = _maDoiTuongDeNghi; //--_ChungTu.DoiTuong;
                }
            ...
            if (taiKhoanCo.MaTaiKhoan != 0)
            {
                ...
                {
                    currentButToan.DoiTuongCo = _maDoiTuongDeNghi; //--_ChungTu.DoiTuong;
                }
            }
        ...
        public FrmChungTuMuaNgoaiTe(ChungTuCustomize chungtuCus)
        {
            InitializeComponent();
        ...
        public FrmChungTuMuaNgoaiTe()
        {
            InitializeComponent();
        }

        public FrmChungTuMuaNgoaiTe(ChungTu chungTu)
        {
        ...
        public FrmChungTuMuaNgoaiTe(long maChungTu)
        {
            InitializeComponent();
            ...
            _ngayLapCu = _ChungTu.NgayLap.Year > 1900 ? _ChungTu.NgayLap : _ChungTu.NgayThucHien;
            _LoaiChungTu = LoaiChungTuDev.GetLoaiChungTuDevByMaQuanLy("GBNT");
            _taoMoiChungTu = false;
            _maChungTuGhiTangCuCanXemLai = _ChungTu.MaChungTu;
            TongTien = _ChungTu.Tien.ThanhTien;
            soTien = _ChungTu.Tien.SoTien;
        ...
        public void ShowChungTuMuaNgoaiTe()
        {
            _LoaiChungTu = LoaiChungTuDev.GetLoaiChungTuDevByMaQuanLy("GBNT");
            FormatForm();
            _taoMoiChungTu = true;
        ...
        private void btnPrintA4_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            else if (_LoaiChungTu.MaLoaiCTQuanLy == "GBNT")//Giấy Bán Ngoại Tệ
            {
                ReportTemplate _report = ReportTemplate.GetReportTemplate("ID_Report_GiayDeNghiBanNgoaiTe");
                if (_report != null)
                {
                    DateTime dtDenNgay = DateTime.Today;
                    frmReport frm = new frmReport();
        ...
        private void tlslblThemDN_Click(object sender, EventArgs e)
        {
            ...
            if (frm.ShowDialog() != DialogResult.OK)
            {
                ...
                if (chungTuReferencelistSelected.Count != 0)//M
                {
                    ...
                    ChungTu objCT = ChungTu.GetChungTu(chungTuReferencelistSelected[0].MaChungTu);
                    _ChungTu.BoSungChungTuKT.MaTaiKhoanNH = objCT.BoSungChungTuKT.MaTaiKhoanNH;
        ...
        private void FrmChungTuMuaNgoaiTe_Load(object sender, EventArgs e)
        {
            this.ReadOnlyConTrolByStatus(this.strStatus);
