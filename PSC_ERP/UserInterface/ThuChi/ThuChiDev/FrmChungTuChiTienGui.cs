...
namespace PSC_ERP
{
    public partial class FrmChungTuChiTienGui : XtraForm
    {
        #region Properties
        ...
        TK_NganHangList _tk_NganHangDoiTuongList = TK_NganHangList.NewTK_NganHangList();
        ...
        private void FormatForm()
        {
            ...
            else if (_LoaiChungTu.MaLoaiCTQuanLy == "PC111")
            {
                ...
                btnlapChungTuBienLai.Visibility = DevExpress.XtraBars.BarItemVisibility.Always;
                btnlapChungTuBienLai.Caption = "Lập Chứng từ hoàn phí";
        ...
        private void LoadDaTa()
        {
            ...
            //_nhanVienList = NhanVienList.GetNhanVienList_Ma_Ten();
            //_nhanVien = NhanVien.NewNhanVien(0, "");
            ...
            TaiKhoanNganHangCongTyList _TKNHCongTyList = TaiKhoanNganHangCongTyList.NewTaiKhoanNganHangCongTyList();
            _TKNHCongTyList = ERP_Library.ThanhToan.TaiKhoanNganHangCongTyList.GetTaiKhoanNganHangCongTyList();
            TaiKhoanNganHangCongTyChild _TKNHCongTy = TaiKhoanNganHangCongTyChild.NewTaiKhoanNganHangCongTy("");
            _TKNHCongTyList.Insert(0, _TKNHCongTy);
            TKNganHangCongTyList_bindingSource1.DataSource = _TKNHCongTyList;
            //TaiKhoanNganHangDoiTuong
            _tk_NganHangDoiTuongList = TK_NganHangList.NewTK_NganHangList();
            TK_NganHang tknhEmpt = TK_NganHang.NewTK_NganHang("");
            _tk_NganHangDoiTuongList.Insert(0, tknhEmpt);
            TKNganHangDoiTuongbindingSource.DataSource = _tk_NganHangDoiTuongList;
            if (_taoMoiChungTu)
            {
                KhoiTaoChungTuMoi();
            }
        ...
        private void KhoiTao()
        {
            ...
            TKNganHangDoiTuongbindingSource.DataSource = typeof(TK_NganHangList);
        ...
        private void DesignGrid_ButToan()
        {
            ...
            HamDungChung.ShowFieldGridViewDev(gridView_ButToan, new string[] { "DienGiai", "NoTaiKhoan", "CoTaiKhoan", "SoTienNgoaiTe", "SoTien", "DoiTuongNo", "DoiTuongCo", "MaDonVi", "IDKhoanMuc", "MaHopDong", "SoHoaDonThamChieu", "MaNhanVien" },
                                new string[] { "Nội dung", "Nợ Tài Khoản", "Có Tài Khoản", "Số tiền ngoại tệ", "Số Tiền", "Đối tượng nợ", "Đối tượng có", "Đơn vị", "Thuộc khoản mục", "Số hợp đồng", "Số hóa đơn", "Mã Nhân Viên" },
                                             new int[] { 150, 80, 80, 90, 90, 120, 120, 100, 100, 100, 100, 100 });
            ...
            HamDungChung.AlignHeaderColumnGridViewDev(gridView_ButToan, new string[] { "DienGiai", "NoTaiKhoan", "CoTaiKhoan", "SoTienNgoaiTe", "SoTien", "DoiTuongNo", "DoiTuongCo", "MaDonVi", "IDKhoanMuc", "MaHopDong", "SoHoaDonThamChieu", "MaNhanVien" }, DevExpress.Utils.HorzAlignment.Center);
            ...
            //
            //
            RepositoryItemGridLookUpEdit NhanVien_GrdLU = new RepositoryItemGridLookUpEdit();
            HamDungChung.InitRepositoryItemGridLookUpDev2(NhanVien_GrdLU, Table_DataRS(0), "TenNhanVien", "MaNhanVien", "", true, DevExpress.XtraEditors.Controls.TextEditStyles.Standard);
            HamDungChung.ShowFieldRepositoryItemGridLookUpDev(NhanVien_GrdLU, new string[] { "TenNhanVien", "MaQLNhanVien" }, new string[] { "Tên Nhân Viên", "Mã QL" }, new int[] { 100, 150 }, false);
            HamDungChung.RegisterControlFieldGridViewDev(gridView_ButToan, "MaNhanVien", NhanVien_GrdLU);
            //
            //
        ...
        {
            HamDungChung.InitGridViewDev(gridView_DSDeNghi, false, true, GridMultiSelectMode.RowSelect, false, false, false, true);
            ...
            HamDungChung.FormatNumberTypeofColumnGridViewDev2(gridView_DSDeNghi, new string[] { "SoTien" }, "#,###.##");
            this.gridView_DSDeNghi.KeyDown += new KeyEventHandler(this.gridView_DSDeNghi_KeyDown);
        }
        ...
        private void DesignGrid_HoaDon()
        {
            ...
            HamDungChung.ShowFieldGridViewDev_Modify(ChungTu_HoaDonThanhToangridView, new string[] { "HoaDon.GhiChu", "HoaDon.MauHoaDon", "HoaDon.KyHieuMauHoaDon", "HoaDon.SoSerial", "HoaDon.SoHoaDon", "HoaDon.NgayLap", "HoaDon.NhomHHDVMuaVao", "HoaDon.ThanhTien", "HoaDon.ThueSuatVAT", "HoaDon.ThueVAT", "HoaDon.TongTien", "SoTienThanhToan", "HoaDon.MaDoiTac", "HoaDon.TenDoiTac", "HoaDon.MaSoThue", "HoaDon.DiaChi" },
                                new string[] { "Diễn giải", "Mẫu hóa đơn", "Ký hiệu mẫu HĐ", "Số serial", "Số hóa đơn", "Ngày hóa đơn", "Nhóm hóa đơn", "Tiền trước thuế", "% thuế", "Tiền Thuế", "Tiền sau thuế", "Số tiền thanh toán", "Mã đối tượng", "Tên đối tượng", "Mã số thuế", "Địa chỉ" },
        ...
        private void DesignGridControls()
        {
            ...
            DesignMaTaiKhoanNHDoiTacgridLookUpEdit();
        }
        ...
        private bool KhoaButToanTheoTaiKhoan(int mataiKhoan)
        {
            ...
            KhoaSo_MaTaiKhoanRootList khoa = KhoaSo_MaTaiKhoanRootList.GetKhoaSo_MaTaiKhoanRootList(UserId, mataiKhoan, Convert.ToDateTime(_ChungTu.NgayThucHien));
            if (khoa.Count > 0)
            {
        ...
        private void KhoiTaoChungTuMoi()
        {
            ...
            //_daLoadXong = false;
            {
                ...
                soTien = 0;
                TongTien = 0;
                _ngayLapCu = Convert.ToDateTime(_ChungTu.NgayThucHien);
        ...
        private void LoadChungTuCu(long maChungTu)
        {
...

            {
                ...
                if (_ChungTu.MaChungTu != 0)
                {
                    ...
                    LoadTaiKhoanNganHangDoiTuong(_ChungTu.DoiTuong);
                    GanBindingSource();
                    _ngayLapCu = Convert.ToDateTime(_ChungTu.NgayThucHien);
        ...
        private bool KiemTraButToanHopLe()
        {
            ...
            decimal tTThanhToanTheoDtuong = 0;
            ...
            foreach (ButToan bt in _ChungTu.DinhKhoan.ButToan)
            {
                ...
                #region Be Kiem tra ChungTu Hoa Don Thanh Toan Theo ButToan

                tTThanhToanTheoDtuong = 0;
                foreach (ChungTu_HoaDonThanhToan itemct_hd in _ChungTu.ChungTu_HoaDonThanhToanList)
                {
                    if (HeThongTaiKhoan1.GetHeThongTaiKhoan1(bt.NoTaiKhoan).SoHieuTK.StartsWith("331") && itemct_hd.HoaDon.MaDoiTac == bt.DoiTuongNo)
                    {
                        hoply = true;
                        tTThanhToanTheoDtuong += itemct_hd.SoTienThanhToan;
                    }
                }
                //if (hoply && tTThanhToanTheoDtuong != 0 && tTThanhToanTheoDtuong != bt.SoTien)
                //{
                //    MessageBox.Show(this, "Hạch toán Chứng từ không bằng tổng tiền thanh toán của Hóa đơn!", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                //    return false;
                //}

                #endregion//End Kiem tra ChungTu Hoa Don Thanh Toan Theo ButToan

            }

            if (hoply && tTThanhToanTheoDtuong != 0 && tTThanhToanTheoDtuong > tongtienButToan) //tien thanh toan hóa đơn đc phép nhỏ hơn tiền hạch toán: Thương yêu cầu 2018.04.18
            {
                MessageBox.Show(this, "Tổng tiền thanh toán của Hóa đơn lớn hơn tiền hạch toán chứng từ!", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return false;
            }
        ...
        private bool KhoaSoThue()
        {
            ...
            KhoaSo_UserList khoa = KhoaSo_UserList.GetKhoaSo_UserListByNgayLap(Convert.ToDateTime(_ChungTu.NgayThucHien));
            if (khoa.Count > 0)
            {
        ...
        private Boolean DuocPhepLuu()
        {
            ...
            if (dtmp_Ngay.Text != "" && (MaTaiKhoanNHgridLookUpEdit.EditValue == null || (int)MaTaiKhoanNHgridLookUpEdit.EditValue == 0))
            {
                MessageBox.Show("Chưa chọn tài khoản ngân hàng, khổng thể thực hiện ghi sổ! Vui lòng chọn tài khoản ngân hàng, hoặc bỏ ngày ghi sổ!");
        ...
        private void LoadDataControlLienQuanTheoDoiTuong(long maDoiTuong)
        {
            if (maDoiTuong != 0)
            {
                ...
                if (_ChungTu != null && _ChungTu.ChungTu_DiaChi != null)
                {
                    ...
                    NguoiLienLacList lstNguoiLienLac = NguoiLienLacList.GetNguoiLienLacList(maDoiTuong);
                    if (lstNguoiLienLac.Count == 0)
                        NguoiNhan_textEdit1.Text = dtKhachHang.TenDoiTuong;
                    else
                        NguoiNhan_textEdit1.Text = lstNguoiLienLac[0].TenNguoiLienLac + "";
                ...
                LoadTaiKhoanNganHangDoiTuong(maDoiTuong);

            }
            else
            {
                _ChungTu.BoSungChungTuKT.MaTaiKhoanNHDoiTac = 0;
            }
        }
        ...
        private void DesignDoiTuongGridLookUpEdit()
        {
            ...
            HamDungChung.ShowFieldGridLookUpDev2(DoiTuongGridLookUpEdit, new string[] { "TenDoiTuong", "MaQLDoiTuong", "TenCongTy", "Email", }, new string[] { "Tên đối tượng", "Mã đối tượng", "Tên Công Ty", "Email", }, new int[] { 120, 90, 150, 90 }, false);
        ...
        private void LoadDataControlLienQuanTheoTaiKhoanNgangHangCongTy(int machitiet)
        {
            ...
            //    _ChungTu.BoSungChungTuKT.TenNganHang = tknh.TenNganHang;
            //}
            //else
            //{
            //    //TenNganHangNopVaotextEdit.Text = _ChungTu.BoSungChungTuKT.TenNganHang + "";
            //}
        ...
        private void LoadTaiKhoanNganHangDoiTuong(long maDoiTuong)
        {
            _tk_NganHangDoiTuongList = TK_NganHangList.GetTK_NganHangList(maDoiTuong);
            TK_NganHang tknhEmpt = TK_NganHang.NewTK_NganHang("");
            _tk_NganHangDoiTuongList.Insert(0, tknhEmpt);
            TKNganHangDoiTuongbindingSource.DataSource = _tk_NganHangDoiTuongList;
            if (_tk_NganHangDoiTuongList.Count > 1)
            {
                MaTaiKhoanNHDoiTacgridLookUpEdit.EditValue = _tk_NganHangDoiTuongList[1].MaTKNganHang;
            }
        }
        private void LoadDataControlLienQuanTheoTaiKhoanNgangHangDoiTac(int maTKnganhang)
        {

            //if (maTKnganhang != 0)
            //{
            //    TK_NganHang tknh = TK_NganHang.GetTK_NganHangByMaTKNgaHang(maTKnganhang);
            //    //TenNganHangDoiTactextEdit.Text = tknh.TenNganHang;
            //    _ChungTu.BoSungChungTuKT.TenNganHangDoiTac = tknh.TenNganHang;
            //}
            //else
            //{
            //    //TenNganHangDoiTactextEdit.Text = _ChungTu.BoSungChungTuKT.TenNganHangDoiTac + "";
            //}


        }
        private void DesignMaTaiKhoanNHDoiTacgridLookUpEdit()
        {
            HamDungChung.InitGridLookUpDev2(MaTaiKhoanNHDoiTacgridLookUpEdit, TKNganHangDoiTuongbindingSource, "SoTK", "MaTKNganHang", "", true, true, DevExpress.XtraEditors.Controls.TextEditStyles.Standard);
            HamDungChung.ShowFieldGridLookUpDev2(MaTaiKhoanNHDoiTacgridLookUpEdit, new string[] { "SoTK", "TenNganHang" }, new string[] { "Số tài khoản", "Ngân hàng" }, new int[] { 90, 120 }, false);
            MaTaiKhoanNHDoiTacgridLookUpEdit.EditValueChanged += new System.EventHandler(this.MaTaiKhoanNHDoiTacgridLookUpEdit_EditValueChanged);
        }
        #endregion //TaiKhoanNganHangDoiTuong

        #region MaTaiKhoanNHDoiTacgridLookUpEdit

        private void MaTaiKhoanNHDoiTacgridLookUpEdit_EditValueChanged(object sender, EventArgs e)
        {
            //if (MaTaiKhoanNHDoiTacgridLookUpEdit.EditValue != null)
            //{
            //    int maTKnganhangOut;
            //    if (int.TryParse(MaTaiKhoanNHDoiTacgridLookUpEdit.EditValue.ToString(), out maTKnganhangOut))
            //    {
            //        LoadDataControlLienQuanTheoTaiKhoanNgangHangDoiTac(maTKnganhangOut);
            //    }
            //}
        }

        #endregion//MaTaiKhoanNHDoiTacgridLookUpEdit
        ...
        private bool KiemTraLapHoaDonTuBienLaiHopLe(List<ChiTietBienLaiFromOtherDB> chitietbienlailistSelected)
        {
            ...
            if (_ChungTu.DoiTuong != 0)
            {
                maQLDoiTuong = DoiTuongAll.GetDoiTuongAll(_ChungTu.DoiTuong).MaQLDoiTuong;
            }
            else
            {
                maQLDoiTuong = chitietbienlailistSelected[0].MaQLDoiTuong;
            }
            ...
            foreach (ChiTietBienLaiFromOtherDB ctbienlai in chitietbienlailistSelected)
            {
                ...
                //{
                //    MessageBox.Show("Không cùng đối tượng khi hoàn phí!", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                //    return false;
                //}
        ...
        private void LapChungTuFromBienLai(byte kieuthuphiFNC)
        {
            ...
            string tendoituong = DoiTuongGridLookUpEdit.Text;
            int hinhthucthanhtoan = 0;
            if (_LoaiChungTu.MaLoaiCTQuanLy == "PC111")
            {
                hinhthucthanhtoan = 1;//TienMat
            }
            else if (_LoaiChungTu.MaLoaiCTQuanLy == "PKT" || _LoaiChungTu.MaLoaiCTQuanLy == "PC112")
            {
                hinhthucthanhtoan = 2;//ChuyenKhoan
            }
            #region Process
            FrmGetBienLaiFronOtherDB frm = new FrmGetBienLaiFronOtherDB(tendoituong, hinhthucthanhtoan, kieuthuphiFNC);
                ...
                if (chitietbienlailistSelected.Count != 0)//M
                {
                    ...
                    foreach (ChiTietBienLaiFromOtherDB ctbienlai in chitietbienlailistSelected)
                    {
                        ...
                        if (_ChungTu.DinhKhoan.ButToan.Count > 0)
                        {
                            ...
                            {
                                if (
                                    (ctbienlai.MaBienLai != Guid.Empty && item.OidMaBienLai == ctbienlai.MaBienLai && item.SoTien == ctbienlai.SoTien)
                                     ||
                                     (ctbienlai.MaBienLaiInt != 0 && item.IDBienLai == ctbienlai.MaBienLaiInt && item.SoTien == ctbienlai.SoTien)
                                    )
                                {
                                    insert = false;
                                    break;
                        ...
                        if (insert)
                        {
                            ...
                            #endregion Tao CT_HoaDonBienLai
                            #region ButToan
                    ...
                    if (soBienLaiStr.Length > 1)
                    {
                        soBienLaiStr.Remove(soBienLaiStr.Length - 1, 1);
                        _ChungTu.ChungTuKemTheo = "Re " + soBienLaiStr.ToString();
                    }
                }
            }
            #endregion//Process
        ...
        private void XuLyDoiTuongTheoDoi(ButToan currentButToan)
        {
            ...
            if (taiKhoanNo.MaTaiKhoan != 0)
            {
                ...
                if (taiKhoanNo.CoDoiTuongTheoDoi == true)
                {
                    ...
                    if (_ChungTu.ChungTu_HoaDonThanhToanList.Count > 0) //co hoa don lay theo doi tuong cua hoa don
                    {
                        if (gridView_ButToan.FocusedRowHandle >= 0 && gridView_ButToan.FocusedRowHandle < _ChungTu.ChungTu_HoaDonThanhToanList.Count)
                        {
                            currentButToan.DoiTuongNo = _ChungTu.ChungTu_HoaDonThanhToanList[gridView_ButToan.FocusedRowHandle].HoaDon.MaDoiTac;
                        }
                        else
                        {
                            currentButToan.DoiTuongNo = _ChungTu.ChungTu_HoaDonThanhToanList[0].HoaDon.MaDoiTac;
                        }
                    }
                    else
                    {
        ...
        private void inUyNhiemChi(string UNCNganHang)
        {
            if (_ChungTu.IsNew == false)
            {
                NguoiKyTen nguoiky = NguoiKyTen.GetNguoiKyTen(CurrentUser.Info.UserID);
        ...
        private void CreateTamUng(ButToan buttoan)
        {
            if (IsTaiKhoanTamUng(buttoan.NoTaiKhoan) && buttoan.DoiTuongNo != 0)
            {
                ...
                tu.DienGiai = buttoan.DienGiai;
                //tu.NgayLap = Convert.ToDateTime(_ChungTu.NgayLap);
                if (dtmp_Ngay.Text == "")
                {
                    tu.NgayLap = Convert.ToDateTime(_ChungTu.NgayThucHien);
                }
                else
                {
                    tu.NgayLap = Convert.ToDateTime(_ChungTu.NgayLap);
        ...
        private void SetValueChungTuKemTheo()
        {
            if (_ChungTu.ChungTuKemTheo.Trim().Length == 0)
            {
                StringBuilder cTKemTheoStr = new StringBuilder("");
                foreach (ChungTu_HoaDonThanhToan itemct_hd in _ChungTu.ChungTu_HoaDonThanhToanList)
                {
                    if (cTKemTheoStr.ToString().Contains(itemct_hd.HoaDon.SoHoaDon) == false)
                    {
                        cTKemTheoStr.Append(string.Format("{0},", itemct_hd.HoaDon.SoHoaDon));
                    }
                }
                if (cTKemTheoStr.Length > 1)
                {
                    cTKemTheoStr.Remove(cTKemTheoStr.Length - 1, 1);
                    _ChungTu.ChungTuKemTheo = "Hóa đơn: " + cTKemTheoStr.ToString();
                }
            }
        }
        ...
        #region Initialize
        public FrmChungTuChiTienGui()
        {
            InitializeComponent();

        }

        public FrmChungTuChiTienGui(ChungTu chungTu)
        {
        ...
        public FrmChungTuChiTienGui(ChungTuCustomize chungtuCus)
        {
            InitializeComponent();
        ...
        public FrmChungTuChiTienGui(long maChungTu)
        {
        ...
        private void gridView_ButToan_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            if (currentButToan != null && gridView_ButToan.FocusedColumn.Name == "colNoTaiKhoan" || gridView_ButToan.FocusedColumn.Name == "colCoTaiKhoan")
            {
                ...
                if (gridView_ButToan.FocusedColumn.Name == "colNoTaiKhoan")
                {
                    if (currentButToan != null && currentButToan.NoTaiKhoan != 0 && IsTaiKhoanTamUng(currentButToan.NoTaiKhoan))
                    {
                        currentButToan.DoiTuongNo = _ChungTu.DoiTuong;
                ...
                {
                    if (currentButToan.CoTaiKhoan != 0 && IsTaiKhoanTamUng(currentButToan.CoTaiKhoan))
                    {
                        currentButToan.DoiTuongCo = _ChungTu.DoiTuong;
            ...
            else if (e.KeyCode == Keys.F8)
            {
                ...
                using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
                {
                    ...
                    using (SqlCommand cm = cn.CreateCommand())
                    {
                        ...
                        if (_ChungTu.NgayThucHien.Month >= 7)
                            tuNgay = new DateTime(_ChungTu.NgayThucHien.Year, 7, 1);
                        else
                            tuNgay = new DateTime(_ChungTu.NgayThucHien.Year - 1, 7, 1);
                        ...
                        cm.Parameters.AddWithValue("@DenNgay", _ChungTu.NgayThucHien.Date);
        ...
        private void gridView_ButToan_InitNewRow(object sender, DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs e)
        {
            ...
            if (buttoan != null)
            {
                //mac dinh so tien neu la dong dau tien
                decimal soTien = 0;
                foreach (ChungTu_HoaDonThanhToan hd in this._ChungTu.ChungTu_HoaDonThanhToanList)
                {
                    soTien = soTien + hd.SoTienThanhToan;
                }
                if (_ChungTu.Tien.ThanhTien == 0)
        ...
        private void btnLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //Kiem Tra Ngay Xac Nhan UNC
            //if (_LoaiChungTu.MaLoaiCTQuanLy == "PC112"
            //    && _ChungTu.BoSungChungTuKT.NgayXacNhanUNC != DateTime.MinValue
            //    && _ChungTu.BoSungChungTuKT.NgayXacNhanUNC != null
            //    )
            //{
            //    MessageBox.Show(this, "Chứng từ đã xác nhận ngày chi, không thể lưu", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            //    return;
            //}
        ...
        private void tlslblThemDN_Click(object sender, EventArgs e)
        {
            ...
            frm.ShowDialog();
            dtmp_Ngay.DateTime = _ChungTu.NgayThucHien;
            TaoBindingDeNghiChuyenKhoan();
        }
        ...
        private void UNCVietcombankMauCoSanbarButtonItem_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            _InmauCoSan = true;
            inUyNhiemChi("Vietcombank");
        }
        ...
        private void UNCACBMauCoSanbarButtonItem_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            _InmauCoSan = true;
            inUyNhiemChi("ACB");
        }
        ...
        private void FrmChungTuChiTienGui_Load(object sender, EventArgs e)
        {
            this.ReadOnlyConTrolByStatus(this.strStatus);
        ...
        private void btnThemChungTuHoaDonMoi_Click(object sender, EventArgs e)
        {
        ...
        private DataTable Table_DataRS(int maBoPhan)
        {
            ...
            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
            {
                ...
                using (SqlCommand cm = cn.CreateCommand())
                {
                    ...
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "spd_LoadDanhSachNhanVienBS_New";
                    cm.Parameters.AddWithValue("@MaBoPhan", maBoPhan);
        ...
        #region event selectedPageChanged
        private void xtraTabControl2_SelectedPageChanged_1(object sender, DevExpress.XtraTab.TabPageChangedEventArgs e)
        {
            if ((xtraTabControl2.SelectedTabPage.Name == Tab1_xtraTabPage1.Name) && (this.isChonHoaDon == true))
            {
                ...
                if (_ChungTu.DinhKhoan.ButToan.Count > 0 && _ChungTu.ChungTu_HoaDonThanhToanList.Count <= _ChungTu.DinhKhoan.ButToan.Count)
                {
                    ...
                    {
                        _ChungTu.DinhKhoan.ButToan[i].SoTien = _ChungTu.ChungTu_HoaDonThanhToanList[i].SoTienThanhToan;
                    }
                    TinhSoTienChungTu();
                ...
                //khong gom moi nha NCC mot but toan
        ...
        private void NgayHT_dateEdit1_EditValueChanged(object sender, EventArgs e)
        {
            //if (NgayHT_dateEdit1.OldEditValue != NgayHT_dateEdit1.EditValue && _ChungTu.IsNew)
            //{
            //    dtmp_Ngay.EditValue = NgayHT_dateEdit1.EditValue;
            //    _ChungTu.SoChungTu = PublicClass.SetSoChungTuByMaLoaiChungTu(_LoaiChungTu.MaLoaiCT, _ChungTu.NgayThucHien);
        ...
        private void grdLU_LoaiTien_EditValueChanged(object sender, EventArgs e)
        {
            if (this.isLoadCboTienTe)
            {
                ...
                if (this.strStatus != "KHOA")
                {
                    ...
                    if (_ChungTu.DinhKhoan.ButToan.Count == 0)
                    {
                        _ChungTu.Tien.ThanhTien = Math.Round(_ChungTu.Tien.TiGiaQuyDoi * _ChungTu.Tien.SoTien, 0, MidpointRounding.AwayFromZero);
                    }
                    else
                    {
                        foreach (ButToan bt in _ChungTu.DinhKhoan.ButToan)
        ...
        private void btnTim_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //{
            //}
            //_ChungTuTimList = ChungTuRutGonList.GetChungTuList(_LoaiChungTu.MaLoaiCT, (Convert.ToDateTime(dtEdit_TuNgay.EditValue)).Date, (Convert.ToDateTime(dtEdit_DenNgay.EditValue)).Date);
        ...
        private void gridView_Tim_DoubleClick(object sender, EventArgs e)
        {
            this.strStatus = "KHOA";
            this.ReadOnlyConTrolByStatus(this.strStatus);
        ...
        public void Method_Report_UNC_ACB_NgoaiTe()
        {
            NguoiKyTen nguoiky = NguoiKyTen.GetNguoiKyTen(CurrentUser.Info.UserID);
        ...
        private void InUNC_ACB_NgoaiTe()
        {
            ReportTemplate _report;
            //BEGIN
            if (_InmauCoSan)
            {
                _report = ReportTemplate.GetReportTemplate("ID_Report_UNC_ACB_MauCoSan_NgoaiTe");
            }
            else
            {
                _report = ReportTemplate.GetReportTemplate("ID_Report_UNC_ACB_NgoaiTe");
            }
            if (_report != null)
            {
                DateTime dtDenNgay = DateTime.Today;
        ...
        private void btnUNCACBNgoaiTe_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            _InmauCoSan = false;
            inUyNhiemChi_NgoaiTe("ACB");
        }
    }
}