...
namespace PSC_ERP
{
    public partial class FrmChungTuThuTienMat : XtraForm
    {
        #region Properties
        ...
        public long maChungTuOfReport = 0;
        public bool isShowFromReport = false;
        ...
        private void DesignGrid_HoaDon()
        {
            ...
            HamDungChung.ShowFieldGridViewDev_Modify(ChungTu_HoaDonThanhToangridView, new string[] { "HoaDon.GhiChu", "HoaDon.MauHoaDon", "HoaDon.KyHieuMauHoaDon", "HoaDon.SoHoaDon", "HoaDon.SoSerial", "HoaDon.NgayLap", "HoaDon.ThanhTien", "HoaDon.ThueSuatVAT", "HoaDon.ThueVAT", "HoaDon.TongTien", "HoaDon.MaDoiTac", "HoaDon.TenDoiTac", "HoaDon.MaSoThue", "HoaDon.DiaChi" },
                                    new string[] { "Diễn giải", "Mẫu hóa đơn", "Ký hiệu mẫu HĐ", "Số hóa đơn", "Số serial", "Ngày hóa đơn", "Tiền trước thuế", "% thuế", "Tiền Thuế", "Tiền sau thuế", "Mã đối tượng", "Tên đối tượng", "Mã số thuế", "Địa chỉ", "Đối tượng", "Số tiền chi tiết" },
        ...
        private void LapChungTuFromBienLai(byte kieuthuphiFNC)
        {
            ...
            if (frm.ShowDialog() != DialogResult.OK)
            {
                ...
                if (chitietbienlailistSelected.Count != 0)//M
                {
                    ...
                    if (KiemTraLapHoaDonTuBienLaiHopLe(chitietbienlailistSelected) == false)
                        return;
                    ...
                    string kyHieuTruong = chitietbienlailistSelected[0].SoSeri.Substring(0, 1);
                    _ChungTu.SoChungTu = "PT" + kyHieuTruong + "-" + chitietbienlailistSelected[0].SoBienLai;
                    ...
                    foreach (ChiTietBienLaiFromOtherDB ctbienlai in chitietbienlailistSelected)
                    {
                        ...
                        if (insert)
                        {
                            ...
                            if (ctbienlai.NamHoc != "")
                            {
                                diengiai.Append(string.Format("{0},", ctbienlai.NamHoc));
                            }
        ...
        public FrmChungTuThuTienMat(ChungTuCustomize chungtuCus)
        {
            InitializeComponent();
        ...
        public FrmChungTuThuTienMat()
        {
            InitializeComponent();
        }

        public FrmChungTuThuTienMat(ChungTu chungTu)
        {
        ...
        public FrmChungTuThuTienMat(long maChungTu)
        {
            InitializeComponent();

            //this._ChungTu = ChungTu.GetChungTu(maChungTu);
            ChungTuList ct = ChungTuList.GetChungTuListByMaChungTu_New(maChungTu);
            if (ct.Count > 0)
            {
                this._ChungTu = ct[0];
                ...
                if (hoadonSelected.Count != 0)//M
                {
                    ...
                    if (_ChungTu.DinhKhoan.ButToan.Count == 0)
                    {
                        foreach (ChungTu_HoaDonThanhToan cthdtt in _ChungTu.ChungTu_HoaDonThanhToanList)
                        {
                            ...
                            bt.NoTaiKhoan = HeThongTaiKhoan1.LayMaTaiKhoan("1111");
                ...
                if (chungTuReferencelistSelected.Count != 0)//M
                {
                    ...
                    foreach (ChungTuReference itemchungturef in chungTuReferencelistSelected)
                    {
                        ...
                        if (insert)
                        {
                            ...
                            //    diengiaiChungtu.Append(string.Format("{0},", " Ngày " + itemchungturef.NgayChungTu.ToString("dd/MM/yyyy")));
                            //    diengiaiChungtu.Append(string.Format("{0},", " " + itemchungturef.NoiDung));
                            //}
                            ...
                            {
                                ButToan btadd = ButToan.NewButToan();
                                btadd.NoTaiKhoan = HeThongTaiKhoan1.LayMaTaiKhoan("1111");
                                ...
                                btadd.DienGiai = sDienGiaiChungTu + ""; // "Thu hoàn ứng: " + itemchungturef.SoChungTu + " Ngày " + itemchungturef.NgayChungTu.ToString("dd/MM/yyyy") + " " + itemchungturef.NoiDung;// itemchungturef.TenDoiTuong
                                _ChungTu.DinhKhoan.ButToan.Add(btadd);
                            }
        ...
        private void FrmChungTuThuTienMat_Load(object sender, EventArgs e)
        {
