...
namespace PSC_ERP
{
    public partial class FrmChungTuThuTienGui : XtraForm
    {
        #region Properties
        ...
        private void FormatForm()
        {
            ...
            if (_LoaiChungTu.MaLoaiCTQuanLy == "PT111")
            {
                ...
                LapChungTutuBienLaibarSubItem.Visibility = DevExpress.XtraBars.BarItemVisibility.Always;
            ...
            else if (_LoaiChungTu.MaLoaiCTQuanLy == "PC111")
            {
                ...
                LapChungTutuBienLaibarSubItem.Visibility = DevExpress.XtraBars.BarItemVisibility.Never;
        ...
        private void DesignGrid_DSDeNghiChuyenKhoan()
        {
            ...
            HamDungChung.ShowFieldGridViewDev(gridView_DSDeNghi, new string[] { "SoChungTuRef", "NgayCanTru", "TenDoiTuong", "NoiDung", "SoTien" },
                                new string[] { "Số chứng từ", "Ngay chứng từ", "Đối tượng", "Nội dung", "Số tiền" },
        ...
        private void DesignGrid_HoaDon()
        {
            ...
            //                                     new int[] { 120, 90, 100, 90, 90, 90, 90, 80, 90, 90, 95, 100, 90, 100 }, false);
        ...
        private void LoadChungTuCu(long maChungTu)
        {
...

            {
                ...
                foreach (ChungTu_HoaDonThanhToan cthdtt in _ChungTu.ChungTu_HoaDonThanhToanList)
                {
                    ...
                    //cthdtt.HoaDon.ThueSuatVAT = Convert.ToDouble(cthdtt.TienThue);                    
        ...
        private Boolean DuocPhepLuu()
        {
            ...
            if (_LoaiChungTu.MaLoaiCTQuanLy == "PT112")
            {
                if (_ChungTu.BoSungChungTuKT.MaTaiKhoanNH == 0)
                {
                    MessageBox.Show(this, "Vui lòng nhập số tài khoản ngân hàng nộp vào!", "Yêu Cầu", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void LoadDoiTuongList()
        {
            try
            {
                ...
                // doi tuong
                if (_LoaiChungTu.MaLoaiCTQuanLy.StartsWith("PT111") || _LoaiChungTu.MaLoaiCTQuanLy.StartsWith("PT112"))
                {
                ...
                else if (_LoaiChungTu.MaLoaiCTQuanLy.StartsWith("PC111") || _LoaiChungTu.MaLoaiCTQuanLy.StartsWith("PC112"))
                {
        ...
        private bool KiemTraLapHoaDonTuBienLaiHopLe(List<ChiTietBienLaiFromOtherDB> chitietbienlailistSelected)
        {
            ...
            dat = chitietbienlailistSelected[0].NgayLap.Date;
            soTKNganHang = chitietbienlailistSelected[0].SoTaiKhoan;
            ...
            foreach (ChiTietBienLaiFromOtherDB ctbienlai in chitietbienlailistSelected)
            {
                ...
                if (ctbienlai.NgayLap.Date != dat)//Không Cùng ngày
                {
                    MessageBox.Show("Không cùng ngày thu giữa các dòng được chọn!", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return false;
                }
                if (ctbienlai.SoTaiKhoan != soTKNganHang)//Không Cùng ngày
                {
                    MessageBox.Show("Không cùng số tài khoản ngân hàng giữa các dòng được chọn!", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return false;
                }
            }
            return true;
        ...
        private void LapChungTuFromBienLai(byte kieuthuphiFNC)
        {
            ...
            #region Process
            FrmGetBienLaiFronOtherDB frm = new FrmGetBienLaiFronOtherDB("", hinhthucthanhtoan, kieuthuphiFNC);
            if (frm.ShowDialog() != DialogResult.OK)
            {
                int maTKNganHangCongTy = 0;
                string strSoTKNganHang = "";
                string strMaNgoaiTe = "";
                decimal decTyGia = 1;
                decimal tongtien = _ChungTu.Tien.ThanhTien;
                StringBuilder diengiai = new StringBuilder("");
                string strNoiDung = "", strNoiDungThu = "";
                string strBienLaiTruoc = "";
                //giai quyet sai so ngoai te, vi vnd/tygia <> tien ngoai te
                //voi moi bien lai, dong cuoi cung bien lai, neu sum chi tiet - tong bien lai <=1 ngoai te, thi chinh sai so cho dong cuoi
                decimal tongTienNgoaiTeNhieuBienLai = 0;
                decimal tongTienNgoaiTeMotBienLai = 0;
                decimal sumChiTietNgoaiTeMotBienLai = 0;
                ...
                if (chitietbienlailistSelected.Count != 0)//M
                {
                    ...
                    // lay so ctu theo bien lai
                    _ChungTu.SoChungTu = "BC-" + chitietbienlailistSelected[0].SoBienLai;
                    ...
                    foreach (ChiTietBienLaiFromOtherDB ctbienlai in chitietbienlailistSelected)
                    {
                        strSoTKNganHang = ctbienlai.SoTaiKhoan;
                        strMaNgoaiTe = ctbienlai.MaNgoaiTe;

                        int intMaNgoaiTe = 0;
                        if (strMaNgoaiTe != "" && intMaNgoaiTe == 0)
                        {
                            LoaiTienList lstLoaiTien = LoaiTienList.GetLoaiTienList();
                            foreach (LoaiTien item in lstLoaiTien)
                            {
                                if (item.MaLoaiQuanLy == strMaNgoaiTe)
                                {
                                    intMaNgoaiTe = item.MaLoaiTien;
                                    break;
                                }
                            }
                            if (intMaNgoaiTe != 0)
                            {
                                _ChungTu.Tien.MaLoaiTien = intMaNgoaiTe;
                                _ChungTu.Tien.TiGiaQuyDoi = ctbienlai.TyGia;
                            }
                        }

                        if (strBienLaiTruoc == "")
                        {
                            strBienLaiTruoc = ctbienlai.SoBienLai;
                            tongTienNgoaiTeMotBienLai = Math.Round(ctbienlai.TongTienNgoaiTe, 2, MidpointRounding.AwayFromZero);
                            tongTienNgoaiTeNhieuBienLai = tongTienNgoaiTeNhieuBienLai + Math.Round(ctbienlai.TongTienNgoaiTe, 2, MidpointRounding.AwayFromZero);
                            sumChiTietNgoaiTeMotBienLai = 0;
                        }
                        else if (strBienLaiTruoc != "" && strBienLaiTruoc != ctbienlai.SoBienLai)
                        {
                            strBienLaiTruoc = ctbienlai.SoBienLai;
                            tongTienNgoaiTeMotBienLai = Math.Round(ctbienlai.TongTienNgoaiTe, 2, MidpointRounding.AwayFromZero);
                            tongTienNgoaiTeNhieuBienLai = tongTienNgoaiTeNhieuBienLai + Math.Round(ctbienlai.TongTienNgoaiTe, 2, MidpointRounding.AwayFromZero);
                        ...
                        if (_ChungTu.DinhKhoan.ButToan.Count > 0)
                        {
                            ...
                            foreach (ButToan item in _ChungTu.DinhKhoan.ButToan)
                            {
                                if (
                                     (
                                        (kieuthuphiFNC == 1)//Thu Phí
                                        &&
                                        (
                                         (ctbienlai.MaBienLai != Guid.Empty && ctbienlai.MaBienLai == item.OidMaBienLai && ctbienlai.MaChiTiet != Guid.Empty && item.OidChiTietBienLai == ctbienlai.MaChiTiet)
                                         ||
                                         (ctbienlai.MaBienLaiInt != 0 && ctbienlai.MaBienLaiInt == item.IDBienLai && ctbienlai.MaChiTietInt != 0 && item.IDChiTietBienLai == ctbienlai.MaChiTietInt)
                                        )
                                     )
                                    ||
                                    (
                                        (kieuthuphiFNC == 3)//Phí Dư
                                        &&
                                        (
                                         (ctbienlai.MaBienLai != Guid.Empty && ctbienlai.MaBienLai == item.OidMaBienLai)
                                         ||
                                         (ctbienlai.MaBienLaiInt != 0 && ctbienlai.MaBienLaiInt == item.IDBienLai)
                                        )
                                     )
                                    )
                                {
                        ...
                        if (insert)
                        {
                            ...
                            strNoiDung = ctbienlai.DienGiai + " " + ctbienlai.NamHoc;
                            if (!strNoiDungThu.Contains(ctbienlai.NoiDungThu))
                                strNoiDungThu += ctbienlai.NoiDungThu + ", ";
                            ...
                            {
                                #region Modify
                                if (ctbienlai.TienPos != 0)
                                {
                                    ButToan btadd = ButToan.NewButToan();
                                    //Dien Giai=[loai thu]+ [tên hoc sinh]+ [lớp]+[mã học sinh]
                                    btadd.DienGiai = ctbienlai.DienGiai + " " + ctbienlai.NamHoc + " - " + ctbienlai.TenDoiTuong + " - " + ctbienlai.TenLop + " - " + ctbienlai.MaQLDoiTuong;
                                    btadd.NoTaiKhoan = _dinhKhoanTuDong.TKNo;
                                    btadd.CoTaiKhoan = _dinhKhoanTuDong.TKCo;
                                    btadd.IDKhoanMuc = _dinhKhoanTuDong.IDKhoanMuc;
                                    btadd.SoTien = ctbienlai.SoTien - Math.Round(ctbienlai.TienPos, 0, MidpointRounding.AwayFromZero);
                                    //btadd.SoTienNgoaiTe = ctbienlai.SoTien - Math.Round(ctbienlai.TienPos, 0, MidpointRounding.AwayFromZero); ;
                                    //
                                    ...
                                    HeThongTaiKhoan1 taiKhoanCo = HeThongTaiKhoan1.GetHeThongTaiKhoan1(btadd.CoTaiKhoan);
                                    if (taiKhoanCo.MaTaiKhoan != 0)
                                    {
                                        //currentButToan.DoiTuongCo = 0;
                                        if (taiKhoanCo.CoDoiTuongTheoDoi == true && btadd.DoiTuongCo == 0)
                                        {
                                            btadd.DoiTuongCo = ctbienlai.MaDoiTuongInt;
                                        }
                                    }

                                    _ChungTu.DinhKhoan.ButToan.Add(btadd);
                                    //
                                    ButToan btpos = ButToan.NewButToan();
                                    //Dien Giai=[loai thu]+ [tên hoc sinh]+ [lớp]+[mã học sinh]
                                    btpos.DienGiai = "Phí ngân hàng " + ctbienlai.DienGiai + " " + ctbienlai.NamHoc + " - " + ctbienlai.TenDoiTuong + " - " + ctbienlai.TenLop + " - " + ctbienlai.MaQLDoiTuong;

                                    btpos.SoTien = Math.Round(ctbienlai.TienPos, 0, MidpointRounding.AwayFromZero);
                                    //
                                    btpos.OidMaBienLai = ctbienlai.MaBienLai;
                                    btpos.OidChiTietBienLai = ctbienlai.MaChiTiet;
                                    btpos.IDBienLai = ctbienlai.MaBienLaiInt;
                                    btpos.IDChiTietBienLai = ctbienlai.MaChiTietInt;
                                    btpos.KieuThuPhi = 4;//Phí ngân hàng
                                    btpos.NoTaiKhoan = HeThongTaiKhoan1.LayMaTaiKhoan("6427");
                                    btpos.CoTaiKhoan = _dinhKhoanTuDong.TKCo;
                                    btpos.IDKhoanMuc = 48;  //phi ngan hang                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  

                                    HeThongTaiKhoan1 objTKCo = HeThongTaiKhoan1.GetHeThongTaiKhoan1(btpos.CoTaiKhoan);
                                    if (objTKCo.MaTaiKhoan != 0)
                                    {
                                        //currentButToan.DoiTuongCo = 0;
                                        if (objTKCo.CoDoiTuongTheoDoi == true && btpos.DoiTuongCo == 0)
                                        {
                                            btpos.DoiTuongCo = ctbienlai.MaDoiTuongInt;
                                        }
                                    }

                                    //btpos.IDKhoanMuc = _dinhKhoanTuDong.IDKhoanMuc;

                                    if (ctbienlai.MaTruongHocSinh != "")
                                    {
                                        BoPhan bp = BoPhan.GetBoPhan_MaBoPhanQL(ctbienlai.MaTruongHocSinh);
                                        btpos.MaDonVi = bp.MaBoPhan;
                                    }

                                    XuLyDoiTuongTheoDoi(btpos);
                                    _ChungTu.DinhKhoan.ButToan.Add(btpos);
                                }
                                else
                                {
                                    ButToan btadd = ButToan.NewButToan();
                                    ...
                                    btadd.SoTienNgoaiTe = Math.Round(ctbienlai.TienNgoaiTe, 2, MidpointRounding.AwayFromZero);
                                    sumChiTietNgoaiTeMotBienLai = sumChiTietNgoaiTeMotBienLai + Math.Round(ctbienlai.TienNgoaiTe, 2, MidpointRounding.AwayFromZero);
                                    //dieu chinh sai so ngoai te cho dong cuoi cung cua bien lai trong pham vi 1 don vi ngoai te)
                                    decimal saiso = tongTienNgoaiTeMotBienLai - sumChiTietNgoaiTeMotBienLai;
                                    if (saiso != 0 && saiso >= -1 && saiso <= 1)
                                        btadd.SoTienNgoaiTe = btadd.SoTienNgoaiTe + saiso;

                                    btadd.SoTien = Math.Round(ctbienlai.SoTien, 0, MidpointRounding.AwayFromZero);
                                    //
                                    btadd.OidMaBienLai = ctbienlai.MaBienLai;
                                    btadd.OidChiTietBienLai = ctbienlai.MaChiTiet;
                                    btadd.IDBienLai = ctbienlai.MaBienLaiInt;
                            ...
                            if (strSoTKNganHang != "")
                            {
                                ERP_Library.ThanhToan.TaiKhoanNganHangCongTyList lst = ERP_Library.ThanhToan.TaiKhoanNganHangCongTyList.GetTaiKhoanNganHangCongTyList();
                                foreach (ERP_Library.ThanhToan.TaiKhoanNganHangCongTyChild item in lst)
                                {
                                    if (item.SoTaiKhoan.Replace(" ", "") == strSoTKNganHang)
                                    {
                                        maTKNganHangCongTy = item.MaChiTiet;
                                        break;
                                    }
                                }
                                if (maTKNganHangCongTy != 0)
                                {
                                    _ChungTu.BoSungChungTuKT.MaTaiKhoanNH = maTKNganHangCongTy;
                                }
                            }
                        }
                    }
                    ...
                    if (strNoiDungThu.Length > 2)
                    {
                        strNoiDungThu = strNoiDungThu.Remove(strNoiDungThu.Length - 2, 2);
                        _ChungTu.DienGiai = strNoiDungThu.ToString();
                    }
                    else
                        _ChungTu.DienGiai = strNoiDung;
        ...
        public FrmChungTuThuTienGui(ChungTuCustomize chungtuCus)
        {
            InitializeComponent();
        ...
        public FrmChungTuThuTienGui()
        {
            InitializeComponent();
        }

        public FrmChungTuThuTienGui(ChungTu chungTu)
        {
        ...
        public FrmChungTuThuTienGui(long maChungTu)
        {
            InitializeComponent();
            ...
            else if (e.KeyCode == Keys.F8)
            {
                ...
                using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
                {
                    ...
                    using (SqlCommand cm = cn.CreateCommand())
                    {
                        ...
                        cm.Parameters.AddWithValue("@MaDoiTuong", bt.DoiTuongCo);
                ...
                if (hoadonSelected.Count != 0)//M
                {
                        ...
                        if (insert)
                        {
                            if (hoadon.CT_HoaDonDichVuList.Count > 0)
                            {
                                foreach (CT_HoaDonDichVu cthddv in hoadon.CT_HoaDonDichVuList)
                                {
                                    ...
                                    item.SoTienThanhToan = HoaDon.GetSoTienConLai_HoaDonBanRa(cthddv.MaHoaDon, _ChungTu.MaChungTu, cthddv.MaDoiTac);
                    ...
                    if (_ChungTu.DinhKhoan.ButToan.Count == 0)
                    {
                        foreach (ChungTu_HoaDonThanhToan cthdtt in _ChungTu.ChungTu_HoaDonThanhToanList)
                        {
                            ...
                            bt.NoTaiKhoan = HeThongTaiKhoan1.LayMaTaiKhoan("1121");
        ...
        private void ThuPhibarButtonItem_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            bool duoclap = true;
            //if (_ChungTu.IsNew == false)
            //{
            ...
            {
                _lapChungTuBienLai = true;
                LapChungTuFromBienLai(1);
            }
        }

        private void PhiDubarButtonItem_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            bool duoclap = true;
            //if (_ChungTu.IsNew == false)
            //{
                ...
                if (chungTuReferencelistSelected.Count != 0)//M
                {
                    ...
                    foreach (ChungTuReference itemchungturef in chungTuReferencelistSelected)
                    {
                        ...
                        if (insert)
                        {
                            ...
                            {
                                ButToan btadd = ButToan.NewButToan();
                                btadd.NoTaiKhoan = HeThongTaiKhoan1.LayMaTaiKhoan("1121");
                                ...
                                btadd.SoTienNgoaiTe = itemchungturef.SoTien;
        ...
        private void FrmChungTuThuTienGui_Load(object sender, EventArgs e)
        {
            menuPhimTat.Visible = false;
            menuPhimTat.Opacity = 0;
        ...
        private void LapChungTutuBienLaibarSubItem_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            bool duoclap = true;
            btnThemMoi_ItemClick(sender, e);
        ...
        private void menuItemCtrlE_Click(object sender, EventArgs e)
        {
            if (btnSua.Visibility == DevExpress.XtraBars.BarItemVisibility.Always)
            {
                btnSua.PerformClick();
            }
        }
