...
namespace PSC_ERP
{
    public partial class FrmChungTuPhiNganHang : XtraForm
    {
        #region Properties
        ...
        private void FormatForm()
        {
            ...
            else if (_LoaiChungTu.MaLoaiCTQuanLy == "PhiNH")
            {
                this.Text = "Phí Ngân Hàng";
                Tab1_xtraTabPage3.PageVisible = false;//HoaDon
                //NguoiNhanLbCtrl.Text = "Người nhận";
                DienGiaiLbCtrl.Text = "Diễn giải";
                NhanVienLbCtrl.Text = "Nhân viên lập";
        ...
        private void LapChungTuFromBienLai()
        {
            ...
            //                _dinhKhoanTuDong = DinhKhoanTuDong.GetDinhKhoanTuDong(ctbienlai.DienGiai, _LoaiChungTu.MaLoaiCT, ctbienlai.MaDonViCongTy);
        ...
        #region Initialize
        public FrmChungTuPhiNganHang()
        {
            InitializeComponent();
        }

        public FrmChungTuPhiNganHang(ChungTu chungTu)
        {
        ...
        public FrmChungTuPhiNganHang(ChungTuCustomize chungtuCus)
        {
            InitializeComponent();
        ...
        public FrmChungTuPhiNganHang(long maChungTu)
        {
            InitializeComponent();
            ...
            _ngayLapCu = _ChungTu.NgayLap.Year > 1900 ? _ChungTu.NgayLap : _ChungTu.NgayThucHien;
            _LoaiChungTu = LoaiChungTuDev.GetLoaiChungTuDevByMaQuanLy("phiNH");
            _taoMoiChungTu = false;
            _maChungTuGhiTangCuCanXemLai = _ChungTu.MaChungTu;
            TongTien = _ChungTu.Tien.ThanhTien;
            soTien = _ChungTu.Tien.SoTien;
        ...
        public void ShowPhieuPhiNganHang()
        {
            //_maLoaiChungTu = 22;//Phí ngân hàng
            _LoaiChungTu = LoaiChungTuDev.GetLoaiChungTuDevByMaQuanLy("PhiNH");
            FormatForm();
            _taoMoiChungTu = true;
            KhoiTao();
        ...
        private void btnPrintA4_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            #region Devexpress
            if (_LoaiChungTu.MaLoaiCTQuanLy == "PKT"
                || _LoaiChungTu.MaLoaiCTQuanLy == "PhiNH"
                )//Bảng Kê
            {
        ...
        private void FrmChungTuPhiNganHang_Load(object sender, EventArgs e)
        {
            this.ReadOnlyConTrolByStatus(this.strStatus);
