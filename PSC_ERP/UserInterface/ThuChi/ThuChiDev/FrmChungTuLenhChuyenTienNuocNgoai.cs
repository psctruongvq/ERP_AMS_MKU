...
namespace PSC_ERP
{
    public partial class FrmChungTuLenhChuyenTienNuocNgoai : XtraForm
    {
        #region Properties
        ...
        private void LoadDaTa()
        {
            ...
            NganHang objNH = NganHang.NewNganHang();
            _nganHangList.Insert(0, objNH);
            bdNganHangTrungGian.DataSource = _nganHangList;
            if (_taoMoiChungTu)
            {
                KhoiTaoChungTuMoi();
            }
        ...
        private void KhoiTao()
        {
            ...
            bdNganHangTrungGian.DataSource = typeof(NganHangList);
        ...
        private void DesignGrid_HoaDon()
        {
            ...
            HamDungChung.ShowFieldGridViewDev_Modify(ChungTu_HoaDonThanhToangridView, new string[] { "HoaDon.GhiChu", "HoaDon.MauHoaDon", "HoaDon.KyHieuMauHoaDon", "HoaDon.SoHoaDon", "HoaDon.SoSerial", "HoaDon.NgayLap", "HoaDon.ThanhTien", "HoaDon.ThueSuatVAT", "HoaDon.ThueVAT", "HoaDon.TongTien", "SoTienThanhToan", "HoaDon.MaDoiTac", "HoaDon.TenDoiTac", "HoaDon.MaSoThue", "HoaDon.DiaChi" },
                                new string[] { "Diễn giải", "Mẫu hóa đơn", "Ký hiệu mẫu HĐ", "Số hóa đơn", "Số serial", "Ngày hóa đơn", "Tiền trước thuế", "% thuế", "Tiền Thuế", "Tiền sau thuế", "Số tiền thanh toán", "Mã đối tượng", "Tên đối tượng", "Mã số thuế", "Địa chỉ" },
        ...
        private void SetSoChungTuMoiPS(int LoaiChungTu)
        {
            ...
            _ChungTu.SoChungTu = PublicClass.SetSoChungTuByMaLoaiChungTu(_LoaiChungTu.MaLoaiCT, (Convert.ToDateTime(NgayHT_dateEdit1.EditValue)).Date);
        ...
        private void KhoiTaoChungTuMoi()
        {
            ...
            //_daLoadXong = false;
            {
                ...
                soTien = 0;
                TongTien = 0;
                _ngayLapCu = _ChungTu.NgayThucHien;
                _ChungTu.NgayLapString = "";
                LoadDataAfterInitChungTu();
                _ChungTu.BoSungChungTuKT.LoaiChuyenTienNN = 1;
                //gán bindingSource
                GanBindingSource();
        ...
        private bool KiemTraButToanHopLe()
        {
            ...
            if (tongtienButToan != 0 && _ChungTu.Tien.ThanhTien != tongtienButToan)
            {
            ...
            //if (tongtienButToan != 0 && _ChungTu.Tien.SoTien != tongtienButToan)
            //{
            //    MessageBox.Show("Tổng tiền bút toán và Số tiền Chứng từ không bằng nhau, không hợp lệ", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            //    return false;
            //}
        ...
        private void DesignCboNganHangTrungGian()
        {
            HamDungChung.InitGridLookUpDev2(cboNganHangTrungGian, bdNganHangTrungGian, "TenNganHang", "MaNganHang", "", true, true, DevExpress.XtraEditors.Controls.TextEditStyles.Standard);
            HamDungChung.ShowFieldGridLookUpDev2(cboNganHangTrungGian, new string[] { "TenNganHang", "MaQuanLy" }, new string[] { "Tên Ngân Hàng", "Mã Ngân Hàng" }, new int[] { 90, 120 }, false);
            //MaTaiKhoanNHgridLookUpEdit.EditValueChanged += new System.EventHandler(this.MaTaiKhoanNHgridLookUpEdit_EditValueChanged);
        }
        ...
        public bool Method_Report_LenhChuyenTienNuocNgoai()//Lệnh Chuyển Tiền Nước Ngoài
        {
            ...
            using (SqlConnection cn = new SqlConnection(ERP_Library.Database.ERP_Connection))
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "spd_Report_LenhChuyenTienNuocNgoai";
                    cm.Parameters.AddWithValue("@MaChungTu", _ChungTu.MaChungTu);
                    SqlDataAdapter da = new SqlDataAdapter(cm);
                    DataTable dt = new DataTable();
                    da.Fill(dt);
        ...
        private void LapChungTuFromBienLai()
        {
            ...
            #region Process
            FrmGetBienLaiFronOtherDB frm = new FrmGetBienLaiFronOtherDB(tendoituong, hinhthucthanhtoan, 2);//--kieulap=1: Thu Phí; kieulap=2: Hoàn Phí
        ...
        private void inUyNhiemChi(string UNCNganHang)
        {
            if (_ChungTu.IsNew == false)
            {
                ERP_Library.NguoiKyTen nguoiky = NguoiKyTen.GetNguoiKyTen(CurrentUser.Info.UserID);
        ...
        private void CreateTamUng(ButToan buttoan)
        {
            if (IsTaiKhoanTamUng(buttoan.NoTaiKhoan) && buttoan.DoiTuongNo != 0)
            {
                ...
                tu.DienGiai = buttoan.DienGiai;
                tu.NgayLap = _ChungTu.NgayThucHien;
                tu.SoTien = buttoan.SoTien;
        ...
        #region Initialize
        public FrmChungTuLenhChuyenTienNuocNgoai()
        {
            InitializeComponent();
        }

        public FrmChungTuLenhChuyenTienNuocNgoai(ChungTu chungTu)
        {
        ...
        public FrmChungTuLenhChuyenTienNuocNgoai(ChungTuCustomize chungtuCus)
        {
            InitializeComponent();
        ...
        public FrmChungTuLenhChuyenTienNuocNgoai(long maChungTu)
        {
            InitializeComponent();
            ...
            _LoaiChungTu = LoaiChungTuDev.GetLoaiChungTuDevByMaQuanLy("LCTNN");
            _taoMoiChungTu = false;
            _maChungTuGhiTangCuCanXemLai = _ChungTu.MaChungTu;
            TongTien = _ChungTu.Tien.ThanhTien;
            soTien = _ChungTu.Tien.SoTien;
        ...
        public void ShowChungTuLenhChuyenTienNuocNgoai()
        {
            //_maLoaiChungTu = 24;//Lệnh chuyển tiền ra nước ngoài
            _LoaiChungTu = LoaiChungTuDev.GetLoaiChungTuDevByMaQuanLy("LCTNN");
            FormatForm();
            _taoMoiChungTu = true;
            KhoiTao();
        ...
        private void btnPrintA4_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            else if (_LoaiChungTu.MaLoaiCTQuanLy == "LCTNN")//Lệnh Chuyển Tiền Nước Ngoài
            {
                ReportTemplate _report = ReportTemplate.GetReportTemplate("ID_Report_LenhChuyenTienNuocNgoai");
                if (_report != null)
                {
                    DateTime dtDenNgay = DateTime.Today;
                    frmReport frm = new frmReport();
        ...
        private void FrmChungTuLenhChuyenTienNuocNgoai_Load(object sender, EventArgs e)
        {
            this.ReadOnlyConTrolByStatus(this.strStatus);
        ...
        private void btn_InMatSau_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ReportTemplate _report = ReportTemplate.GetReportTemplate("ID_Report_LenhChuyenTienNuocNgoai_MatSau");
            if (_report != null)
            {
                DateTime dtDenNgay = DateTime.Today;
                frmReport frm = new frmReport();
