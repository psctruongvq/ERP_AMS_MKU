...
namespace PSC_ERP
{
    public partial class FrmChungTuMuaChuaThanhToan : XtraForm
    {
        #region Properties
        ...
        private BindingSource NhomHHDVMuaVaoBindingSource = new BindingSource();
        ...
        private void LoadDaTa()
        {
            ...
            //NhomHHDVMuaVaoList
            NhomHHDVMuaVaoList nhomHHDVMuaVaoList = NhomHHDVMuaVaoList.GetNhomHHDVMuaVaoList();
            NhomHHDVMuaVao nhomHHDVMuaVao = NhomHHDVMuaVao.NewNhomHHDVMuaVao();
            nhomHHDVMuaVaoList.Insert(0, nhomHHDVMuaVao);
            NhomHHDVMuaVaoBindingSource.DataSource = nhomHHDVMuaVaoList;
            //DonViList
            ...
            DanhMucMauHoaDon dmMHD = DanhMucMauHoaDon.NewDanhMucMauHoaDon();
            danhMucMauHoaDonList.Insert(0, dmMHD);
        ...
        private void SetTaiKhoanDefaultForNewFirstButtoan(ButToan buttoan)
        {
            ...
            int indexRow = _ChungTu.DinhKhoan.ButToan.IndexOf(buttoan);
            if (indexRow > 0)
            {
                ButToan btDongTren = _ChungTu.DinhKhoan.ButToan[indexRow - 1];
                buttoan.NoTaiKhoan = btDongTren.NoTaiKhoan;
                buttoan.DoiTuongNo = btDongTren.DoiTuongNo;
                buttoan.CoTaiKhoan = btDongTren.CoTaiKhoan;
                buttoan.DoiTuongCo = btDongTren.DoiTuongCo;
                buttoan.MaDonVi = btDongTren.MaDonVi;
                buttoan.MaHopDong = btDongTren.MaHopDong;
                buttoan.IDKhoanMuc = btDongTren.IDKhoanMuc;                
            }
        ...
        private void DesignGrid_ButToan()
        {
            ...
            HamDungChung.ShowFieldGridViewDev(gridView_ButToan, new string[] { "DienGiai", "NoTaiKhoan", "CoTaiKhoan", "SoTienNgoaiTe", "SoTien", "DoiTuongNo", "DoiTuongCo", "MaDonVi", "IDKhoanMuc", "SoHoaDonThamChieu", "MaHopDong" },
                                new string[] { "Nội dung", "Nợ Tài Khoản", "Có Tài Khoản", "Số tiền ngoại tệ", "Số Tiền", "Đối tượng nợ", "Đối tượng có", "Đơn vị", "Thuộc khoản mục", "Số hóa đơn", "Hợp đồng" },
            ...
            HamDungChung.AlignHeaderColumnGridViewDev(gridView_ButToan, new string[] { "DienGiai", "NoTaiKhoan", "CoTaiKhoan", "SoTienNgoaiTe", "SoTien", "DoiTuongNo", "DoiTuongCo", "MaDonVi", "IDKhoanMuc", "SoHoaDonThamChieu", "MaHopDong" }, DevExpress.Utils.HorzAlignment.Center);
            ...
            HamDungChung.ShowFieldRepositoryItemTreeListLookUpEdit(khoanMuc_GrdLU, new string[] { "MaQL", "Ten", "EnglishName", "ParentIDString" }, new string[] { "Mã QL", "Khoản mục", "Tên tiếng Anh", "Thuộc mục cha" }, new int[] { 100, 200, 100, 200 }, false);
            HamDungChung.RegisterControlFieldGridViewDev(gridView_ButToan, "IDKhoanMuc", khoanMuc_GrdLU);
        ...
        private void DesignGrid_HoaDon()
        {
            ...
            HamDungChung.ShowFieldGridViewDev_Modify(ChungTu_HoaDonThanhToangridView, new string[] { "HoaDon.GhiChu", "HoaDon.MauHoaDon", "HoaDon.KyHieuMauHoaDon", "HoaDon.SoSerial", "HoaDon.SoHoaDon", "HoaDon.NgayLap", "HoaDon.NguyenTe", "HoaDon.ThanhTien", "HoaDon.ThueSuatVAT", "HoaDon.ThueVAT", "HoaDon.TongTien", "SoTienThanhToan", "HoaDon.MaDoiTac", "HoaDon.TenDoiTac", "HoaDon.MaSoThue", "HoaDon.DiaChi", "HoaDon.NhomHHDVMuaVao" },
                                new string[] { "Diễn giải", "Mẫu hóa đơn", "Ký hiệu mẫu HĐ", "Số serial", "Số hóa đơn", "Ngày hóa đơn", "Ngoại tệ", "Tiền trước thuế", "% thuế", "Tiền Thuế", "Tiền sau thuế", "Số tiền thanh toán", "Mã đối tượng", "Tên đối tượng", "Mã số thuế", "Địa chỉ", "Nhóm HHDV mua vào" },
                                             new int[] { 120, 90, 100, 90, 90, 90, 90, 90, 80, 90, 90, 100, 95, 100, 90, 100, 100 }, false);

            HamDungChung.AlignHeaderColumnGridViewDev(ChungTu_HoaDonThanhToangridView, new string[] { "HoaDon.GhiChu", "HoaDon.MauHoaDon", "HoaDon.KyHieuMauHoaDon", "HoaDon.SoSerial", "HoaDon.SoHoaDon", "HoaDon.NgayLap", "HoaDon.NguyenTe", "HoaDon.ThanhTien", "HoaDon.ThueSuatVAT", "HoaDon.ThueVAT", "HoaDon.TongTien", "SoTienThanhToan", "HoaDon.MaDoiTac", "HoaDon.TenDoiTac", "HoaDon.MaSoThue", "HoaDon.DiaChi", "HoaDon.NhomHHDVMuaVao" }, DevExpress.Utils.HorzAlignment.Center);
            ...
            HamDungChung.FormatNumberTypeofColumnGridViewDev2(ChungTu_HoaDonThanhToangridView, new string[] { "HoaDon.NguyenTe" }, "#,###.##");
            HamDungChung.ShowSummaryFooterofColumnGridViewDev2(ChungTu_HoaDonThanhToangridView, new string[] { "HoaDon.NguyenTe" }, "{0:#,###.##}");

            //ChungTu_HoaDonThanhToangridView.Columns["HoaDon.NgayLap"].DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
            //ChungTu_HoaDonThanhToangridView.Columns["HoaDon.NgayLap"].DisplayFormat.FormatString = "dd/MM/yyyy";
            ...
            //
            //NhomHHDVMuaVao
            RepositoryItemGridLookUpEdit NhomHHDVMuaVao_grdLU = new RepositoryItemGridLookUpEdit();
            HamDungChung.InitRepositoryItemGridLookUpDev2(NhomHHDVMuaVao_grdLU, NhomHHDVMuaVaoBindingSource, "TenNhomHHDVMuaVao", "Id", "", true, DevExpress.XtraEditors.Controls.TextEditStyles.Standard);
            HamDungChung.ShowFieldRepositoryItemGridLookUpDev(NhomHHDVMuaVao_grdLU, new string[] { "TenNhomHHDVMuaVao" }, new string[] { "Tên nhóm" }, new int[] { 360 }, false);
            HamDungChung.RegisterControlFieldGridViewDev(ChungTu_HoaDonThanhToangridView, "HoaDon.NhomHHDVMuaVao", NhomHHDVMuaVao_grdLU);
            //
            RepositoryItemDateEdit itemNgayHoaDon = new RepositoryItemDateEdit();
            itemNgayHoaDon.CalendarTimeProperties.EditMask = "dd/MM/yyyy";
            itemNgayHoaDon.CalendarTimeProperties.Mask.EditMask = "dd/MM/yyyy";
            itemNgayHoaDon.Mask.EditMask = "dd/MM/yyyy";
            itemNgayHoaDon.Mask.MaskType = DevExpress.XtraEditors.Mask.MaskType.DateTimeAdvancingCaret;
            itemNgayHoaDon.Mask.PlaceHolder = '/';
            itemNgayHoaDon.Mask.UseMaskAsDisplayFormat = true;
            itemNgayHoaDon.CalendarTimeProperties.Mask.MaskType = DevExpress.XtraEditors.Mask.MaskType.DateTimeAdvancingCaret;
            HamDungChung.RegisterControlFieldGridViewDev(ChungTu_HoaDonThanhToangridView, "HoaDon.NgayLap", itemNgayHoaDon);
            ...
            this.ChungTu_HoaDonThanhToangridView.FocusedRowChanged += new DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventHandler(this.ChungTu_HoaDonThanhToangridView_FocusedRowChanged);
        ...
        private void EventRowOrColumnGrdView_DinhKhoanChange(int rowhandle)
        {
            ...
            if (isXoaDongHoaDon == true)
            {
                isXoaDongHoaDon = false;
                return;
            }
        ...
        private bool KiemTraTruocKhiXoaChungTuHopLe()
        {
            ...
            bool isHoaDonDaChonLenBangKe = false;
            foreach (ChungTu_HoaDonThanhToan obj in this._ChungTu.ChungTu_HoaDonThanhToanList)
            {
                if (HoaDon.IsHoaDonDaChonLenBangKe(obj.MaHoaDon) == true)
                {
                    isHoaDonDaChonLenBangKe = true;
                    break;
                }
            }

            if (isHoaDonDaChonLenBangKe == true)
            {
                MessageBox.Show("Hóa đơn của chứng từ đã được lập bảng kê, bạn không thể thực hiện xóa", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return false;
            }
        ...
        private bool KiemTraButToanHopLe()
        {
            ...
            foreach (ButToan bt in _ChungTu.DinhKhoan.ButToan)
            {
                ...
                if (httkno.CoTheoDoiKhoanMucChiPhi == true || httkco.CoTheoDoiKhoanMucChiPhi == true)
                {
                    if (bt.IDKhoanMuc == 0)
                    {
                        MessageBox.Show(this, "Vui lòng chọn khoản mục chi phí cho bút toán", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        return false;
                    }
                }
                //Don Vi
        ...
        private Boolean DuocPhepLuu()
        {
            ...
            foreach (ChungTu_HoaDonThanhToan itemct_hd in _ChungTu.ChungTu_HoaDonThanhToanList)
            {
                if (itemct_hd.SoTienThanhToan == 0)
                {
                    ...
                    //return false;
                    itemct_hd.SoTienThanhToan = itemct_hd.HoaDon.TongTien;
                }
                tongtienthanhtoan += itemct_hd.SoTienThanhToan;
            }
            if (_ChungTu.ChungTu_HoaDonThanhToanList.Count > 0 && _ChungTu.Tien.ThanhTien != tongtienthanhtoan && tongtienthanhtoan != 0)
            {
                if (MessageBox.Show(this, "Lưu ý! Giá trị Chứng từ không bằng tổng tiền thanh toán của Hóa đơn! Bạn có muốn tiếp tục Lưu?", "Thông Báo", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == System.Windows.Forms.DialogResult.No)
                    return false;
            }
            ...
            if (DuocPhepLuu())
            {
                try
                {
                    using (DialogUtil.WaitForSave(this))
                    {
                        ...
                        this.strStatus = "KHOA"; //khong cho tu dong add dong                          

                        //Load lai chung tu sau khi luu, neu ko load, xoa dong chi tiet ko luu dc, sau do xoa phieu bi loi
                        ChungTuList ct = ChungTuList.GetChungTuListByMaChungTu_New(_ChungTu.MaChungTu);
                        if (ct.Count > 0)
                        {
                            _ChungTu = ct[0];
                            GanBindingSource();
                            //LoadChungTuCu(_ChungTu.MaChungTu);                               
                        }
                    }
        ...
        private void LoadDoiTuongList()
        {
            try
            {
                ...
                {
                    //_DoiTuongThuChiList = DoiTuongAllList.GetDoiTuongAllList_TimDoiTac("", _maCongTy, 0);//_factory.Context.sp_AllDoiTuong(0, 0).Where(x => x.MaCongTy == _maCongTy).ToList();
                    _DoiTuongThuChiList = DoiTuongAllList.GetDoiTuongAllListForKhachHang_NhaCungCap("", _maCongTy, 0);//_factory.Context.sp_AllDoiTuong(0, 0).Where(x => x.MaCongTy == _maCongTy).ToList();
                }
                DoiTuongAll doituong = DoiTuongAll.NewDoiTuongAll("");//new sp_AllDoiTuong_Result() { MaDoiTuong = 0, TenDoiTuong = "" };
                _DoiTuongThuChiList.Insert(0, doituong);
                AllDoiTuong_bindingSource.DataSource = _DoiTuongThuChiList;
        ...
        private bool KiemTraHoaDonTaoMoiHopLe()
        {
            foreach (ChungTu_HoaDonThanhToan ct_hd in _ChungTu.ChungTu_HoaDonThanhToanList)
            {
                ...
                if (ct_hd.HoaDon.NgayLap > _ChungTu.NgayLap)
                {
                    MessageBox.Show("Ngày hóa đơn đang lớn hơn ngày ghi sổ, không thể thực hiện lưu", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return false;
                }
            }
            return true;
        ...
        public FrmChungTuMuaChuaThanhToan(ChungTuCustomize chungtuCus)
        {
            InitializeComponent();
        ...
        public FrmChungTuMuaChuaThanhToan()
        {
            InitializeComponent();
        }

        public FrmChungTuMuaChuaThanhToan(ChungTu chungTu)
        {
        ...
        public FrmChungTuMuaChuaThanhToan(long maChungTu)
        {
            InitializeComponent();
            this.strStatus = "KHOA";
            ChungTuList ct = ChungTuList.GetChungTuListByMaChungTu_New(maChungTu);
            ...
            _ngayLapCu = _ChungTu.NgayLap.Year > 1900 ? _ChungTu.NgayLap : _ChungTu.NgayThucHien;
            _LoaiChungTu = LoaiChungTuDev.GetLoaiChungTuDevByMaQuanLy("MuaChuaThanhToan");
            _taoMoiChungTu = false;
            _maChungTuGhiTangCuCanXemLai = _ChungTu.MaChungTu;
            TongTien = _ChungTu.Tien.ThanhTien;
            soTien = _ChungTu.Tien.SoTien;
        ...
        public void ShowPhieuMuaChuaThanhToan()
        {
            _LoaiChungTu = LoaiChungTuDev.GetLoaiChungTuDevByMaQuanLy("MuaChuaThanhToan");
            FormatForm();
            _taoMoiChungTu = true;
        ...
        private void gridView_ButToan_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            if (currentButToan != null && gridView_ButToan.FocusedColumn.Name == "colNoTaiKhoan" || gridView_ButToan.FocusedColumn.Name == "colCoTaiKhoan")
            {
                ...
                #region mặc định hạch toán cho các dòng khác chưa hạch toán theo dòng đầu tiên

                if (e.RowHandle == 0)
                {
                    if (gridView_ButToan.FocusedColumn.Name == "colNoTaiKhoan")
                    {
                        int TKno = currentButToan.NoTaiKhoan;
                        long DTno = currentButToan.DoiTuongNo;
                    ...
                    {
                        int TKco = currentButToan.CoTaiKhoan;
                        long DTco = currentButToan.DoiTuongCo;
            ...
            else if (gridView_ButToan.FocusedColumn.Name == "colIDKhoanMuc")
            {
                if (e.RowHandle == 0)
                {
                    int idKhoanMuc = currentButToan.IDKhoanMuc;

                    foreach (ButToan bt in _ChungTu.DinhKhoan.ButToan)
                    {
                        if (bt.IDKhoanMuc == 0)
                        {
                            bt.IDKhoanMuc = idKhoanMuc;
                        }
                    }
                    tblButToanBindingSource.DataSource = _ChungTu.DinhKhoan.ButToan;
                    gridControl1.DataSource = null;
            ...
            else if (gridView_ButToan.FocusedColumn.Name == "colMaDonVi")
            {
                if (e.RowHandle == 0)
                {
                    int maDonVi = currentButToan.MaDonVi;
        ...
        private void DeleteChungTu_HoaDonThanhToanList()
        {
            if (ChungTu_HoaDonThanhToangridView.RowCount > 0)
            {
                if (ChungTu_HoaDonThanhToangridView.GetSelectedRows().Length > 0)
                {
                    ...
                    {
                        _ChungTu.ApplyEdit();
                        ChungTuHoaDonThanhToan_bindingSource.EndEdit();
                        ChungTu_HoaDonThanhToan obj = ChungTuHoaDonThanhToan_bindingSource.Current as ChungTu_HoaDonThanhToan;

                        //obj.HoaDon.ChungTu_HoaDonThanhToanList.Clear();
                        //obj.HoaDon.ChungTu_HoaDonThanhToanList = null;
                        //ChungTuHoaDonThanhToan_bindingSource.RemoveCurrent();
                        //_ChungTu.ChungTu_HoaDonThanhToanList.Remove(obj.HoaDon.ChungTu_HoaDonThanhToanList[0]);
                        //_ChungTu.ChungTu_HoaDonThanhToanList.RemoveAt(ChungTu_HoaDonThanhToangridView.GetSelectedRows()[0]);
                        //ChungTuHoaDonThanhToan_bindingSource.RemoveAt(0);  
                        this.isXoaDongHoaDon = true;
                        ChungTu_HoaDonThanhToangridView.DeleteSelectedRows();
                        ChungTuHoaDonThanhToan_bindingSource.EndEdit();
                        this.isChonHoaDon = true;
        ...
        private void ChungTu_HoaDonThanhToangridView_InitNewRow(object sender, DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs e)
        {
            ...
            //ChungTu_HoaDonThanhToan currentCT_HD = ChungTu_HoaDonThanhToan.NewChungTu_HoaDonThanhToan();      
            ChungTu_HoaDonThanhToan currentCT_HD = this.ChungTu_HoaDonThanhToangridView.GetRow(e.RowHandle) as ChungTu_HoaDonThanhToan;
            //currentCT_HD.HoaDon.ChungTu_HoaDonThanhToanList.Clear();
            currentCT_HD.HoaDon.MaDoiTac = _ChungTu.DoiTuong;
            currentCT_HD.HoaDon.LoaiHoaDon = 4;//Hoa Don Mua vao
            currentCT_HD.HoaDon.NgayLap = _ChungTu.NgayLap;

            if (currentCT_HD.HoaDon.GhiChu + "" == "")
                currentCT_HD.HoaDon.GhiChu = _ChungTu.DienGiai;
            ...
            //mac dinh thong tin hoa don giong dong tren neu co
            if (this.ChungTu_HoaDonThanhToangridView.RowCount > 1)
            {
                ChungTu_HoaDonThanhToan dongTren = this.ChungTu_HoaDonThanhToangridView.GetRow(this.ChungTu_HoaDonThanhToangridView.RowCount - 2) as ChungTu_HoaDonThanhToan;
                currentCT_HD.HoaDon.KyHieuMauHoaDon = dongTren.HoaDon.KyHieuMauHoaDon;
                currentCT_HD.HoaDon.MauHoaDon = dongTren.HoaDon.MauHoaDon;
                currentCT_HD.HoaDon.SoSerial = dongTren.HoaDon.SoSerial;
                currentCT_HD.HoaDon.ThueSuatVAT = dongTren.HoaDon.ThueSuatVAT;
                currentCT_HD.HoaDon.KhauTruThue = dongTren.HoaDon.KhauTruThue;
                currentCT_HD.HoaDon.GhiChu = dongTren.HoaDon.GhiChu;
            }
        ...
        {
            ChungTu_HoaDonThanhToan currentct_hd = (ChungTu_HoaDonThanhToan)ChungTuHoaDonThanhToan_bindingSource.Current;
            string fname = ChungTu_HoaDonThanhToangridView.FocusedColumn.FieldName;
            ...
            else if (currentct_hd != null && ChungTu_HoaDonThanhToangridView.FocusedColumn.FieldName == "HoaDon.SoHoaDon")
            {
                ...
                if (currentct_hd.HoaDon.NhomHHDVMuaVao == 0)
                {
                    currentct_hd.HoaDon.NhomHHDVMuaVao = 4;
                }

            }
            else if (fname == "HoaDon.ThanhTien" || fname == "HoaDon.ThueVAT" || fname == "HoaDon.ThueSuatVAT")
            {
                currentct_hd.SoTienThanhToan = currentct_hd.HoaDon.TongTien;
            }
            else if (currentct_hd != null && fname == "HoaDon.NguyenTe")
            {

                if (currentct_hd.HoaDon.NguyenTe != 0)
                {
                    currentct_hd.HoaDon.ThanhTien = currentct_hd.HoaDon.NguyenTe * _ChungTu.Tien.TiGiaQuyDoi;
                    double thueSuat = currentct_hd.HoaDon.ThueSuatVAT;
                    if (thueSuat < 0)
                        thueSuat = 0;

                    currentct_hd.HoaDon.ThueVAT = Math.Round(currentct_hd.HoaDon.ThanhTien * (decimal)thueSuat / 100, 0, MidpointRounding.AwayFromZero);
                    currentct_hd.TienThue = currentct_hd.HoaDon.ThueVAT;
                    currentct_hd.HoaDon.TongTien = currentct_hd.HoaDon.ThanhTien + currentct_hd.HoaDon.ThueVAT;
                    currentct_hd.SoTienThanhToan = currentct_hd.HoaDon.TongTien;
                }
        ...
        private void KiemTraXoaHD(DataTable dtXoaHoaDon)
        {
            foreach (DataRow dr in dtXoaHoaDon.Rows)
            {
                if (ChungTu_HoaDonThanhToanChildList.GetChungTu_HoaDonThanhToanChildListByHoaDon(Convert.ToInt64(dr["MaHoaDon"].ToString())).Count() == 0)
                {
                    HoaDon.DeleteHoaDon(Convert.ToInt64(dr["MaHoaDon"].ToString()));
                }
            }
        }
        ...
        {
            DataTable dtXoaHoaDon = new DataTable();
            dtXoaHoaDon.Columns.Add("MaHoaDon", typeof(long));
            if (_ChungTu.ChungTu_HoaDonThanhToanList.Count != 0)
            {
                foreach (ChungTu_HoaDonThanhToan add in _ChungTu.ChungTu_HoaDonThanhToanList)
                {
                    dtXoaHoaDon.Rows.Add(add.HoaDon.MaHoaDon);
                }
            }

            if (DeleteChungTu())
            {
                KiemTraXoaHD(dtXoaHoaDon);
                ...
                if (hoadonSelected.Count != 0)//M
                {
                    ...
                    foreach (HoaDon hoadon in hoadonSelected)
                    {
                        ...
                        if (insert)
                        {
                            ...
                            ct_hoadon.SoTienThanhToan = ct_hoadon.HoaDon.TongTien;
        ...
        {
            if (dtmp_Ngay.OldEditValue != dtmp_Ngay.EditValue && _ChungTu.IsNew)
            {
        ...
        private void btnSua_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (isHoaDonDaChonLenBangKe == true)
            {
                if (MessageBox.Show("Lưu ý! Hóa đơn của chứng từ đã được lập bảng kê, bạn có muốn tiếp tục thực hiện sửa chứng từ?", "", MessageBoxButtons.YesNo) == System.Windows.Forms.DialogResult.No)
                    return;
            }
        ...
        private void FrmChungTuMuaChuaThanhToan_Load(object sender, EventArgs e)
        {
            this.ReadOnlyConTrolByStatus(this.strStatus);
        ...
        {
            if ((xtraTabControl2.SelectedTabPage.Name == Tab1_xtraTabPage1.Name) && (this.isChonHoaDon == true) && _ChungTu.DinhKhoan.ButToan.Count == _ChungTu.ChungTu_HoaDonThanhToanList.Count)
            {
                int i = 0;
                for (i = 0; i < _ChungTu.ChungTu_HoaDonThanhToanList.Count; i++)
                {
                    _ChungTu.DinhKhoan.ButToan[i].SoTien = _ChungTu.ChungTu_HoaDonThanhToanList[i].HoaDon.TongTien;
                    _ChungTu.DinhKhoan.ButToan[i].SoTienNgoaiTe = _ChungTu.ChungTu_HoaDonThanhToanList[i].HoaDon.NguyenTe;

                    _ChungTu.DinhKhoan.ButToan[i].SoHoaDonThamChieu = _ChungTu.ChungTu_HoaDonThanhToanList[i].HoaDon.SoHoaDon;
                    _ChungTu.DinhKhoan.ButToan[i].DoiTuongCo = _ChungTu.ChungTu_HoaDonThanhToanList[i].HoaDon.MaDoiTac;
                }
                TinhSoTienChungTu();
                this.isChonHoaDon = false;
                return;
            }
            else if ((xtraTabControl2.SelectedTabPage.Name == Tab1_xtraTabPage1.Name) && (this.isChonHoaDon == true) && _ChungTu.DinhKhoan.ButToan.Count < _ChungTu.ChungTu_HoaDonThanhToanList.Count)
            {
                //giu lai hach toan cho truong hop them hoa don moi, them cac dong hach toan cho hoa don moi
                foreach (ChungTu_HoaDonThanhToan hd in this._ChungTu.ChungTu_HoaDonThanhToanList)
                {
                    if (hd.IsNew == true)
                    {
                        ButToan bt = ButToan.NewButToan();
                        bt.SoTien = hd.HoaDon.TongTien;
                        bt.DienGiai = hd.HoaDon.GhiChu;
                        bt.SoTienNgoaiTe = hd.HoaDon.NguyenTe;
                        bt.SoHoaDonThamChieu = hd.HoaDon.SoHoaDon;
                        if (_dinhKhoanTuDong.Id != 0)
                        {
                            bt.NoTaiKhoan = _dinhKhoanTuDong.TKNo;
                            bt.CoTaiKhoan = _dinhKhoanTuDong.TKCo;
                            bt.DoiTuongCo = hd.HoaDon.MaDoiTac;
                        }
                        else
                        {
                ...
                //nếu sửa số tiền hóa đơn thì cập nhật tiền hóa đơn qua hạch toán
                if (_ChungTu.DinhKhoan.ButToan.Count > 0 && _ChungTu.ChungTu_HoaDonThanhToanList.Count <= _ChungTu.DinhKhoan.ButToan.Count)
                {
                    int i = 0;
                    for (i = 0; i < _ChungTu.ChungTu_HoaDonThanhToanList.Count; i++)
                    {
                ...
                else if (_ChungTu.DinhKhoan.ButToan.Count > 0 && _ChungTu.ChungTu_HoaDonThanhToanList.Count > _ChungTu.DinhKhoan.ButToan.Count)
                {
                    int i = _ChungTu.DinhKhoan.ButToan.Count;
                    ChungTu_HoaDonThanhToan hd;
                    for (i = _ChungTu.DinhKhoan.ButToan.Count; i < _ChungTu.ChungTu_HoaDonThanhToanList.Count; i++)
                    {
                        ButToan bt = ButToan.NewButToan();
                        hd = _ChungTu.ChungTu_HoaDonThanhToanList[i];
                        bt.SoTien = hd.HoaDon.TongTien;
                        bt.DienGiai = hd.HoaDon.GhiChu;
                        bt.SoTienNgoaiTe = hd.HoaDon.NguyenTe;
                        bt.SoHoaDonThamChieu = hd.HoaDon.SoHoaDon;
                ...
                #region gom mỗi nhà NCC 1 but toan
                ...
                //                  tongTien = tongTien + hd.HoaDon.TongTien;
                //                  dienGiai = "";
                ...
                //                          soTien = soTien + hoaDonThanhToan.HoaDon.TongTien;
                ...
                //mỗi hóa đơn một bút toán
                foreach (ChungTu_HoaDonThanhToan hd in this._ChungTu.ChungTu_HoaDonThanhToanList)
                {
                    soTien = hd.HoaDon.TongTien;
                    maDoiTuong = hd.HoaDon.MaQLDoiTac;
                    tongTien = tongTien + hd.HoaDon.TongTien;
                    nguyenTe = hd.HoaDon.NguyenTe;

                    if (hd.HoaDon.GhiChu != "")
                    {
                        dienGiai = hd.HoaDon.GhiChu;
                    }
                    else
                    {
            ...
            else if ((xtraTabControl2.SelectedTabPage.Name == Tab1_xtraTabPage1.Name) && _ChungTu.DinhKhoan.ButToan.Count == 0 && _ChungTu.ChungTu_HoaDonThanhToanList.Count > 0 && _ChungTu.Tien.ThanhTien == 0) //xoa het cac dong hach toan de lay lai thong tu tab hoa don
            {
                this.DefaultFromHoaDonToDinhKhoan();
            }
        }
        ...
        private void UpdateDoiTuongNoCo(long madoituong)
        {
            ...
            foreach (ChungTu_HoaDonThanhToan hd in _ChungTu.ChungTu_HoaDonThanhToanList)
            {
                hd.HoaDon.MaDoiTac = madoituong;
            }
        ...
        #region event
        private void ChungTu_HoaDonThanhToangridView_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            EventRowOrColumnGrdView_HoaDonChange(e.FocusedRowHandle);
        }

        private void EventRowOrColumnGrdView_HoaDonChange(int rowhandle)
        {
            if (isXoaDongHoaDon == true)
            {
                isXoaDongHoaDon = false;
            ...
            if (ChungTu_HoaDonThanhToangridView.IsNewItemRow(rowhandle))
            {
                if (ChungTu_HoaDonThanhToangridView.GetRow(rowhandle) == null)
                    ChungTu_HoaDonThanhToangridView.AddNewRow();
                //ChungTu_HoaDonThanhToangridView.FocusedColumn = gridView_ButToan.VisibleColumns[0];

                ChungTu_HoaDonThanhToangridView.FocusedColumn = ChungTu_HoaDonThanhToangridView.VisibleColumns[4];
            }
        ...
        private void grdLU_LoaiTien_EditValueChanged(object sender, EventArgs e)
        {
            if (this.isLoadCboTienTe)
            {
                if ((int)grdLU_LoaiTien.EditValue == 1)
                {
                    ...
                    ChungTu_HoaDonThanhToangridView.Columns["HoaDon.NguyenTe"].Visible = false;
                }
                else
                {
                    gridView_ButToan.Columns["SoTienNgoaiTe"].Visible = true;

                    ChungTu_HoaDonThanhToangridView.Columns["HoaDon.NguyenTe"].Visible = true;
                }
                ...
                if (this.strStatus != "KHOA")
                {
                    ...
                    foreach (ChungTu_HoaDonThanhToan ct_hd in _ChungTu.ChungTu_HoaDonThanhToanList)
                    {
                        if (ct_hd.HoaDon.NguyenTe != 0)
                        {
                            ct_hd.HoaDon.ThanhTien = ct_hd.HoaDon.NguyenTe * _ChungTu.Tien.TiGiaQuyDoi;
                            double thueSuat = ct_hd.HoaDon.ThueSuatVAT;
                            if (thueSuat < 0)
                                thueSuat = 0;

                            ct_hd.HoaDon.ThueVAT = Math.Round(ct_hd.HoaDon.ThanhTien * (decimal)thueSuat / 100, 0, MidpointRounding.AwayFromZero);
                            ct_hd.TienThue = ct_hd.HoaDon.ThueVAT;
                            ct_hd.HoaDon.TongTien = ct_hd.HoaDon.ThanhTien + ct_hd.HoaDon.ThueVAT;
                            ct_hd.SoTienThanhToan = ct_hd.HoaDon.TongTien;
                        }
                    }
        ...
        private void DefaultFromHoaDonToDinhKhoan()
        {
            //mỗi hóa đơn một bút toán
            string strDoiTuong = "";
            string maDoiTuong = "";
            ...
            foreach (ChungTu_HoaDonThanhToan hd in this._ChungTu.ChungTu_HoaDonThanhToanList)
            {
                ...
                if (soTien > 0)
                {
                    ...
                    bt.DienGiai = dienGiai;
                    bt.SoTienNgoaiTe = nguyenTe;
                    bt.SoHoaDonThamChieu = hd.SoHoaDon;
        ...
        {
            ChungTuRutGon ChungTuRG = (ChungTuRutGon)bindingSource_DanhSachChungTuTim.Current;
            FrmChungTuMuaChuaThanhToan frm = new FrmChungTuMuaChuaThanhToan(ChungTuRG.MaChungTu);
