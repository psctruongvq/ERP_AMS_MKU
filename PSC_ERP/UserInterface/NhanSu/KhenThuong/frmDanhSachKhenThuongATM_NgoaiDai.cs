...
{
    public partial class frmDanhSachKhenThuongATM_NgoaiDai : Form
    {

        ThuLaoNhanVienNgoaiDaiList _thuLaoNhanVienNgoaiDaiList;

        public frmDanhSachKhenThuongATM_NgoaiDai()
        {
            InitializeComponent();
        }
        ...
        {
            _thuLaoNhanVienNgoaiDaiList = ThuLaoNhanVienNgoaiDaiList.GetKhenThuongListByNgayLap(Convert.ToDateTime(dateTimePicker_TuNgay.Value), Convert.ToDateTime(dateTimePicker_DenNgay.Value), true);
        ...
        private void grdu_DanhSachTacQuyen_DoubleClick(object sender, EventArgs e)
        {
            if (grdu_DanhSachTacQuyen.ActiveRow != null)
            {
                ...
                {
                    frmNhapKhenThuongATM_NgoaiDai _frmNhapKhenThuongATM = new frmNhapKhenThuongATM_NgoaiDai(maKyTinhLuong, maChuongTrinh, maChiTietGiayXacNhan, maPhieuChi, ngayLap, maChiThuLao);
                    _frmNhapKhenThuongATM.Show();
                }
            }
        }
