...
{
    public partial class frmTimChonHoaDonTheoButToan : DevExpress.XtraEditors.XtraForm
    {
        //Singleton
        #region Singleton
        private static frmTimChonHoaDonTheoButToan singleton_ = null;
        public static frmTimChonHoaDonTheoButToan Singleton
        {
            get
            {
                if (singleton_ == null || singleton_.IsDisposed)
                    singleton_ = new frmTimChonHoaDonTheoButToan();
                return singleton_;
            }
        }
        ...
        HoaDon_Factory _hoaDon_Factory = null;
        ...
        public frmTimChonHoaDonTheoButToan()
        {
            InitializeComponent();
        }
        public frmTimChonHoaDonTheoButToan(tblChungTu chungTu//, tblButToan butToan
            , long maDoiTac)
        {
            InitializeComponent();
            _chungTu = chungTu;
        ...
        private void LoadData()
        {
            ...
            tblDoiTac dtac = new tblDoiTac() { MaDoiTac = 0, TenDoiTac = "<<Không chọn>>" };
            _doiTacList.Insert(0, dtac);
            GanBindingSource();
        ...
        private void Tim()
        {
            ...
            {
                txtBlackHole.Focus();
                _hoaDon_Factory = HoaDon_Factory.New();
                _hoaDonTimKiemList = _hoaDon_Factory.GetHoaDonListbySearchForChungTu(checkEdit_TimTheoNgay.Checked, dteNgayLap.DateTime, dteNgayLap_Den.DateTime, txtSoHoaDon.Text.Trim(), (Int64)cbDoiTac.EditValue);
                ////
        ...
        {
            this.Tim();
            if (_hoaDonTimKiemList == null || _hoaDonTimKiemList.Count() == 0)
            { MessageBox.Show("Danh sách hóa đơn rỗng", "Thông Báo"); }
        }
        ...
        private void btnDuaDuLieuVeChungTu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //Detach
            _hoaDon_Factory.Detach(_hoaDonDuocChonList);
        ...
        private void frmTimChonHoaDonTheoButToan_Load(object sender, EventArgs e)
        {
            this.Shown += (object senderz, EventArgs ez) =>
            {
                using (DialogUtil.Wait(this))
                {
                    ...
                    dteNgayLap_Den.EditValue = DateTime.Today;
                    ...
                    //cài đặt radio group
                    //RadioUtil.RadioGroup.Setup(false, new CheckEdit[] { radioTimTheoNgay, radioChonSoHoaDon, radioChonNgayLap, radioChonSoTien, radioChonPhanTramThueVAT, radioChonTienThueVAT, radioChonTongTien, radioChonDoiTac });
