...
{
    public partial class frmPhieuChiE : DevExpress.XtraEditors.XtraForm
    {
        #region Singleton
        ...
        void SetTaiKhoanDefault()
        {
            if (_maCongTy == 1)//HTVC
            {
                grdLU_TaiKhoanCo.EditValue = GetMaTaiKhoan("1111");
            }
            else if (_maCongTy == 2)//HTVC
            {
                grdLU_TaiKhoanCo.EditValue = GetMaTaiKhoan("1111.9");
            }
            else if (_maCongTy == 3)
            {
                grdLU_TaiKhoanCo.EditValue = GetMaTaiKhoan("1111.5");
            }
        }
        ...
        */
        ...
        private Boolean DuocPhepLuu()
        {
            ...
            if (_ChungTu.KiemTraDinhKhoanPhieuChi() == false)
                return false;
        ...
        */
        ...
        public frmPhieuChiE(tblChungTu chungTu)
        {
            InitializeComponent();
            _taoMoiChungTu = false;
        ...
        private void grdLU_TaiKhoanNo_Leave(object sender, EventArgs e)
        {
            #region Tạm ứng
            ...
            if (grdLU_TaiKhoanNo.EditValue != null)
            {
                TK = TaiKhoan_Factory.New().Get_TaiKhoan_ByMaTaiKhoan(Convert.ToInt32(grdLU_TaiKhoanNo.EditValue)).SoHieuTK;
            }
            if (TK.Contains("312"))
            {
        ...
        private void grdLU_TaiKhoanCo_Leave(object sender, EventArgs e)
        {
            #region Tạm ứng
            ...
            if (grdLU_TaiKhoanCo.EditValue != null)
            {
                TK = TaiKhoan_Factory.New().Get_TaiKhoan_ByMaTaiKhoan(Convert.ToInt32(grdLU_TaiKhoanCo.EditValue)).SoHieuTK;
        ...
        private void btnDSChungTu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            #region Old
            frmTimDanhSachChungTu f = new frmTimDanhSachChungTu(3);
