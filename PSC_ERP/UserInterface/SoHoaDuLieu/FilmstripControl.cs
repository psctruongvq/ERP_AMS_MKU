...
namespace Filmstrip
{
    ...
    public partial class FilmstripControl : UserControl
    {
        ...
        private ThongTinVanBanList _thongTinVanBanList;
        ...
        [Description("Danh sách hiện tại và thông tin liên quan.")]
        [Browsable(false)]
        [ReadOnly(true)]
        public ThongTinVanBanList ThongTinVanBanList
        {
            get
            {
                return _thongTinVanBanList;
            }
            set
            {
                _thongTinVanBanList = value;
            }
        }

        public void SetImageIdBegin()
        {
            imageIdCounter = 1;
        }
        ...
        [Category("Filmstrip properties")]
        [Description("Số Hồ Sơ of the image currently selected in the control.")]
        [Browsable(false)]
        [ReadOnly(true)]
        public String SelectSoHoSo
        {
            get
            {
                // Do we have a valid selection?
                ...
                {
                    // Get it!
                    return imagesCollection[selectedImageID].SoHoSo;
                }
                else
                {
                    // Nothing to see here...
            ...
            set
            {
                ...
                //{
                //    // Nope!
                //    throw new InvalidOperationException("Không thể gán giá trị số hồ sơ cho hình ảnh đang lựa chọn");
                //}
                ...
                if (imagesCollection.ContainsKey(selectedImageID))
                {
                    ...
                    imagesCollection[selectedImageID].SoHoSo = value;
                }
                //else
                //{
                //    // Nope. :(
                //    throw new InvalidOperationException(String.Format("Không thể gán giá trị số hồ sơ cho hình ảnh đang lựa chọn Id: ({0}) bị lỗi.", selectedImageID));
                //}
            }
        }

        [Category("Filmstrip properties")]
        [Description("Diễn giải of the image currently selected in the control.")]
        [Browsable(false)]
        [ReadOnly(true)]
        public String SelectDienGiai
        {
            get
            {
                // Do we have a valid selection?
                ...
                {
                    // Get it!
                    return imagesCollection[selectedImageID].DienGiai;
                }
                else
                {
                    // Nothing to see here...
            ...
            set
            {
                ...
                //{
                //    // Nope!
                //    throw new InvalidOperationException("Không thể gán giá trị diễn giải cho hình ảnh đang lựa chọn");
                //}
                ...
                {
                    // Set the new description
                    imagesCollection[selectedImageID].DienGiai = value;
                }
                //else
                //{
                //    // Nope. :(
                //    throw new InvalidOperationException(String.Format("Không thể gán giá trị diễn giải cho hình ảnh đang lựa chọn ID: ({0}) bị lỗi", selectedImageID));
                //}
            }
        }

        [Category("Filmstrip properties")]
        [Description("Ngày lập of the image currently selected in the control.")]
        [Browsable(false)]
        [ReadOnly(true)]
        public DateTime SelectNgayLap
        {
            get
            {
                // Do we have a valid selection?
                ...
                {
                    // Get it!
                    return imagesCollection[selectedImageID].NgayLap;
                }
                else
                {
                    // Nothing to see here...
            ...
            set
            {
                ...
                //{
                //    // Nope!
                //    throw new InvalidOperationException("Không thể gán giá trị Ngày lập cho hình ảnh đang lựa chọn");
                //}
                ...
                {
                    // Set the new description
                    imagesCollection[selectedImageID].NgayLap = value;
                }
                //else
                //{
                //    // Nope. :(
                //    throw new InvalidOperationException(String.Format("Không thể gán giá trị Ngày lập cho hình ảnh đang lựa chọn ID: ({0}) bị lỗi", selectedImageID));
                //}
            }
        }

        [Category("Filmstrip properties")]
        [Description("Mã hình ảnh of the image currently selected in the control.")]
        [Browsable(false)]
        [ReadOnly(true)]
        public long SelectedImageMaHinhAnh
        {
            get
            {
                // Do we have a valid selection?
                ...
                {
                    // Get it!
                    return imagesCollection[selectedImageID].MaHinhAnh;
                }
                else
                {
                    // Nothing to see here...
        ...
        [Category("Filmstrip properties")]
        [Description("The images collection Count. Return item of List.")]
        [Browsable(false)]
        [ReadOnly(true)]
        public int ImagesCollectionCount
        {
            get
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public void FilmstripControl_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        public void ClearControl()
        {
            txt_DienGiai.Text = "";
            txtu_SoHoSo.Text = "";
            dtpu_NgayLap.Value = DateTime.Now.Date;
        ...
        public void RemoveImage(int id)
        {
            ...
            {
                Xoa1HinhAnh(SelectedImageMaHinhAnh);
        ...
        /// </summary>
        public void ClearAllImages(bool bDelete)
        {
            if(bDelete)
                XoaTatCa();
            // Reset selection
        ...
        private void Xoa1HinhAnh(long maHinhAnh)
        {
            foreach (ThongTinVanBan vanban in _thongTinVanBanList)
            {
                if (vanban.MaThongTinVanBan == maHinhAnh)
                {
                    _thongTinVanBanList.Remove(vanban);
                    break; 
                } 
            }
        }
        ...
        {
            _thongTinVanBanList.Clear();
        }

        /// <summary>
        /// Load information of Image in interface.
        /// </summary>
        private void Load_Info()
        {
            txtu_SoHoSo.Text = SelectSoHoSo;
            txt_DienGiai.Text = SelectDienGiai;
            if (SelectNgayLap != DateTime.MinValue && SelectNgayLap != DateTime.MaxValue)
                dtpu_NgayLap.Value = SelectNgayLap;
            else
                dtpu_NgayLap.Value = DateTime.Now.Date;
        }
        ...
        private void Populate()
        {
            ...
            //tắt mở chức năng nhập liệu
            if (ImagesCollectionCount > 0)
            {
                groupBox_ThongTin.Enabled = true;
                panelThumbs.Visible = true;
            }
            else
            {
                groupBox_ThongTin.Enabled = false;
                panelThumbs.Visible = false;
            }
        }
    ...
    public class FilmstripImage
    {
        ...
        private string _strSoHoSo = string.Empty;
        private string _strDienGiai = string.Empty;
        private DateTime _dtNgayLap = DateTime.Now.Date;
        #endregion Member variables
        ...
        /// <summary>
        /// The image Mã hình Ảnh.
        /// </summary>
        public long MaHinhAnh
        {
        ...
        {
            get { return _strSoHoSo; }
            set { _strSoHoSo = value; }
        }
        ...
        {
            get { return _strDienGiai; }
            set { _strDienGiai = value; }
        }
        ...
        {
            get { return _dtNgayLap; }
            set { _dtNgayLap = value; }
        }
        ...
        /// <param name="imageValue">The image itself</param>
        /// <param name="descriptionValue">The image description</param>
        public FilmstripImage(Image imageValue, String descriptionValue, long MaHinhAnh)
        {
            id = FilmstripControl.NO_SELECTION_ID;
            image = imageValue;
            maHinhAnh = MaHinhAnh;
        ...
        /// <param name="imageValue">The image itself</param>
        /// <param name="descriptionValue">The image description</param>
        public FilmstripImage(Image imageValue, String descriptionValue, long MaHinhAnh, string strSoHoSo, DateTime dtngayLap, string strDienGiai)
        {
            id = FilmstripControl.NO_SELECTION_ID;
            image = imageValue;
            maHinhAnh = MaHinhAnh;
