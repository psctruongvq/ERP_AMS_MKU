...
{
    public partial class frmDanhSachChungTu_ThanhLyTSCDCaBiet : DevExpress.XtraEditors.XtraForm
    {
        //Singleton
        #region Singleton
        private static frmDanhSachChungTu_ThanhLyTSCDCaBiet singleton_ = null;
        public static frmDanhSachChungTu_ThanhLyTSCDCaBiet Singleton
        {
            get
            {
                if (singleton_ == null || singleton_.IsDisposed)
                    singleton_ = new frmDanhSachChungTu_ThanhLyTSCDCaBiet();
                return singleton_;
            }
        }
        ...
        public frmDanhSachChungTu_ThanhLyTSCDCaBiet()
        {
            InitializeComponent();
        ...
        private void btnThemMoi_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //frmThanhLyTSCDCaBiet frm = new frmThanhLyTSCDCaBiet();
        ...
        private void frmDanhSachChungTu_ThanhLyTSCDCaBiet_Load(object sender, EventArgs e)
        {
                ...
                using (DialogUtil.Wait(this))
                {
                    ...
                    GridUtil.DoubleClickHelper.Setup(this.grdViewChungTu, (object senderz1, EventArgs ez1) =>
                    {
                        ...
                        if (chungTu != null)
                        {
                            ...
                            {
                                frm = new frmThanhLyTSCDCaBiet(chungTu);
                                chungTu.CurrentForm_AddedObj = frm;
                            }
                            else
                                frm = chungTu.CurrentForm_AddedObj as frmThanhLyTSCDCaBiet;
