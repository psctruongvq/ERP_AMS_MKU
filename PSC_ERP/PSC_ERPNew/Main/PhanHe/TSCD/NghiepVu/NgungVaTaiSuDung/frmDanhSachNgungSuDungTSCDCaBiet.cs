...
{
    public partial class frmDanhSachNgungSuDungTSCDCaBiet : XtraForm
    {
        //Singleton
        #region Singleton
        private static frmDanhSachNgungSuDungTSCDCaBiet singleton_ = null;
        public static frmDanhSachNgungSuDungTSCDCaBiet Singleton
        {
            get
            {
                if (singleton_ == null || singleton_.IsDisposed)
                    singleton_ = new frmDanhSachNgungSuDungTSCDCaBiet();
                return singleton_;
            }
        }
        ...
        public frmDanhSachNgungSuDungTSCDCaBiet()
        {
            InitializeComponent();
            ...
            GridUtil.DoubleClickHelper.Setup(this.grdViewNgungSuDungTSCDCaBiet, (object sender, EventArgs e) =>
            {
                ...
                if (nVNgungVaTaiSuDung != null)
                {
                    ...
                    {
                        frm = new frmNgungSuDungTSCDCaBiet(Convert.ToInt32(nVNgungVaTaiSuDung.MaNghiepVu));
                        nVNgungVaTaiSuDung.CurrentForm_AddedObj = frm;
                    }
                    else
                        frm = nVNgungVaTaiSuDung.CurrentForm_AddedObj as frmNgungSuDungTSCDCaBiet;
        ...
        private void Tim()
        {
            ...
            //tìm
            _nVNgungVaTaiSuDungList_TimDuoc = _factory.TimKiem_NgungSuDung(loaiTim: loaiTim
        ...
        {
            Sys.frmEntityTrackingLog.ShowSingleton(null, BusinessCodeEnum.TSCD_NgungSuDung, this.MdiParent);
        }

        private void btnThemMoi_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            //gọi thêm mới chứng từ ghi tăng tài sản
            //frmNgungSuDungTSCDCaBiet frm = new frmNgungSuDungTSCDCaBiet();
            //frm.MdiParent = this.MdiParent;
            //frm.Show();
            frmNgungSuDungTSCDCaBiet.ShowSingleton(null, this.MdiParent);
        }
