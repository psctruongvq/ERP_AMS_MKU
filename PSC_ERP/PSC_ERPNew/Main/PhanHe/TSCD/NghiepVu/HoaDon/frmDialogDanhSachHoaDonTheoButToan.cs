...
{
    public partial class frmDialogDanhSachHoaDonTheoButToan : DevExpress.XtraEditors.XtraForm
    {
        //Singleton
        #region Singleton
        private static frmDialogDanhSachHoaDonTheoButToan singleton_ = null;
        public static frmDialogDanhSachHoaDonTheoButToan Singleton
        {
            get
            {
                if (singleton_ == null || singleton_.IsDisposed)
                    singleton_ = new frmDialogDanhSachHoaDonTheoButToan();
                return singleton_;
            }
        }
        ...
        public frmDialogDanhSachHoaDonTheoButToan()
        {
            InitializeComponent();
        }
        public frmDialogDanhSachHoaDonTheoButToan(Entities context, tblChungTu chungTu, tblButToan butToan, IQueryable<tblTaiKhoan> noTaiKhoanList, IQueryable<tblTaiKhoan> coTaiKhoanList)
        {
            InitializeComponent();
            _context = context;
            _chungTu = chungTu;
        ...
        //Event Method
        #region Event Method
        private void frmDialogDanhSachHoaDonTheoButToan_Load(object sender, EventArgs e)
        {
            LoadData();
        ...
        private void frmDialogDanhSachHoaDonTheoButToan_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        {
            frmDialogTimChonHoaDon frm = new frmDialogTimChonHoaDon(_chungTu//, _butToan
                , _maDoiTac);
