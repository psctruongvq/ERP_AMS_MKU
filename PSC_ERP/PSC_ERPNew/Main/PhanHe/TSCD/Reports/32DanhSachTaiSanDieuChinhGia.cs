...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool DanhSachTaiSanDieuChinhGia()//M
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_DanhSachTaiSanDieuChinhGia", "@TuNgay,@DenNgay,@MaBoPhan,@OnlyDenNgay,@NguonMua", tuNgay, denNgay,maBoPhan, onLyDenNgay, nguonMua);
                #region Extend table
