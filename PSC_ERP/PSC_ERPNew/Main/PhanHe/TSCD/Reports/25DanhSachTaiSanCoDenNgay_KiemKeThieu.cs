...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool DanhSachTaiSanCoDenNgay_KiemKeThieu()
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_DanhSachTaiSanCoDenNgay_KiemKeThieu", "@NgayChot,@NgayKiemKe,@MaPhongBan,@LoaiBaoCao", ngayChot, ngayKiemKe, maBoPhan,LoaiBaoCao);
                #region Extend table
