...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool DanhSachTaiSanGiamDoTachHeTHong()//M
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_DanhSachTaiSanGiamDoTachHeTHong", "@TuNgay,@DenNgay,@MaBoPhan", tuNgay, denNgay, maBoPhan);
                #region Extend table
