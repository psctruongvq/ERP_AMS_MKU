...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool ChiTietTaiSanCoDinhTuXXXTroLenTangTrongKy()//M
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                decimal soTien=500000000;
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_ChiTietTaiSanCoDinhTuXXXTroLenTangTrongKy", "@TuNgay,@DenNgay,@MaBoPhan,@NguonMua,@SoTien", tuNgay, denNgay, maBoPhan, nguonMua,soTien);
                #region Extend table
                //Tao Bang Chua TuNgay, DenNgay
                DataTable dtngay = new DataTable();
                dtngay.Columns.Add("TuNgay", typeof(DateTime));
                dtngay.Columns.Add("DenNgay", typeof(DateTime));
                dtngay.Columns.Add("SoTien", typeof(Decimal));
                //Add dòng 1
