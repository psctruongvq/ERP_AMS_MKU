...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool DanhSachTaiSanCoDinhCoDenNgay_CoTrichKhauHao()//M
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_DanhSachTaiSanCoDinhCoDenNgay_CoTrichKhauHaoTrongNam", "@DenNgay,@MaBoPhan,@NguonMua", denNgay, maBoPhan, nguonMua);
                #region Extend table
