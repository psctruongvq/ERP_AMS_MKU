...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool TongHopKinhPhiTangTrongKyTheoDonVi()//M
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_TongHopKinhPhiTangTrongKyTheoDonVi", "@TuNgay,@DenNgay,@MaBoPhan,@NguonMua,@LoaiBaoCao", tuNgay, denNgay, maBoPhan, nguonMua,LoaiBaoCao);
                #region Extend table
        ...
        public bool TongHopKinhPhiTangTrongKyTheoDonViCoChungTu()//M
        {
