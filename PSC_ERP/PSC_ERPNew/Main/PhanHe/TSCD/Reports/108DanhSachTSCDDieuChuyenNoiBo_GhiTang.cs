...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool DanhSachTSCDDieuChuyenNoiBo_GhiTang()
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_DanhSachTSCDDieuChuyenNoiBo_GhiTang", "@TuNgay,@DenNgay,@MaCongTy", tuNgay, denNgay,_maCongTy);
                #region Extend table
