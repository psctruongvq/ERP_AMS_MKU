...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool BangTongHopDuAnTangTheoPhongBanTrongNam()//M
        {
            //if ( ChuaChon_DenNgay())
            //{
            //    return false;
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_BangTongHopDuAnTangTheoDonViTrongNam", "@Nam,@NguonMua", denNgay.Year, nguonMua);
                #region Extend table
