...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool TongHopTaiSanTinhKhauHao_HaoMon()//M
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_TongHopTaiSanTinhKhauHao_HaoMon", "@TuNgay,@DenNgay",tuNgay, denNgay);
                #region Extend table
