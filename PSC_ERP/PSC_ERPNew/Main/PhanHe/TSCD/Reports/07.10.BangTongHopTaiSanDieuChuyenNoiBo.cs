...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        //07
        public bool BangTongHopTaiSanDieuChuyenNoiBo()//M
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_BangTongHopTaiSanDieuChuyenNoiBo", "@TuNgay,@DenNgay,@MaBoPhan,@NguonMua", tuNgay, denNgay, maBoPhan, nguonMua);
                #region Extend table
        ...
        //10
        public bool BangTongHopTaiSanDuAnDieuChuyenNoiBo()//M
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                DateTime denNgay = (Convert.ToDateTime(dteDenNgay.EditValue)).Date;
                int maBoPhan = (Int32)cbPhongBan.EditValue;
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_BangTongHopTaiSanDuAnDieuChuyenNoiBo", "@TuNgay,@DenNgay,@MaBoPhan", tuNgay, denNgay, maBoPhan);
                #region Extend table
                //Tao Bang Chua TuNgay, DenNgay
                DataTable dtngay = new DataTable();
                dtngay.Columns.Add("TuNgay", typeof(DateTime));
