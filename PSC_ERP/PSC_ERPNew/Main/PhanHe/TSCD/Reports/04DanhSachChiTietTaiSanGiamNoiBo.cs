...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool DanhSachChiTietTaiSanGiamNoiBo()//M
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_DanhSachChiTietTaiSanGiamNoiBo", "@TuNgay,@DenNgay,@MaBoPhan", tuNgay, denNgay, maBoPhan);
                #region Extend table
