...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool BangTongHopTangGiamDieuChuyenNoiBo()//M
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_BangTongHopTangGiamDieuChuyenNoiBo", "@TuNgay,@DenNgay,@MaBoPhan", tuNgay, denNgay, maBoPhan);
                #region Extend table
