...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool TongHopTaiSanGiamTrongKyTheoTaiKhoan()//M
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_TongHopTaiSanGiamTrongKyTheoTaiKhoan", "@TuNgay,@DenNgay,@MaBoPhan,@HinhThucGiam", tuNgay, denNgay, maBoPhan, hinhThucGiam);
                #region Extend table
