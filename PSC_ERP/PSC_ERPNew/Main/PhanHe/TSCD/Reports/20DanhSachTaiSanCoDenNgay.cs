...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool DanhSachTaiSanCoDenNgay()//M
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_DanhSachTaiSanCoDenNgay", "@DenNgay,@MaBoPhan,@NguonMua,@LoaiBaoCao,@MaCongTy", denNgay, maBoPhan, nguonMua,LoaiBaoCao, _maCongTy);
                #region Extend table
