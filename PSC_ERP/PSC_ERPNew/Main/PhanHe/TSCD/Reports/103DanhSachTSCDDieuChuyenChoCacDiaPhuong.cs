...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool DanhSachTSCDDieuChuyenChoCacDiaPhuong()
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_DanhSachTSCDDieuChuyenChoCacDiaPhuong", "@TuNgay,@DenNgay", tuNgay, denNgay);
                #region Extend table
