...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool DanhSachTaiSanDuAnvaNhapLeCoDenNgay()//M
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_DanhSachTaiSanDuAnvaNhapLeCoDenNgay", "@DenNgay,@MaBoPhan,@LoaiBaoCao", denNgay, maBoPhan,LoaiBaoCao);
                #region Extend table
