...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool DanhSachChiTietTaiSanTangNoiBo()//M
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_DanhSachChiTietTaiSanTangNoiBo", "@TuNgay,@DenNgay,@MaBoPhan", tuNgay, denNgay, maBoPhan);
                #region Extend table
