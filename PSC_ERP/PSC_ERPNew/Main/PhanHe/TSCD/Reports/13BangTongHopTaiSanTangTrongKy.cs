...
namespace PSC_ERPNew.Main.PhanHe.TSCD.Reports
{
    ...
    {
        public bool BangTongHopTaiSanTangTrongKy()//M
        {
            ...
            ReportHelper.ShowReport(key, () =>
            {
                ...
                dataAccess.FillDataSet(ref dataSet, "MainData", "spRpt_TSCD_BangTongHopTaiSanTangTrongKy", "@TuNgay,@DenNgay,@MaBoPhan,@LoaiBaoCao,@MaCongTy",tuNgay, denNgay, maBoPhan,LoaiBaoCao,_maCongTy);
                #region Extend table
