...
//using PSC_ERPNew.Main.PhanHe.DIGITIZING.Util;
//using PSC_ERPNew.Main.PhanHe.DIGITIZING.Sys;


namespace PSC_ERPNew.Main.PhanHe.DIGITIZING
{
    public partial class frmDigitizingModule : RibbonForm
    {


        #region Singleton
        private static frmDigitizingModule singleton_ = null;
        public static frmDigitizingModule Singleton
        {
            get
            {
                if (singleton_ == null || singleton_.IsDisposed)
                    singleton_ = new frmDigitizingModule();
                return singleton_;
            }
        }
        ...
        private void BasicConfig()
        {
            ...
            //load menu
            PSC_ERPNew.Main.Util.LoadMenu.LoadMenuChoPhanHe(maPhanHeQL: "DIGITIZING", owner: this, ribbon: this.ribbonControl1);
        ...
        private void frmDigitizingModule_Load(object sender, EventArgs e)
        {
