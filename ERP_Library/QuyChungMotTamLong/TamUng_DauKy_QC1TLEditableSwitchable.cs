...
{ 
	[Serializable()] 
	public class TamUng_DauKy_QC1TL : Csla.BusinessBase<TamUng_DauKy_QC1TL>
	{
        ...
        private TamUng_DauKy_QC1TL()
		{ /* require use of factory method */ }

        public static TamUng_DauKy_QC1TL NewTamUng_DauKy_QC1TL()
		{
            TamUng_DauKy_QC1TL item = new TamUng_DauKy_QC1TL();
            item.MarkAsChild();
            return item;
		}

        public static TamUng_DauKy_QC1TL GetTamUng_DauKy_QC1TL(int id)
		{
            return DataPortal.Fetch<TamUng_DauKy_QC1TL>(new Criteria(id));
		}

        public static void DeleteTamUng_DauKy_QC1TL(int id)
		{
        ...
        internal static TamUng_DauKy_QC1TL NewTamUng_DauKy_QC1TLChild()
		{
            TamUng_DauKy_QC1TL child = new TamUng_DauKy_QC1TL();
			child.ValidationRules.CheckRules();
			child.MarkAsChild();
			return child;
		}

        internal static TamUng_DauKy_QC1TL GetTamUng_DauKy_QC1TL(SafeDataReader dr)
		{
            TamUng_DauKy_QC1TL child = new TamUng_DauKy_QC1TL();
			child.MarkAsChild();
			child.Fetch(dr);
		...
		private void ExecuteFetch(SqlTransaction tr, Criteria criteria)
		{
			using (SqlCommand cm = tr.Connection.CreateCommand())
			{
                ...
                cm.CommandText = "spd_SelecttblTamUng_SoDuDauKy_QC1TL";
		...
		private void ExecuteDelete(SqlTransaction tr, Criteria criteria)
		{
			using (SqlCommand cm = tr.Connection.CreateCommand())
			{
				cm.Transaction = tr;
				cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "spd_DeletetblTamUng_SoDuDauKy_QC1TL";
		...
		#region Data Access - Insert
		internal void Insert(SqlTransaction tr, TamUng_DauKy_QC1TLList parent)
		{
			if (!IsDirty) return;
		...
		private void ExecuteInsert(SqlTransaction tr, TamUng_DauKy_QC1TLList parent)
		{
			using (SqlCommand cm = tr.Connection.CreateCommand())
			{
				cm.Transaction = tr;
				cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "spd_InserttblTamUng_SoDuDauKy_QC1TL";
		...
		private void AddInsertParameters(SqlCommand cm, TamUng_DauKy_QC1TLList parent)
		{
		...
		#region Data Access - Update
		internal void Update(SqlTransaction tr, TamUng_DauKy_QC1TLList parent)
		{
			if (!IsDirty) return;
		...
		private void ExecuteUpdate(SqlTransaction tr, TamUng_DauKy_QC1TLList parent)
		{
			using (SqlCommand cm = tr.Connection.CreateCommand())
			{
				cm.Transaction = tr;
				cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "spd_UpdatetblTamUng_SoDuDauKy_QC1TL";
		...
		private void AddUpdateParameters(SqlCommand cm, TamUng_DauKy_QC1TLList parent)
		{
			cm.Parameters.AddWithValue("@ID", _id);
			cm.Parameters.AddWithValue("@MaDoiTuong", _maDoiTuong);
			if (_soDuThuDauKy != 0)
