...
{ 
	[Serializable()]
    public class TamUng_QC1TL : Csla.BusinessBase<TamUng_QC1TL>
	{
	...
	//	private string _tenNhanVien = string.Empty;
        ...
        private TamUng_QC1TL()
		{ /* require use of factory method */ }

        public static TamUng_QC1TL NewTamUng_QC1TL()
		{
            TamUng_QC1TL item = new TamUng_QC1TL();
            item.MarkAsChild();
            return item;
		}

        public static TamUng_QC1TL GetTamUng_QC1TL(int maTamUng)
		{
            return DataPortal.Fetch<TamUng_QC1TL>(new Criteria(maTamUng));
		}

        public static void DeleteTamUng_QC1TL(int maTamUng)
		{
        ...
        internal static TamUng_QC1TL NewTamUng_QC1TLChild()
		{
            TamUng_QC1TL child = new TamUng_QC1TL();
			child.ValidationRules.CheckRules();
			child.MarkAsChild();
			return child;
		}

        internal static TamUng_QC1TL GetTamUng_QC1TL(SafeDataReader dr)
		{
            TamUng_QC1TL child = new TamUng_QC1TL();
			child.MarkAsChild();
			child.Fetch(dr);
		...
		private void ExecuteFetch(SqlTransaction tr, Criteria criteria)
		{
			using (SqlCommand cm = tr.Connection.CreateCommand())
			{
                ...
                cm.CommandText = "spd_SelecttblTamUng_QC1TL";
		...
		private void ExecuteDelete(SqlTransaction tr, Criteria criteria)
		{
			using (SqlCommand cm = tr.Connection.CreateCommand())
			{
				cm.Transaction = tr;
				cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "spd_DeletetblTamUng_QC1TL";
        ...
        private void ExecuteInsert(SqlTransaction tr, long maChungTu,string soChungTu)
		{
			using (SqlCommand cm = tr.Connection.CreateCommand())
			{
				cm.Transaction = tr;
				cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "spd_InserttblTamUng_QC1TL";
        ...
        private void ExecuteUpdate(SqlTransaction tr, long maChungTu,string soChungTu)
		{
			using (SqlCommand cm = tr.Connection.CreateCommand())
			{
				cm.Transaction = tr;
				cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "spd_UpdatetblTamUng_QC1TL";
