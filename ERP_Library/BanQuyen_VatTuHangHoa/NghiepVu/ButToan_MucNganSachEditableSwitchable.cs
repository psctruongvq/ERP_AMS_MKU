...
{ 
	[Serializable()] 
	public class ButToan_MucNganSach : Csla.BusinessBase<ButToan_MucNganSach>
	{
		...
		private ButToan_MucNganSach()
		{ /* require use of factory method */ }

		public static ButToan_MucNganSach NewButToan_MucNganSach()
		{
			if (!CanAddObject())
				throw new System.Security.SecurityException("User not authorized to add a ButToan_MucNganSach");
			return DataPortal.Create<ButToan_MucNganSach>();
		}

		public static ButToan_MucNganSach GetButToan_MucNganSach(int maButToanMucNganSach)
		{
			if (!CanGetObject())
				throw new System.Security.SecurityException("User not authorized to view a ButToan_MucNganSach");
			return DataPortal.Fetch<ButToan_MucNganSach>(new Criteria(maButToanMucNganSach));
		}

        public static ButToan_MucNganSach GetButToan_MucNganSachByMaButToan(int maButToan)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException("User not authorized to view a ButToan_MucNganSach");
            return DataPortal.Fetch<ButToan_MucNganSach>(new CriteriaByMaButToan(maButToan));
        }
		...
		public override ButToan_MucNganSach Save()
		{
		...
		internal static ButToan_MucNganSach NewButToan_MucNganSachChild()
		{
			ButToan_MucNganSach child = new ButToan_MucNganSach();
			child.ValidationRules.CheckRules();
			child.MarkAsChild();
			return child;
		}

		internal static ButToan_MucNganSach GetButToan_MucNganSach(SafeDataReader dr)
		{
			ButToan_MucNganSach child =  new ButToan_MucNganSach();
			child.MarkAsChild();
			child.Fetch(dr);
