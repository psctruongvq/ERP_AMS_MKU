...
{
    [Serializable()]
    public class CT_PhieuXuat : Csla.BusinessBase<CT_PhieuXuat>
    {
        ...
        public decimal SLgCt_PNhap//M
        {
            ...
            set
            {
                CanWriteProperty("SLgCt_PNhap", true);
                if (!_sLgCt_PNhap.Equals(value))
                {
                    _sLgCt_PNhap = value;
                    PropertyHasChanged("SLgCt_PNhap");
                }
            }
        }
        ...
        public static CT_PhieuXuat NewCT_PhieuXuat()
        {
            return new CT_PhieuXuat();
        }

        internal static CT_PhieuXuat NewCT_PhieuXuat(CT_PhieuNhap _ctPhieuNhap, int _loai)
        {
            return new CT_PhieuXuat(_ctPhieuNhap, _loai);
        }
        public static CT_PhieuXuat NewCT_PhieuXuat(ChuongTrinhBanQuyenCon _chuongTrinhBanQuyenCon, long _maPhieuNhapxuat, int _maBoPhan, int _maKho, DateTime _ngayNX, string _dienGiaiPhieu)
        {
            return new CT_PhieuXuat(_chuongTrinhBanQuyenCon, _maPhieuNhapxuat, _maBoPhan, _maKho, _ngayNX, _dienGiaiPhieu);
        }
        internal static CT_PhieuXuat NewCT_PhieuXuat(CT_PhieuNhap _ctPhieuNhap, int _maKho, DateTime _ngayNX)
        {
            return new CT_PhieuXuat(_ctPhieuNhap, _maKho, _ngayNX);
        }
        internal static CT_PhieuXuat NewCT_PhieuXuat(CT_PhieuNhap _ctPhieuNhap, DateTime _ngayNX)//Cho Xuat Thang
        {
            return new CT_PhieuXuat(_ctPhieuNhap, _ngayNX);
        }
        internal static CT_PhieuXuat GetCT_PhieuXuat(SafeDataReader dr)
        {
            return new CT_PhieuXuat(dr);
        }

        private CT_PhieuXuat()
        {

            ValidationRules.CheckRules();
            MarkAsChild();
        }
        private CT_PhieuXuat(ChuongTrinhBanQuyenCon ctbq, long _maPhieuNhapxuat, int _maBoPhan, int _maKho, DateTime _ngayNX, string _dienGiaiphieu)
        {
        ...
        public CT_PhieuXuat(CT_KiemKeTonKho cT_KiemKeTonKho)
        {
        ...
        public CT_PhieuXuat(CT_PhieuLinhNhienLieu cT_PhieuLinhNhienLieu, int maKho, DateTime ngayNX)
        {
            //
        ...
        public CT_PhieuXuat(CT_PhieuNhap _ctPhieuNhap, int _loai)
        {
            if (_loai == 4)
            {
                long maHopDong = 0;
        ...
        public CT_PhieuXuat(CT_PhieuNhap _ctPhieuNhap, int _maKho, DateTime _ngayLap)//
        {
            _maPhieuNhap = _ctPhieuNhap.MaPhieuNhap;
            _maHangHoa = _ctPhieuNhap.MaHangHoa;
            _donGia = _ctPhieuNhap.DonGia;
        ...
        public CT_PhieuXuat(CT_PhieuNhap _ctPhieuNhap, int maBoPhan, int _maKho, long maHopDong, DateTime _ngayLap)//Binh Quan Ban Quyen
        {
        ...
        public CT_PhieuXuat(CT_PhieuNhap _ctPhieuNhap, DateTime _ngayLap)//Cho Xuat Thang Vat tu Hang hoa
        {
            _maPhieuNhap = _ctPhieuNhap.MaPhieuNhap;
            //_soPhieuNhap = PhieuNhapXuat.GetPhieuNhapXuat(_maPhieuNhap).SoPhieu;
            if (_ctPhieuNhap.SoPhieu + "" == "")
            {
                _soPhieuNhap = PhieuNhapXuat.GetPhieuNhapXuat(_maPhieuNhap).SoPhieu;
            }   
            else
            {
                _soPhieuNhap = _ctPhieuNhap.SoPhieu;
            }
            ...
            else if (_soLuong == _ctPhieuNhap.SoLuong)
                _thanhTien = _ctPhieuNhap.ThanhTien;
            else
                _thanhTien = Math.Round(_donGia * _soLuong, 0, MidpointRounding.AwayFromZero);
            //
            ...
            _maBoPhan = _ctPhieuNhap.MaBoPhan;
            _maChiTietPhieuNhap = _ctPhieuNhap.MaChiTietPhieuNhap;
            _maCT_KetChuyen = _ctPhieuNhap.MaCT_KetChuyen;
            ValidationRules.CheckRules();
            MarkAsChild();
        }//END Cho Xuat Thang Vat tu Hang hoa
        public CT_PhieuXuat(CT_PhieuNhap _ctPhieuNhap, int maBoPhan, int _maKho, int _phuongPhapNX, long maHopDong, DateTime _ngayLap)//Cho Xuat Thang and Binh Quan Ban Quyen
        {
             _maPhieuNhap = _ctPhieuNhap.MaPhieuNhap;
            _soPhieuNhap = PhieuNhapXuat.GetPhieuNhapXuat(_maPhieuNhap).SoPhieu;
            _maHangHoa = _ctPhieuNhap.MaHangHoa;
        ...
        public CT_PhieuXuat(CT_PhieuXuat _ctPhieuXuat)
        {
            _maPhieuNhap = 0;
        ...
        public CT_PhieuXuat(CT_PhieuXuat _ctPhieuXuat, int _maKho, DateTime _ngayLap)
        {
            _maPhieuNhap = 0;
            _maHangHoa = _ctPhieuXuat.MaHangHoa;
            _donGia = _ctPhieuXuat.DonGia;
        ...
        private CT_PhieuXuat(SafeDataReader dr)
        {
            MarkAsChild();
            Fetch(dr);
        }
        ...
        private void FetchObject(SafeDataReader dr)
        {
            ...
            //_soPhieuNhap = PhieuNhapXuat.GetPhieuNhapXuat(_maPhieuNhap).SoPhieu;
            _soPhieuNhap = dr.GetString("SoPhieuNhap");
            ...
            _sLgCt_PNhap = dr.GetDecimal("sLgCt_PNhap");
