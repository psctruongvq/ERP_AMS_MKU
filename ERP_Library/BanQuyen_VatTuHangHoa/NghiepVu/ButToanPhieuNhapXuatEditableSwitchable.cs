...
{ 
   //thuyên
	[Serializable()] 
	public class ButToanPhieuNhapXuat : Csla.BusinessBase<ButToanPhieuNhapXuat>
	{
		...
		private ButToan_MucNganSach _butToan_MucNganSach = ButToan_MucNganSach.NewButToan_MucNganSach();
		...
		public ButToan_MucNganSach ButToan_MucNganSach
		{
			get
			{
		...
		private ButToanPhieuNhapXuat()
        { /* require use of factory method */  MarkAsChild(); }
        public ButToanPhieuNhapXuat(ButToanPhieuNhapXuat btPhieuNhapXuat)
        {
		...
		public static ButToanPhieuNhapXuat NewButToanPhieuNhapXuat()
		{
			if (!CanAddObject())
				throw new System.Security.SecurityException("User not authorized to add a ButToanPhieuNhapXuat");
			return DataPortal.Create<ButToanPhieuNhapXuat>();
		}

		public static ButToanPhieuNhapXuat GetButToanPhieuNhapXuat(int maButToan)
		{
			if (!CanGetObject())
				throw new System.Security.SecurityException("User not authorized to view a ButToanPhieuNhapXuat");
			return DataPortal.Fetch<ButToanPhieuNhapXuat>(new Criteria(maButToan));
		}
		...
		public override ButToanPhieuNhapXuat Save()
		{
		...
		internal static ButToanPhieuNhapXuat NewButToanPhieuNhapXuatChild()
		{
			ButToanPhieuNhapXuat child = new ButToanPhieuNhapXuat();
			child.ValidationRules.CheckRules();
			child.MarkAsChild();
			return child;
		}

		internal static ButToanPhieuNhapXuat GetButToanPhieuNhapXuat(SafeDataReader dr)
		{
			ButToanPhieuNhapXuat child =  new ButToanPhieuNhapXuat();
			child.MarkAsChild();
			child.Fetch(dr);
		...
		private void FetchChildren(SafeDataReader dr)
		{
			...
			_butToan_MucNganSach = ButToan_MucNganSach.GetButToan_MucNganSachByMaButToan(this.MaButToan);
            if (_butToan_MucNganSach.MaButToanMucNganSach == 0)
                _butToan_MucNganSach = ButToan_MucNganSach.NewButToan_MucNganSach();
            else _maTieuMuc = _butToan_MucNganSach.MaTieuMuc;
            _chungTu_HoaDonList = ChungTu_HoaDonList.GetChungTu_HoaDonListByMaBuToan(_maButToan);
