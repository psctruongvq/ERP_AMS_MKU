...
{
    [Serializable()]
    public class ChuongTrinh_NewBQ : Csla.BusinessBase<ChuongTrinh_NewBQ>
    {
        ...
        public int MaNguonCT
        {
            get { return _maNguonCT; }
        }
        ...
        private ChuongTrinh_NewBQ()
        { /* require use of factory method */ }

        public static ChuongTrinh_NewBQ NewChuongTrinh_New()
        {
            if (!CanAddObject())
                throw new System.Security.SecurityException("User not authorized to add a ChuongTrinh_New");
            return DataPortal.Create<ChuongTrinh_NewBQ>();
        }
        public static ChuongTrinh_NewBQ NewChuongTrinh_New(string tenChuongTrinh)
        {
            ChuongTrinh_NewBQ ct = ChuongTrinh_NewBQ.NewChuongTrinh_New();
            ct.TenChuongTrinh = tenChuongTrinh;
            return ct;
        }

        public static ChuongTrinh_NewBQ GetChuongTrinh_New(int maChuongTrinh)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException("User not authorized to view a ChuongTrinh_New");
            return DataPortal.Fetch<ChuongTrinh_NewBQ>(new Criteria(maChuongTrinh));
        }
        ...
        public override ChuongTrinh_NewBQ Save()
        {
        ...
        public static decimal GetSoLuongChuongTrinhBanQuyen_NXT(long maPhieuXuat, int maBoPhan, int maKho, int phuongPhapNX, long maPhieuNhap, int maChuongTrinhCon, long maHopDong, DateTime ngay, int maChiTietPhieuNhap)//M
        {
            decimal kqSoLuong = 0;
            ...
            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "Spd_GetSoLuongChuongTrinhBanQuyen_NXT_BQ";
                    ...
                    cm.Parameters.AddWithValue("@maChuongTrinh", maChuongTrinhCon);
        ...
        public static decimal GetGiaTriChuongTrinhBanQuyen_NXT(long maPhieuXuat, int maBoPhan, int maKho, int phuongPhapNX, long maPhieuNhap, int maChuongTrinhCon, long maHopDong, DateTime ngay, int maChiTietPhieuNhap)//M
        {
            decimal kqSoLuong = 0;
            ...
            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "Spd_GetGiaTriChuongTrinhBanQuyen_NXT_BQ";
                    cm.Parameters.AddWithValue("@maPhieuXuat", maPhieuXuat);
                    cm.Parameters.AddWithValue("@maBoPhan", maBoPhan);
                    cm.Parameters.AddWithValue("@maKho", maKho);
                    cm.Parameters.AddWithValue("@phuongPhapNX", phuongPhapNX);
        ...
        public static decimal GetGiaTriChuongTrinhBanQuyen_PhanBoSungGiaTri_NXT(long maPhieuXuat, int maBoPhan, int maKho, int phuongPhapNX, long maPhieuNhap, int maChuongTrinhCon, long maHopDong, DateTime ngay, int maChiTietPhieuNhap)//M
        {
            decimal kqSoLuong = 0;
            ...
            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "Spd_GetGiaTriChuongTrinhBanQuyen_PhanBoSungGiaTri_NXT_BQ";
                    cm.Parameters.AddWithValue("@maPhieuXuat", maPhieuXuat);
                    cm.Parameters.AddWithValue("@maBoPhan", maBoPhan);
                    cm.Parameters.AddWithValue("@maKho", maKho);
                    cm.Parameters.AddWithValue("@phuongPhapNX", phuongPhapNX);
        ...
        public static decimal GetSoLuongChuongTrinhBanQuyenTheoMaChiTietPhieuNhap_NXT(long maPhieuXuat, int maChiTietPhieuNhap, DateTime ngay)//M
        {
            decimal kqSoLuong = 0;
            ...
            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "Spd_GetSoLuongChuongTrinhBanQuyenTheoMaChiTietPhieuNhap_NXT_BQ";
                    cm.Parameters.AddWithValue("@maPhieuXuat", maPhieuXuat);
                    cm.Parameters.AddWithValue("@maChiTietPhieuNhap", maChiTietPhieuNhap);
                    cm.Parameters.AddWithValue("@ngay", ngay);
                    SqlParameter prmSoLuongTraVe = new SqlParameter("@GiaTriTraVe", SqlDbType.Decimal, 16);
        ...
        public static decimal GetGiaTriChuongTrinhBanQuyenTheoMaChiTietPhieuNhap_NXT(long maPhieuXuat, int maChiTietPhieuNhap, DateTime ngay)//M
        {
            decimal kqSoLuong = 0;
            ...
            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "Spd_GetGiaTriChuongTrinhBanQuyenTheoMaChiTietPhieuNhap_NXT_BQ";
                    cm.Parameters.AddWithValue("@maPhieuXuat", maPhieuXuat);
                    cm.Parameters.AddWithValue("@maChiTietPhieuNhap", maChiTietPhieuNhap);
                    cm.Parameters.AddWithValue("@ngay", ngay);
                    SqlParameter prmSoLuongTraVe = new SqlParameter("@GiaTriTraVe", SqlDbType.Decimal, 16);
        ...
        public static decimal GetSoLuongChuongTrinhBanQuyen(long maPhieuXuat, int maBoPhan, int maKho, int maChuongTrinhCon, long maHopDong, DateTime ngay)//M
        {
            decimal kqSoLuong = 0;
            ...
            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "Spd_GetSoLuongChuongTrinhBanQuyen_BQ";
                    cm.Parameters.AddWithValue("@maPhieuXuat", maPhieuXuat);
                    cm.Parameters.AddWithValue("@maBoPhan", maBoPhan);
                    cm.Parameters.AddWithValue("@maKho", maKho);
                    cm.Parameters.AddWithValue("@maChuongTrinh", maChuongTrinhCon);
        ...
        public static decimal GetGiaTriChuongTrinhBanQuyen(long maPhieuXuat, int maBoPhan, int maKho, int maChuongTrinhCon, long maHopDong, DateTime ngay)
        {
            ...
            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "Spd_GetGiaTriChuongTrinhBanQuyen_BQ ";
                    cm.Parameters.AddWithValue("@maPhieuXuat", maPhieuXuat);
                    cm.Parameters.AddWithValue("@maBoPhan", maBoPhan);
                    cm.Parameters.AddWithValue("@maKho", maKho);
                    cm.Parameters.AddWithValue("@maChuongTrinh", maChuongTrinhCon);
        ...
        public static decimal GetGiaBinhQuanChuongTrinhBanQuyen(long maPhieuXuat, int maBoPhan, int maKho, int maChuongTrinhCon, long maHopDong, DateTime ngay)
        {
            decimal kqGiaBinhQuan = 0;
            ...
            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "Spd_GetGiaTriBinhQuanChuongTrinhBanQuyen_BQ";
                    cm.Parameters.AddWithValue("@maPhieuXuat", maPhieuXuat);
                    cm.Parameters.AddWithValue("@maBoPhan", maBoPhan);
                    cm.Parameters.AddWithValue("@maKho", maKho);
                    cm.Parameters.AddWithValue("@maChuongTrinh", maChuongTrinhCon);
        ...
        internal static ChuongTrinh_NewBQ NewChuongTrinh_NewChild()
        {
            ChuongTrinh_NewBQ child = new ChuongTrinh_NewBQ();
            child.ValidationRules.CheckRules();
            child.MarkAsChild();
            return child;
        }

        internal static ChuongTrinh_NewBQ GetChuongTrinh_New(SafeDataReader dr)
        {
            ChuongTrinh_NewBQ child = new ChuongTrinh_NewBQ();
            child.MarkAsChild();
            child.Fetch(dr);
        ...
        private void FetchObject(SafeDataReader dr)
        {
            ...
            _maNguonCT = dr.GetInt32("MaNguonCT");
        ...
        #region Data Access - Insert
        internal void Insert(SqlConnection cn, ChuongTrinh_NewBQList parent)
        {
            if (!IsDirty) return;
        ...
        private void ExecuteInsert(SqlConnection cn, ChuongTrinh_NewBQList parent)
        {
            using (SqlCommand cm = cn.CreateCommand())
            {
                cm.CommandType = CommandType.StoredProcedure;
        ...
        private void AddInsertParameters(SqlCommand cm, ChuongTrinh_NewBQList parent)
        {
        ...
        #region Data Access - Update
        internal void Update(SqlConnection cn, ChuongTrinh_NewBQList parent)
        {
            if (!IsDirty) return;
        ...
        private void ExecuteUpdate(SqlConnection cn, ChuongTrinh_NewBQList parent)
        {
            using (SqlCommand cm = cn.CreateCommand())
            {
                cm.CommandType = CommandType.StoredProcedure;
        ...
        private void AddUpdateParameters(SqlCommand cm, ChuongTrinh_NewBQList parent)
        {
            cm.Parameters.AddWithValue("@MaChuongTrinh", _maChuongTrinh);
            if (_maQL.Length > 0)
                cm.Parameters.AddWithValue("@MaQL", _maQL);
