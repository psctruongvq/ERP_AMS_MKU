...
{ 
   //thuyên
	[Serializable()]
    public class ButToanPhieuNhapXuatBQ : Csla.BusinessBase<ButToanPhieuNhapXuatBQ>
	{
        ...
        private ButToan_MucNganSachBQ _butToan_MucNganSach = ButToan_MucNganSachBQ.NewButToan_MucNganSach();
        private ChungTu_HoaDonBQList _chungTu_HoaDonList = ChungTu_HoaDonBQList.NewChungTu_HoaDonList();
        ...
        public ButToan_MucNganSachBQ ButToan_MucNganSach
		{
			get
			{
		...
		private ButToanPhieuNhapXuatBQ()
        { /* require use of factory method */  MarkAsChild(); }
        public ButToanPhieuNhapXuatBQ(ButToanPhieuNhapXuatBQ btPhieuNhapXuat)
        {
        ...
        public static ButToanPhieuNhapXuatBQ NewButToanPhieuNhapXuat()
		{
			if (!CanAddObject())
				throw new System.Security.SecurityException("User not authorized to add a ButToanPhieuNhapXuat");
            return DataPortal.Create<ButToanPhieuNhapXuatBQ>();
		}

        public static ButToanPhieuNhapXuatBQ GetButToanPhieuNhapXuat(int maButToan)
		{
			if (!CanGetObject())
				throw new System.Security.SecurityException("User not authorized to view a ButToanPhieuNhapXuat");
            return DataPortal.Fetch<ButToanPhieuNhapXuatBQ>(new Criteria(maButToan));
		}
        ...
        public override ButToanPhieuNhapXuatBQ Save()
		{
        ...
        internal static ButToanPhieuNhapXuatBQ NewButToanPhieuNhapXuatChild()
		{
            ButToanPhieuNhapXuatBQ child = new ButToanPhieuNhapXuatBQ();
			child.ValidationRules.CheckRules();
			child.MarkAsChild();
			return child;
		}

        internal static ButToanPhieuNhapXuatBQ GetButToanPhieuNhapXuat(SafeDataReader dr)
		{
            ButToanPhieuNhapXuatBQ child = new ButToanPhieuNhapXuatBQ();
			child.MarkAsChild();
			child.Fetch(dr);
		...
		private void FetchChildren(SafeDataReader dr)
		{
            ...
            _butToan_MucNganSach = ButToan_MucNganSachBQ.GetButToan_MucNganSachByMaButToan(this.MaButToan);
            if (_butToan_MucNganSach.MaButToanMucNganSach == 0)
                _butToan_MucNganSach = ButToan_MucNganSachBQ.NewButToan_MucNganSach();
            else _maTieuMuc = _butToan_MucNganSach.MaTieuMuc;
            _chungTu_HoaDonList = ChungTu_HoaDonBQList.GetChungTu_HoaDonListByMaBuToan(_maButToan);
