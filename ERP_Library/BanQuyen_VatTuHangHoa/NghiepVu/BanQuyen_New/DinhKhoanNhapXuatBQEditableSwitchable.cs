...
{ 
	[Serializable()] 
	public class DinhKhoanNhapXuatBQ : Csla.BusinessBase<DinhKhoanNhapXuatBQ>
	{
		...
		private DinhKhoanNhapXuatBQ()
		{ /* require use of factory method */ }

        public static DinhKhoanNhapXuatBQ NewDinhKhoanNhapXuat()
		{
			if (!CanAddObject())
				throw new System.Security.SecurityException("User not authorized to add a DinhKhoanNhapXuat");
            return DataPortal.Create<DinhKhoanNhapXuatBQ>();
		}

        public static DinhKhoanNhapXuatBQ GetDinhKhoanNhapXuat(int maDinhKhoan)
		{
			if (!CanGetObject())
				throw new System.Security.SecurityException("User not authorized to view a DinhKhoanNhapXuat");
            return DataPortal.Fetch<DinhKhoanNhapXuatBQ>(new Criteria(maDinhKhoan));
		}
        ...
        public override DinhKhoanNhapXuatBQ Save()
		{
        ...
        internal static DinhKhoanNhapXuatBQ NewDinhKhoanNhapXuatChild()
		{
            DinhKhoanNhapXuatBQ child = new DinhKhoanNhapXuatBQ();
			child.ValidationRules.CheckRules();
			child.MarkAsChild();
			return child;
		}

        internal static DinhKhoanNhapXuatBQ GetDinhKhoanNhapXuat(SafeDataReader dr)
		{
            DinhKhoanNhapXuatBQ child = new DinhKhoanNhapXuatBQ();
			child.MarkAsChild();
			child.Fetch(dr);
