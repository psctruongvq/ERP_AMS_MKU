...
{
    [Serializable()]
    public class CT_KetChuyenTonKhoBanQuyenBQ : Csla.BusinessBase<CT_KetChuyenTonKhoBanQuyenBQ>
    {
        ...
        internal static CT_KetChuyenTonKhoBanQuyenBQ NewCT_KetChuyenTonKhoBanQuyen()
        {
            return new CT_KetChuyenTonKhoBanQuyenBQ();
        }

        internal static CT_KetChuyenTonKhoBanQuyenBQ GetCT_KetChuyenTonKhoBanQuyen(SafeDataReader dr, bool kieu)
        {
            return new CT_KetChuyenTonKhoBanQuyenBQ(dr, kieu);
        }

        private CT_KetChuyenTonKhoBanQuyenBQ()
        {
        ...
        private CT_KetChuyenTonKhoBanQuyenBQ(SafeDataReader dr, bool kieu)
        {
            MarkAsChild();
            Fetch(dr, kieu);
        }
        ...
        private void FetchObject(SafeDataReader dr)
        {
            ...
            _tenBoPhan = BoPhan.GetBoPhan(KetChuyenTonKhoBanQuyen.GetKetChuyenTonKhoBanQuyen(_maKetChuyenBQ).MaBoPhan).TenBoPhan;
        }
        ...
        internal void Insert(SqlTransaction tr, KetChuyenTonKhoBanQuyenBQ parent)
        {
            if (!IsDirty) return;
        ...
        private void ExecuteInsert(SqlTransaction tr, KetChuyenTonKhoBanQuyenBQ parent)
        {
            using (SqlCommand cm = tr.Connection.CreateCommand())
            {
                cm.Transaction = tr;
                cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "spd_InserttblCT_KetChuyenTonKhoBanQuyen_BQ";
        ...
        private void AddInsertParameters(SqlCommand cm, KetChuyenTonKhoBanQuyenBQ parent)
        {
        ...
        private void ExecuteUpdate(SqlTransaction tr, KetChuyenTonKhoBanQuyenBQ parent)
        {
            using (SqlCommand cm = tr.Connection.CreateCommand())
            {
                cm.Transaction = tr;
                cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "spd_UpdatetblCT_KetChuyenTonKhoBanQuyen_BQ";
        ...
        private void AddUpdateParameters(SqlCommand cm, KetChuyenTonKhoBanQuyenBQ parent)
        {
            cm.Parameters.AddWithValue("@MaCT_KetChuyen", _mactKetchuyen);
            if (_maHopDong != 0)
                cm.Parameters.AddWithValue("@MaHopDong", _maHopDong);
