...
{
    [Serializable()]
    public class KetChuyenTonKhoBanQuyenBQ : Csla.BusinessBase<KetChuyenTonKhoBanQuyenBQ>
    {
        ...
        private CT_KetChuyenTonKhoBanQuyenBQList _ct_KetChuyenTonKhoBanQuyenList = CT_KetChuyenTonKhoBanQuyenBQList.NewCT_KetChuyenTonKhoBanQuyenList();
        ...
        public CT_KetChuyenTonKhoBanQuyenBQList CT_KetChuyenTonKhoBanQuyenList
        {
            get
            {
        ...
        private KetChuyenTonKhoBanQuyenBQ()
        { /* require use of factory method */ }

        public static KetChuyenTonKhoBanQuyenBQ NewKetChuyenTonKhoBanQuyen()
        {
            if (!CanAddObject())
                throw new System.Security.SecurityException("User not authorized to add a KetChuyenTonKhoBanQuyen");
            return DataPortal.Create<KetChuyenTonKhoBanQuyenBQ>();
        }

        public static KetChuyenTonKhoBanQuyenBQ GetKetChuyenTonKhoBanQuyen(long maKetChuyenBQ)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException("User not authorized to view a KetChuyenTonKhoBanQuyen");
            return DataPortal.Fetch<KetChuyenTonKhoBanQuyenBQ>(new Criteria(maKetChuyenBQ));
        }
        public static KetChuyenTonKhoBanQuyenBQ GetKetChuyenTonKhoBanQuyen(int maKy, int maKho, int maBoPhan)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException("User not authorized to view a KetChuyenTonKhoBanQuyen");
            return DataPortal.Fetch<KetChuyenTonKhoBanQuyenBQ>(new CriteriaByKyAndKhoAndBoPhan(maKy, maKho, maBoPhan));
        }
        ...
        public override KetChuyenTonKhoBanQuyenBQ Save()
        {
        ...
        public static KetChuyenTonKhoBanQuyenBQ NewKetChuyenTonKhoBanQuyen(int maKy, int maKho, int maBoPhan)
        {
            KetChuyenTonKhoBanQuyenBQ _ketChuyenTonKhoBanQuyen = new KetChuyenTonKhoBanQuyenBQ();
            ...
            _ketChuyenTonKhoBanQuyen._ct_KetChuyenTonKhoBanQuyenList = CT_KetChuyenTonKhoBanQuyenBQList.NewCT_KetChuyenTonKhoBanQuyenList();
        ...
        internal static KetChuyenTonKhoBanQuyenBQ NewKetChuyenTonKhoBanQuyenChild()
        {
            KetChuyenTonKhoBanQuyenBQ child = new KetChuyenTonKhoBanQuyenBQ();
            child.ValidationRules.CheckRules();
            child.MarkAsChild();
            return child;
        }

        internal static KetChuyenTonKhoBanQuyenBQ GetKetChuyenTonKhoBanQuyen(SafeDataReader dr)
        {
            KetChuyenTonKhoBanQuyenBQ child = new KetChuyenTonKhoBanQuyenBQ();
            child.MarkAsChild();
            child.Fetch(dr);
        ...
        {
            _ct_KetChuyenTonKhoBanQuyenList = CT_KetChuyenTonKhoBanQuyenBQList.GetCT_KetChuyenTonKhoBanQuyenList(this.MaKetChuyenBQ);
        }
        #endregion //Data Access - Fetch

        #region Data Access - Insert
        internal void Insert(SqlTransaction tr, KetChuyenTonKhoBanQuyenBQList parent)
        {
            if (!IsDirty) return;
        ...
        private void ExecuteInsert(SqlTransaction tr, KetChuyenTonKhoBanQuyenBQList parent)
        {
            using (SqlCommand cm = tr.Connection.CreateCommand())
            {
                cm.Transaction = tr;
        ...
        private void AddInsertParameters(SqlCommand cm, KetChuyenTonKhoBanQuyenBQList parent)
        {
        ...
        #region Data Access - Update
        internal void Update(SqlTransaction tr, KetChuyenTonKhoBanQuyenBQList parent)
        {
            if (!IsDirty) return;
        ...
        private void ExecuteUpdate(SqlTransaction tr, KetChuyenTonKhoBanQuyenBQList parent)
        {
            using (SqlCommand cm = tr.Connection.CreateCommand())
            {
                cm.Transaction = tr;
        ...
        private void AddUpdateParameters(SqlCommand cm, KetChuyenTonKhoBanQuyenBQList parent)
        {
            cm.Parameters.AddWithValue("@MaKetChuyenBQ", _maKetChuyenBQ);
            if (_maKho != 0)
                cm.Parameters.AddWithValue("@MaKho", _maKho);
        ...
        public static bool KiemTraKetChuyenBanQuyen_PhucVuNXvaHuyKetChuyen(DateTime ngay,int maKho, int maBoPhan)
        {
            bool giaTriTraVe = false;
            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "spd_KiemTraKetChuyetBanQuyen_PhucVuNXvaHuyKetChuyen";
