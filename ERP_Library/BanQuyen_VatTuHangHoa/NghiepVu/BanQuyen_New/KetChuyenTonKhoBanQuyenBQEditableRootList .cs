...
{
    [Serializable()]
    public class KetChuyenTonKhoBanQuyenBQList : Csla.BusinessListBase<KetChuyenTonKhoBanQuyenBQList, KetChuyenTonKhoBanQuyenBQ>
    {
        #region BindingList Overrides
        protected override object AddNewCore()
        {
            KetChuyenTonKhoBanQuyenBQ item = KetChuyenTonKhoBanQuyenBQ.NewKetChuyenTonKhoBanQuyen();
            this.Add(item);
            return item;
        }
        ...
        private KetChuyenTonKhoBanQuyenBQList()
        { /* require use of factory method */ }

        public static KetChuyenTonKhoBanQuyenBQList NewKetChuyenTonKhoBanQuyenList()
        {
            if (!CanAddObject())
                throw new System.Security.SecurityException("User not authorized to add a KetChuyenTonKhoBanQuyenList");
            return new KetChuyenTonKhoBanQuyenBQList();
        }

        public static KetChuyenTonKhoBanQuyenBQList GetKetChuyenTonKhoBanQuyenList(int maKho, int maKy, int maNguoiLap)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException("User not authorized to view a KetChuyenTonKhoBanQuyenList");
            return DataPortal.Fetch<KetChuyenTonKhoBanQuyenBQList>(new FilterCriteria(maKho, maKy, maNguoiLap));
        }
        ...
        private void ExecuteFetch(SqlTransaction tr, FilterCriteria criteria)
        {
            using (SqlCommand cm = tr.Connection.CreateCommand())
            {
                ...
                {
                    while (dr.Read())
                        this.Add(KetChuyenTonKhoBanQuyenBQ.GetKetChuyenTonKhoBanQuyen(dr));
                }
            }//using
        }
        ...
        protected override void DataPortal_Update()
        {
            ...
            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
            {
                ...
                try
                {
                    ...
                    foreach (KetChuyenTonKhoBanQuyenBQ deletedChild in DeletedList)
                        deletedChild.DeleteSelf(tr);
                    DeletedList.Clear();

                    // loop through each non-deleted child object
                    foreach (KetChuyenTonKhoBanQuyenBQ child in this)
                    {
                        if (child.IsNew)
