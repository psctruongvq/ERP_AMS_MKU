...
{
    [Serializable()]
    public class PhieuNhapXuat : Csla.BusinessBase<PhieuNhapXuat>
    {
        ...
        private CT_PhieuNXList _cT_PhieuNXList = CT_PhieuNXList.NewCT_PhieuNXList();
        private CT_PhieuNhapList _cT_PhieuNhapList = CT_PhieuNhapList.NewCT_PhieuNhapList();
        private CT_PhieuXuatList _cT_PhieuXuatList = CT_PhieuXuatList.NewCT_PhieuXuatList();
        private DinhKhoanNhapXuat _dinhKhoanNhapXuat = DinhKhoanNhapXuat.NewDinhKhoanNhapXuat();
        private ButToanPhieuNhapXuatList _butToanPhieuNhapXuatList = ButToanPhieuNhapXuatList.NewButToanPhieuNhapXuatList();
        ...
        private CongCuDungCuList _congCuDungCuList = CongCuDungCuList.NewCongCuDungCuList();

        //===========bo sung ngay 2018.03.26====== trinh bay them cot So hoa Don trong danh sach tim kiem        
        ...
        public CT_PhieuNXList CT_PhieuNXList
        {
            get
            {
                CanReadProperty("CT_PhieuNXList", true);
                return _cT_PhieuNXList;
            }
        }

        public CT_PhieuNhapList CT_PhieuNhapList
        {
            get
            {
        ...
        public CT_PhieuXuatList CT_PhieuXuatList
        {
            get
            {
        ...
        public DinhKhoanNhapXuat DinhKhoanNhapXuat
        {
            get
            {
        ...
        public ButToanPhieuNhapXuatList ButToanPhieuNhapXuatList
        {
            get
            {
        ...
        {
            get { return base.IsValid && _cT_PhieuNXList.IsValid && _cT_PhieuNhapList.IsValid && _cT_PhieuXuatList.IsValid && _dinhKhoanNhapXuat.IsValid && _butToanPhieuNhapXuatList.IsValid && _hoaDon_NhapXuatList.IsValid && _nhapXuat_HopDongList.IsValid && _congCuDungCuList.IsValid; }
        }

        public override bool IsDirty
        {
            get { return base.IsDirty || _cT_PhieuNXList.IsDirty || _cT_PhieuNhapList.IsDirty || _cT_PhieuXuatList.IsDirty || _dinhKhoanNhapXuat.IsDirty || _butToanPhieuNhapXuatList.IsDirty || _hoaDon_NhapXuatList.IsDirty || _nhapXuat_HopDongList.IsDirty || _congCuDungCuList.IsDirty; }
        }
        ...
        private PhieuNhapXuat()
        { /* require use of factory method */ }

        public static PhieuNhapXuat NewPhieuNhapXuat()
        {
            if (!CanAddObject())
                throw new System.Security.SecurityException("User not authorized to add a PhieuNhapXuat");
            return DataPortal.Create<PhieuNhapXuat>();
        }

        public static PhieuNhapXuat NewPhieuNhapXuat(PhieuNhapXuat phieuNhapXuat)
        {
            PhieuNhapXuat _phieuNhapXuat = new PhieuNhapXuat();
            ...
            foreach (CT_PhieuNhap ct_PhieuNhap in phieuNhapXuat._cT_PhieuNhapList)
            {
                if (phieuNhapXuat.PhuongPhapNX == 2)
                {
                    ...
                    {
                        //
                        _phieuNhapXuat._cT_PhieuXuatList.Add(new CT_PhieuXuat(ct_PhieuNhap, _phieuNhapXuat._maKho, _phieuNhapXuat.NgayNX));
                        //
                    }
                }
                else
        ...
        //M
        public static PhieuNhapXuat NewPhieuNhapXuat(PhieuNhapXuat phieuNhapXuat, int loai)//Vat tu (lap Phieu xuat tu Phieu Nhap)
        {
            PhieuNhapXuat _phieuNhapXuat = new PhieuNhapXuat();
            _phieuNhapXuat._maKho = phieuNhapXuat._maKho;
            _phieuNhapXuat._maNguoiNhapXuat = phieuNhapXuat._maNguoiNhapXuat;
            ...
            _phieuNhapXuat._maPhongBan = phieuNhapXuat._maPhongBan;
            _phieuNhapXuat.MaDoiTac = phieuNhapXuat.MaDoiTac;
            _phieuNhapXuat.DienGiai = phieuNhapXuat.DienGiai;
            _phieuNhapXuat._dsHHkhongduxuat = new StringBuilder("Số lượng xuất \"");//Check So luong Xuat
            _phieuNhapXuat._khongDuXuat = false;//Check So luong Xuat
            ...
            {
                //
                _phieuNhapXuat._cT_PhieuXuatList.Add(new CT_PhieuXuat(ct_PhieuNhap, _phieuNhapXuat.NgayNX));
                //
            }
        ...
        public static PhieuNhapXuat NewPhieuXuatBanQuen(PhieuNhapXuat phieuNhapXuat, int loai)//Ban Quyen (lap Phieu xuat tu Phieu Nhap)
        {
            PhieuNhapXuat _phieuNhapXuat = new PhieuNhapXuat();
            _phieuNhapXuat._maKho = phieuNhapXuat._maKho;
            _phieuNhapXuat._maNguoiNhapXuat = phieuNhapXuat._maNguoiNhapXuat;
            ...
            {
                //
                _phieuNhapXuat._cT_PhieuXuatList.Add(new CT_PhieuXuat(ct_PhieuNhap, phieuNhapXuat.MaPhongBan, phieuNhapXuat.MaKho, 2, maHopDong, _phieuNhapXuat.NgayNX));
                //
            }
            return _phieuNhapXuat;
        }

        public static PhieuNhapXuat NewPhieuNhapXuat(PhieuNhapXuat phieuNhapXuat, DateTime _ngayLap)//M
        {
            ...
            if (phieuNhapXuat.LaNhap)
            {
                foreach (CT_PhieuNhap ct_PhieuNhap in phieuNhapXuat._cT_PhieuNhapList)
                {
                    _phieuNhapXuat._cT_PhieuNhapList.Add(new CT_PhieuNhap(ct_PhieuNhap));
                }
            }
        ...
        public static PhieuNhapXuat NewPhieuNhapXuat(PhieuLinhNhienLieu phieuLinhNhienLieu)
        {
            PhieuNhapXuat _phieuNhapXuat = new PhieuNhapXuat();
            ...
            foreach (CT_PhieuLinhNhienLieu ct_PhieuLinhNhienLieu in phieuLinhNhienLieu.CT_PhieuLinhNhienLieuList)
            {
                ...
                {
                    //
                    CT_PhieuXuat ct_PhieuXuat = new CT_PhieuXuat(ct_PhieuLinhNhienLieu, _phieuNhapXuat._maKho, _phieuNhapXuat.NgayNX);
        ...
        public static PhieuNhapXuat NewPhieuNhapXuat(PhieuLinhNhienLieuList phieuLinhNhienLieuList, DateTime ngayLap)
        {
            PhieuNhapXuat _phieuNhapXuat = new PhieuNhapXuat();
        ...
        public static PhieuNhapXuat NewPhieuNhapXuat(KiemKeTonKho kiemKeTonKho, bool kieu)
        {
            PhieuNhapXuat _phieuNhapXuat = new PhieuNhapXuat();
        ...
        public static PhieuNhapXuat GetPhieuNhapXuat(long maPhieuNhapXuat)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException("User not authorized to view a PhieuNhapXuat");
            return DataPortal.Fetch<PhieuNhapXuat>(new Criteria(maPhieuNhapXuat));
        }

        public static PhieuNhapXuat KiemTraXuatCapPhat(int maDoiTac)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException("User not authorized to view a PhieuNhapXuat");
            return DataPortal.Fetch<PhieuNhapXuat>(new CriteriaKiemTraXuatCapPhat(maDoiTac));
        }
        ...
        public override PhieuNhapXuat Save()
        {
        ...
        public static bool CheckSoPhieuNhapXuat(long _maPhieuNhapXuat, string _soPhieu, bool _laMoi,int _maLoai = 0)
        {
            bool Kt = false;
            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
            {
        ...
        //tu DS Phieu Nhap
        public PhieuNhapXuat(PhieuNhapXuatList _phieuNhapList)
        {
            foreach (PhieuNhapXuat _phieuNhap in _phieuNhapList)
            {
                foreach (CT_PhieuNhap ct_PhieuNhap in _phieuNhap._cT_PhieuNhapList)
                {
                    if (ct_PhieuNhap.SoLuong > ct_PhieuNhap.SoLuongXuat)
                    {
                        CT_PhieuXuat ct_PhieuXuat = CT_PhieuXuat.NewCT_PhieuXuat(ct_PhieuNhap, _phieuNhap.Loai);
        ...
        public PhieuNhapXuat(PhieuNhapXuat _phieuNhapXuat)
        {
            foreach (CT_PhieuNhap ct_PhieuNhap in _phieuNhapXuat._cT_PhieuNhapList)
            {

                CT_PhieuXuat ct_PhieuXuat = CT_PhieuXuat.NewCT_PhieuXuat(ct_PhieuNhap, _phieuNhapXuat.Loai);
                this.CT_PhieuXuatList.Add(ct_PhieuXuat);
            }
            ValidationRules.CheckRules();
        }
        //TU DS CT_PHIEUNHAP
        public PhieuNhapXuat(CT_PhieuNhapList _ct_PhieuNhapList, int _makhoT, DateTime _ngayNXT)
        {

            foreach (CT_PhieuNhap ct_PhieuNhap in _ct_PhieuNhapList)
            {
                ...
                else
                {
                    ...
                    if (ct_PhieuNhap.SoLuong > ct_PhieuNhap.SoLuongXuat)
                    {
                        CT_PhieuXuat ct_PhieuXuat = CT_PhieuXuat.NewCT_PhieuXuat(ct_PhieuNhap, _makhoT, _ngayNXT);
                        this.CT_PhieuXuatList.Add(ct_PhieuXuat);
                    }
                    else
                    {
        ...
        //
        public PhieuNhapXuat(CT_PhieuNhapList _ct_PhieuNhapList, int maBoPhan, int loai, int phuongPhapNX, int _makhoT, DateTime _ngayNXT)//cho Xuat Thang Vat Tu
        {
            foreach (CT_PhieuNhap ct_PhieuNhap in _ct_PhieuNhapList)
            {
                //
                if (ct_PhieuNhap.SoLuong > ct_PhieuNhap.SoLuongXuat)
                {
                    CT_PhieuXuat ct_PhieuXuat = CT_PhieuXuat.NewCT_PhieuXuat(ct_PhieuNhap, _ngayNXT);
                    this.CT_PhieuXuatList.Add(ct_PhieuXuat);
                }
                else
                {
            ...
            ValidationRules.CheckRules();
        }//END cho Xuat Thang Vat Tu

        //cho Xuat Ban Quyen(BInh Quan, Xuat Thang)
        public PhieuNhapXuat(CT_PhieuNhapList _ct_PhieuNhapList, int maBoPhan, int phuongPhapNX, int _makhoT, DateTime _ngayNXT)//cho Xuat Ban Quyen(BInh Quan, Xuat Thang)
        {
            foreach (CT_PhieuNhap ct_PhieuNhap in _ct_PhieuNhapList)
            {
                long maHopDong = 0;
                ...
                if (ct_PhieuNhap.SoLuong > ct_PhieuNhap.SoLuongXuat)
                {
                    CT_PhieuXuat ct_PhieuXuat = new CT_PhieuXuat(ct_PhieuNhap, maBoPhan, _makhoT, phuongPhapNX, maHopDong, _ngayNXT);
                    this.CT_PhieuXuatList.Add(ct_PhieuXuat);
                }
                else
                {
        ...
        internal static PhieuNhapXuat GetPhieuNhapXuat(SafeDataReader dr)
        {
            PhieuNhapXuat child = new PhieuNhapXuat();
            child.MarkAsChild();
            child.Fetch(dr);
            return child;
        }

        internal static PhieuNhapXuat GetPhieuNhapXuatKhongChild(SafeDataReader dr)
        {
            PhieuNhapXuat child = new PhieuNhapXuat();
            child.MarkAsChild();
        ...
        internal static PhieuNhapXuat NewPhieuNhapXuatChild()
        {
            PhieuNhapXuat child = new PhieuNhapXuat();
        ...
        internal static PhieuNhapXuat GetPhieuNhapXuat_SoHoaDon(SafeDataReader dr)
        {
            PhieuNhapXuat child = new PhieuNhapXuat();
            child.MarkAsChild();
            child.Fetch_SoHoaDon(dr);
            return child;
        }

        #endregion //Child Factory Methods
        #region
        public static void DeletePhieuNhapXuat(PhieuNhapXuat phieuNhapXuat)
        {//B
            SqlTransaction tr;
            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
            {
                ...
                try
                {
                    ...
                    phieuNhapXuat._cT_PhieuNXList.Clear();
                    phieuNhapXuat._cT_PhieuNXList.Update(tr, phieuNhapXuat);
        ...
        private class CriteriaKiemTraXuatCapPhat
        {
            ...
            public CriteriaKiemTraXuatCapPhat(int maDoiTac)
            {
        ...
        private void ExecuteFetch(SqlTransaction tr, object criteria)
        {
            using (SqlCommand cm = tr.Connection.CreateCommand())
            {
                ...
                {
                    cm.CommandText = "spd_KiemTraDaLapPhieuCapPhat";
        ...
        private void DataPortal_Delete(Criteria criteria)
        {
            ...
            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
            {
                ...
                try
                {
                    ...
                    _cT_PhieuNXList.Clear();
                    _cT_PhieuNXList.Update(tr, this);
        ...
        public void Fetch_SoHoaDon(SafeDataReader dr)
        {
            FetchObject_SoHoaDon(dr);
            MarkOld();
            ValidationRules.CheckRules();
        ...
        private void FetchObject(SafeDataReader dr)
        {
            ...
            _maDeNghiXuat = dr.GetInt32("MaDeNghiXuat");//M
        ...
        {
            _cT_PhieuNXList = CT_PhieuNXList.GetCT_PhieuNXList(this.MaPhieuNhapXuat);
            _cT_PhieuNhapList = CT_PhieuNhapList.GetCT_PhieuNhapList(this.MaPhieuNhapXuat);
            _cT_PhieuXuatList = CT_PhieuXuatList.GetCT_PhieuXuatList(this.MaPhieuNhapXuat);
            _dinhKhoanNhapXuat = DinhKhoanNhapXuat.GetDinhKhoanNhapXuat(this.MaDinhKhoan);
            _butToanPhieuNhapXuatList = ButToanPhieuNhapXuatList.GetButToanPhieuNhapXuatList(this.MaDinhKhoan);
            ...
            if (_loai == 7 || Loai == 8)
            {
                _congCuDungCuList = CongCuDungCuList.GetCongCuDungCuList_ByMaThanhLy(_maPhieuNhapXuat);
            }
            else
            {
                _congCuDungCuList = CongCuDungCuList.GetCongCuDungCuList(this.MaPhieuNhapXuat);
            }
