...
{
    [Serializable()]
    public class DuyetCongCuDungCu : Csla.BusinessBase<DuyetCongCuDungCu>
    {
        #region Business Properties and Methods
        //reference object
        private CongCuDungCu _congCuDungCu;
        ...
        private string _MaQLCCDC = string.Empty;
        public string MaQLCCDC
        {
            get
            {
                return _MaQLCCDC;
        ...
        public string TenHangHoa
        {
            get
            {
                //if (_maCongCuDungCu != 0) _TenHangHoa = GetTenHangHoabyMaCCDC(_maCongCuDungCu);
                return _TenHangHoa;
            }
        }
        private DateTime _NgayNhanCCDC;
        public DateTime NgayNhanCCDC
        {
            get
            {
                return _NgayNhanCCDC;
            }
        }
        ...
        private DuyetCongCuDungCu()
        { /* require use of factory method */ }

        public static DuyetCongCuDungCu NewDuyetCongCuDungCu()
        {
            if (!CanAddObject())
                throw new System.Security.SecurityException("User not authorized to add a DuyetCongCuDungCu");
            return DataPortal.Create<DuyetCongCuDungCu>();
        }
        public static DuyetCongCuDungCu GetDuyetCongCuDungCu(int maDuyetCongCuDungCu)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException("User not authorized to view a DuyetCongCuDungCu");
            return DataPortal.Fetch<DuyetCongCuDungCu>(new Criteria(maDuyetCongCuDungCu));
        }
        public static DuyetCongCuDungCu GetDuyetCongCuDungCu_ByMaChiTietDieuChuyenNoiBo(int maChiTietDieuChuyenNoiBo)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException("User not authorized to view a DuyetCongCuDungCu");
            return DataPortal.Fetch<DuyetCongCuDungCu>(new Criteria_ByMaChiTietDieuChuyenNoiBo(maChiTietDieuChuyenNoiBo));
        }
        ...
        public override DuyetCongCuDungCu Save()
        {
        ...
        internal static DuyetCongCuDungCu NewDuyetCongCuDungCuChild()
        {
            DuyetCongCuDungCu child = new DuyetCongCuDungCu();
            child.ValidationRules.CheckRules();
            child.MarkAsChild();
            return child;
        }

        internal static DuyetCongCuDungCu GetDuyetCongCuDungCu(SafeDataReader dr)
        {
            DuyetCongCuDungCu child = new DuyetCongCuDungCu();
            child.MarkAsChild();
            child.Fetch(dr);
        ...
        private void FetchObject(SafeDataReader dr)
        {
            ...
            _MaQLCCDC = dr.GetString("MaQuanLy");
            _TenHangHoa = dr.GetString("TenCCDC");
            _NgayNhanCCDC = dr.GetDateTime("NgayNhan");
        ...
        #region Data Access - Insert
        internal void Insert(SqlTransaction tr, DuyetCongCuDungCuList parent)
        {
            if (!IsDirty) return;
        ...
        private void ExecuteInsert(SqlTransaction tr, DuyetCongCuDungCuList parent)
        {
            using (SqlCommand cm = tr.Connection.CreateCommand())
            {
                cm.Transaction = tr;
        ...
        private void AddInsertParameters(SqlCommand cm, DuyetCongCuDungCuList parent)
        {
        ...
        #region Data Access - Update
        internal void Update(SqlTransaction tr, DuyetCongCuDungCuList parent)
        {
            if (!IsDirty) return;
        ...
        private void ExecuteUpdate(SqlTransaction tr, DuyetCongCuDungCuList parent)
        {
            using (SqlCommand cm = tr.Connection.CreateCommand())
            {
                cm.Transaction = tr;
        ...
        private void AddUpdateParameters(SqlCommand cm, DuyetCongCuDungCuList parent)
        {
            cm.Parameters.AddWithValue("@MaDuyetCongCuDungCu", _maDuyetCongCuDungCu);
            if (_maCongCuDungCu != 0)
                cm.Parameters.AddWithValue("@MaCongCuDungCu", _maCongCuDungCu);
