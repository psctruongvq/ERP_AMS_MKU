...
{
    [Serializable()]
    public class DuyetCCDCList : Csla.BusinessListBase<DuyetCCDCList, DuyetCCDC>
    {
        //public static SqlTransaction AdvancedTransaction = null;
        #region BindingList Overrides
        protected override object AddNewCore()
        {
            DuyetCCDC item = DuyetCCDC.NewDuyetCongCuDungCu();
            this.Add(item);
            return item;
        }
        ...
        private DuyetCCDCList()
        { /* require use of factory method */ }

        public static DuyetCCDCList NewDuyetCongCuDungCuList()
        {
            if (!CanAddObject())
                throw new System.Security.SecurityException("User not authorized to add a DuyetCongCuDungCuList");
            return new DuyetCCDCList();
        }

        public static DuyetCCDCList GetDuyetCongCuDungCuList_ChuaThucHienNghiepVu_DaDuyet_TheoDieuKien(byte loaiNghiepVu, int maBoPhan, int maHangHoa, DateTime denNgay)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException("User not authorized to view a DuyetCongCuDungCuList");
            return DataPortal.Fetch<DuyetCCDCList>(new FilterCriteria_ChuaThucHienNghiepVu_DaDuyet_TheoDieuKien(loaiNghiepVu, maBoPhan, maHangHoa,denNgay));
        }
        public static DuyetCCDCList GetDuyetCongCuDungCuList_ChuaThucHienNghiepVu_DuyetHoacChuaDuyet_TheoDieuKien(byte loaiNghiepVu, int maBoPhan, int maHangHoa)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException("User not authorized to view a DuyetCongCuDungCuList");
            return DataPortal.Fetch<DuyetCCDCList>(new FilterCriteria_ChuaThucHienNghiepVu_DuyetHoacChuaDuyet_TheoDieuKien(loaiNghiepVu, maBoPhan, maHangHoa));
        }
        public static DuyetCCDCList GetDuyetCongCuDungCuList_ChoDuyetTheoDieuKien(byte loaiNghiepVu, int maBoPhan, int maHangHoa)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException("User not authorized to view a DuyetCCDCList");
            return DataPortal.Fetch<DuyetCCDCList>(new FilterCriteria_ChuaThucHienNghiepVu_DuyetHoacChuaDuyet_TheoDieuKien(loaiNghiepVu, maBoPhan, maHangHoa));
        }
        public static DuyetCCDCList GetDuyetCongCuDungCuList()
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException("User not authorized to view a DuyetCongCuDungCuList");
            return DataPortal.Fetch<DuyetCCDCList>(new FilterCriteria());
        }
        ...
        private class FilterCriteria_ChuaThucHienNghiepVu_DaDuyet_TheoDieuKien
        {
            ...
            public FilterCriteria_ChuaThucHienNghiepVu_DaDuyet_TheoDieuKien(byte loaiNghiepVu, int maBoPhan, int maHangHoa,DateTime denNgay)
            {
        ...
        private class FilterCriteria_ChuaThucHienNghiepVu_DuyetHoacChuaDuyet_TheoDieuKien
        {
            ...
            public int MaBoPhan = 0;
            public int MaHangHoa = 0;
            public FilterCriteria_ChuaThucHienNghiepVu_DuyetHoacChuaDuyet_TheoDieuKien(byte loaiNghiepVu, int maBoPhan, int maHangHoa)
            {
                this.LoaiNghiepVu = loaiNghiepVu;
                this.MaBoPhan = maBoPhan;
                this.MaHangHoa = maHangHoa;
        ...
        private void ExecuteFetch_ChuaThucHienNghiepVu_DuyetHoacChuaDuyet_TheoDieuKien(SqlTransaction tr, FilterCriteria_ChuaThucHienNghiepVu_DuyetHoacChuaDuyet_TheoDieuKien criteria)
        {
            using (SqlCommand cm = tr.Connection.CreateCommand())
            {
                ...
                cm.CommandText = "spd_SelectDuyetCCDCList_ChuaThucHienNghiepVu_DuyetHoacChuaDuyet_TheoDieuKien";
                ...
                {
                    while (dr.Read())
                        this.Add(DuyetCCDC.GetDuyetCongCuDungCu(dr));
                }
            }//using
        }
        private void ExecuteFetch_ChuaThucHienNghiepVu_DaDuyet_TheoDieuKien(SqlTransaction tr, FilterCriteria_ChuaThucHienNghiepVu_DaDuyet_TheoDieuKien criteria)
        {
            using (SqlCommand cm = tr.Connection.CreateCommand())
            {
                cm.Transaction = tr;
                cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "spd_SelectDuyetCCDCDaDuyetList_ChuaThucHienNghiepVu_Update";
                cm.Parameters.AddWithValue("@LoaiNghiepVu", criteria.LoaiNghiepVu);
                cm.Parameters.AddWithValue("@MaBoPhan", criteria.MaBoPhan);
                cm.Parameters.AddWithValue("@MaHangHoa", criteria.MaHangHoa);
        ...
        private void ExecuteFetch_ChoDuyetTheoDieuKien(SqlTransaction tr, FilterCriteria_ChoDuyetTheoDieuKien criteria)
        {
            using (SqlCommand cm = tr.Connection.CreateCommand())
            {
                cm.Transaction = tr;
                cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "spd_SelectDuyetCCDCList_ChoDuyetTheoDieuKien";
                cm.Parameters.AddWithValue("@LoaiNghiepVu", criteria.LoaiNghiepVu);
                cm.Parameters.AddWithValue("@MaBoPhan", criteria.MaBoPhan);
                cm.Parameters.AddWithValue("@MaHangHoa", criteria.MaHangHoa);
        ...
        private void ExecuteFetch(SqlTransaction tr, FilterCriteria criteria)
        {
            using (SqlCommand cm = tr.Connection.CreateCommand())
            {
                cm.Transaction = tr;
                cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "spd_SelectDuyetCCDCListAll";
        ...
        protected override void DataPortal_Update()
        {
            ...
            using (SqlConnection cn = new SqlConnection(Database.ERP_Connection))
            {
                ...
                try
                {
                        ...
                        foreach (DuyetCCDC deletedChild in DeletedList)
                            deletedChild.DeleteSelf(tr);
                        DeletedList.Clear();

                        // loop through each non-deleted child object
                        foreach (DuyetCCDC child in this)
                        {
                            if (child.IsNew)
