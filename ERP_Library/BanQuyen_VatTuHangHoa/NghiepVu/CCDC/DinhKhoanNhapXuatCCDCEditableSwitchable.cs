...
{ 
	[Serializable()] 
	public class DinhKhoanNhapXuatCCDC : Csla.BusinessBase<DinhKhoanNhapXuatCCDC>
	{
		...
		private DinhKhoanNhapXuatCCDC()
		{ /* require use of factory method */ }

        public static DinhKhoanNhapXuatCCDC NewDinhKhoanNhapXuat()
		{
			if (!CanAddObject())
				throw new System.Security.SecurityException("User not authorized to add a DinhKhoanNhapXuat");
            return DataPortal.Create<DinhKhoanNhapXuatCCDC>();
		}

        public static DinhKhoanNhapXuatCCDC GetDinhKhoanNhapXuat(int maDinhKhoan)
		{
			if (!CanGetObject())
				throw new System.Security.SecurityException("User not authorized to view a DinhKhoanNhapXuat");
            return DataPortal.Fetch<DinhKhoanNhapXuatCCDC>(new Criteria(maDinhKhoan));
		}
        ...
        public override DinhKhoanNhapXuatCCDC Save()
		{
        ...
        internal static DinhKhoanNhapXuatCCDC NewDinhKhoanNhapXuatChild()
		{
            DinhKhoanNhapXuatCCDC child = new DinhKhoanNhapXuatCCDC();
			child.ValidationRules.CheckRules();
			child.MarkAsChild();
			return child;
		}

        internal static DinhKhoanNhapXuatCCDC GetDinhKhoanNhapXuat(SafeDataReader dr)
		{
            DinhKhoanNhapXuatCCDC child = new DinhKhoanNhapXuatCCDC();
			child.MarkAsChild();
			child.Fetch(dr);
