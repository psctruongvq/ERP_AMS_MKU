...
{
    [Serializable()]
    public class ChungTu_HoaDonCCDC : Csla.BusinessBase<ChungTu_HoaDonCCDC>
    {
        ...
        private ChungTu_HoaDonCCDC()
        { /* require use of factory method */ }

        public static ChungTu_HoaDonCCDC NewChungTu_HoaDon()
        {
            ChungTu_HoaDonCCDC item = new ChungTu_HoaDonCCDC();
            item.MarkAsChild();
            return item;
        }

        public static ChungTu_HoaDonCCDC NewChungTu_HoaDon(HoaDon _hoaDon)
        {
            ChungTu_HoaDonCCDC item = new ChungTu_HoaDonCCDC();
        ...
        public static ChungTu_HoaDonCCDC NewChungTu_HoaDon(ChungTu_HoaDonCCDC _ct_hd)
        {
            ChungTu_HoaDonCCDC item = new ChungTu_HoaDonCCDC();
        ...
        public static ChungTu_HoaDonCCDC GetChungTu_HoaDon(long machungtuChungtugoc)
        {
            return DataPortal.Fetch<ChungTu_HoaDonCCDC>(new Criteria(machungtuChungtugoc));
        }
        ...
        internal static ChungTu_HoaDonCCDC NewChungTu_HoaDonChild()
        {
            ChungTu_HoaDonCCDC child = new ChungTu_HoaDonCCDC();
            child.ValidationRules.CheckRules();
            child.MarkAsChild();
            return child;
        }

        internal static ChungTu_HoaDonCCDC GetChungTu_HoaDon(SafeDataReader dr)
        {
            ChungTu_HoaDonCCDC child = new ChungTu_HoaDonCCDC();
            child.MarkAsChild();
            child.Fetch(dr);
