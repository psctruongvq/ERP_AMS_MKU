...
{
    [Serializable()]
    public class DieuChuyenNoiBoCCDC : Csla.BusinessBase<DieuChuyenNoiBoCCDC>
    {
        ...
        private CT_DieuChuyenNoiBoCCDCChildList _cT_DieuChuyenNoiBoCongCuDungCuList = CT_DieuChuyenNoiBoCCDCChildList.NewCT_DieuChuyenNoiBoCCDCChildList();
        ...
        public CT_DieuChuyenNoiBoCCDCChildList CT_DieuChuyenNoiBoCongCuDungCuList
        {
            get
            {
        ...
        public static DieuChuyenNoiBoCCDC NewDieuChuyenNoiBoCongCuDungCu()
        {
            if (!CanAddObject())
                throw new System.Security.SecurityException("User not authorized to add a DieuChuyenNoiBoCongCuDungCu");
            return DataPortal.Create<DieuChuyenNoiBoCCDC>(new CriteriaNew(DateTime.Now.Date));
        }
        public static DieuChuyenNoiBoCCDC NewDieuChuyenNoiBoCongCuDungCu(int maDieuChuyen)
        {
            if (!CanAddObject())
                throw new System.Security.SecurityException("User not authorized to add a DieuChuyenNoiBoCongCuDungCu");
            return DataPortal.Create<DieuChuyenNoiBoCCDC>(new Criteria(maDieuChuyen));
        }

        public static DieuChuyenNoiBoCCDC GetDieuChuyenNoiBoCongCuDungCu(int maDieuChuyen)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException("User not authorized to view a DieuChuyenNoiBoCongCuDungCu");
            return DataPortal.Fetch<DieuChuyenNoiBoCCDC>(new Criteria(maDieuChuyen));
        }
        ...
        public override DieuChuyenNoiBoCCDC Save()
        {
        ...
        private DieuChuyenNoiBoCCDC(int maDieuChuyen)
        {
            this._maDieuChuyen = maDieuChuyen;
        }

        internal static DieuChuyenNoiBoCCDC NewDieuChuyenNoiBoCongCuDungCuChild(int maDieuChuyen)
        {
            DieuChuyenNoiBoCCDC child = new DieuChuyenNoiBoCCDC(maDieuChuyen);
            child.ValidationRules.CheckRules();
            child.MarkAsChild();
            return child;
        }

        internal static DieuChuyenNoiBoCCDC GetDieuChuyenNoiBoCongCuDungCu(SafeDataReader dr)
        {
            DieuChuyenNoiBoCCDC child = new DieuChuyenNoiBoCCDC();
            child.MarkAsChild();
            child.Fetch(dr);
            return child;
        }
        ...
        {
            _cT_DieuChuyenNoiBoCongCuDungCuList = CT_DieuChuyenNoiBoCCDCChildList.GetCT_DieuChuyenNoiBoCCDCChildList(_maDieuChuyen);
        }
        #endregion //Data Access - Fetch
