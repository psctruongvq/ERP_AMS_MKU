...
{ 
	[Serializable()] 
	public class ButToan_MucNganSachCCDC : Csla.BusinessBase<ButToan_MucNganSachCCDC>
	{
        ...
        private ButToan_MucNganSachCCDC()
		{ /* require use of factory method */ }

        public static ButToan_MucNganSachCCDC NewButToan_MucNganSach()
		{
			if (!CanAddObject())
				throw new System.Security.SecurityException("User not authorized to add a ButToan_MucNganSach");
            return DataPortal.Create<ButToan_MucNganSachCCDC>();
		}

        public static ButToan_MucNganSachCCDC GetButToan_MucNganSach(int maButToanMucNganSach)
		{
			if (!CanGetObject())
				throw new System.Security.SecurityException("User not authorized to view a ButToan_MucNganSach");
            return DataPortal.Fetch<ButToan_MucNganSachCCDC>(new Criteria(maButToanMucNganSach));
		}

        public static ButToan_MucNganSachCCDC GetButToan_MucNganSachByMaButToan(int maButToan)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException("User not authorized to view a ButToan_MucNganSach");
            return DataPortal.Fetch<ButToan_MucNganSachCCDC>(new CriteriaByMaButToan(maButToan));
        }
        ...
        public override ButToan_MucNganSachCCDC Save()
		{
        ...
        internal static ButToan_MucNganSachCCDC NewButToan_MucNganSachChild()
		{
            ButToan_MucNganSachCCDC child = new ButToan_MucNganSachCCDC();
			child.ValidationRules.CheckRules();
			child.MarkAsChild();
			return child;
		}

        internal static ButToan_MucNganSachCCDC GetButToan_MucNganSach(SafeDataReader dr)
		{
            ButToan_MucNganSachCCDC child = new ButToan_MucNganSachCCDC();
			child.MarkAsChild();
			child.Fetch(dr);
		...
		#region Data Access - Insert
        internal void Insert(SqlTransaction tr, ButToanPhieuNhapXuatCCDC parent)
		{
        ...
        private void ExecuteInsert(SqlTransaction tr, ButToanPhieuNhapXuatCCDC parent)
		{
			using (SqlCommand cm = tr.Connection.CreateCommand())
			{
				cm.Transaction = tr;
        ...
        private void AddInsertParameters(SqlCommand cm, ButToanPhieuNhapXuatCCDC parent)
		{
        ...
        private void ExecuteUpdate(SqlTransaction tr, ButToanPhieuNhapXuatCCDC parent)
		{
			using (SqlCommand cm = tr.Connection.CreateCommand())
			{
				cm.Transaction = tr;
        ...
        private void AddUpdateParameters(SqlCommand cm, ButToanPhieuNhapXuatCCDC parent)
		{
			cm.Parameters.AddWithValue("@MaButToanMucNganSach", _maButToanMucNganSach);
			cm.Parameters.AddWithValue("@MaButToan", _maButToan);
			cm.Parameters.AddWithValue("@MaTieuMuc", _maTieuMuc);
