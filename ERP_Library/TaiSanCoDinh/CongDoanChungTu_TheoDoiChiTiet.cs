...
{ 
	[Serializable()] 
	public class CongDoanChungTu_TheoDoiChiTiet : Csla.BusinessBase<CongDoanChungTu_TheoDoiChiTiet>
	{
		...
		private CongDoanChungTu_TheoDoiChiTiet()
		{ /* require use of factory method */ }

		public static CongDoanChungTu_TheoDoiChiTiet NewCongDoanChungTu_TheoDoiChiTiet()
		{
            CongDoanChungTu_TheoDoiChiTiet item = new CongDoanChungTu_TheoDoiChiTiet();
            item.MarkAsChild();
            return item;
		}

		public static CongDoanChungTu_TheoDoiChiTiet GetCongDoanChungTu_TheoDoiChiTiet(int mactTheodoichitiet)
		{
			return DataPortal.Fetch<CongDoanChungTu_TheoDoiChiTiet>(new Criteria(mactTheodoichitiet));
		}

		public static void DeleteCongDoanChungTu_TheoDoiChiTiet(int mactTheodoichitiet)
		{
		...
		internal static CongDoanChungTu_TheoDoiChiTiet NewCongDoanChungTu_TheoDoiChiTietChild()
		{
			CongDoanChungTu_TheoDoiChiTiet child = new CongDoanChungTu_TheoDoiChiTiet();
			child.ValidationRules.CheckRules();
			child.MarkAsChild();
			return child;
		}

		internal static CongDoanChungTu_TheoDoiChiTiet GetCongDoanChungTu_TheoDoiChiTiet(SafeDataReader dr)
		{
			CongDoanChungTu_TheoDoiChiTiet child =  new CongDoanChungTu_TheoDoiChiTiet();
			child.MarkAsChild();
			child.Fetch(dr);
		...
		private void ExecuteFetch(SqlTransaction tr, Criteria criteria)
		{
			using (SqlCommand cm = tr.Connection.CreateCommand())
			{
				...
				cm.CommandText = "SelecttblCongDoanChungTu_TheoDoiChiTiet";
		...
		private void ExecuteDelete(SqlTransaction tr, Criteria criteria)
		{
			using (SqlCommand cm = tr.Connection.CreateCommand())
			{
				cm.Transaction = tr;
				cm.CommandType = CommandType.StoredProcedure;
				cm.CommandText = "DeletetblCongDoanChungTu_TheoDoiChiTiet";
        ...
        private void ExecuteInsert(SqlTransaction tr)
		{
			using (SqlCommand cm = tr.Connection.CreateCommand())
			{
				cm.Transaction = tr;
				cm.CommandType = CommandType.StoredProcedure;
				cm.CommandText = "InserttblCongDoanChungTu_TheoDoiChiTiet";
        ...
        private void ExecuteUpdate(SqlTransaction tr)
		{
			using (SqlCommand cm = tr.Connection.CreateCommand())
			{
				cm.Transaction = tr;
				cm.CommandType = CommandType.StoredProcedure;
				cm.CommandText = "UpdatetblCongDoanChungTu_TheoDoiChiTiet";
