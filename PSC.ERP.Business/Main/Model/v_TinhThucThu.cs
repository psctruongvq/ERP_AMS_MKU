...
namespace PSC_ERP_Business.Main.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="PSC_ERPModel", Name="v_TinhThucThu")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class v_TinhThucThu : PSC_ERP_Core.BaseEntityObject//EntityObject
    {
    	public v_TinhThucThu()
    	{
        ...
        /// <summary>
        /// Create a new v_TinhThucThu object.
        /// </summary>
        ...
        /// <param name="tamThu">Initial value of the TamThu property.</param>
        /// <param name="thueTamThu">Initial value of the ThueTamThu property.</param>
        public static v_TinhThucThu Createv_TinhThucThu(int id, int userID, System.DateTime ngayLap, int nam, long maNhanVien, string hoTen, decimal tamThu, decimal thueTamThu)
        {
            v_TinhThucThu v_TinhThucThu = new v_TinhThucThu();
            v_TinhThucThu.ID = id;
            v_TinhThucThu.UserID = userID;
            v_TinhThucThu.NgayLap = ngayLap;
            v_TinhThucThu.Nam = nam;
            v_TinhThucThu.MaNhanVien = maNhanVien;
            v_TinhThucThu.HoTen = hoTen;
            v_TinhThucThu.TamThu = tamThu;
            v_TinhThucThu.ThueTamThu = thueTamThu;
            return v_TinhThucThu;
        }
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<decimal> ThueTNCNKy3
        {
            get
            {
                return _thueTNCNKy3;
            ...
            set
            {
    			Nullable<decimal> oldValue =  _thueTNCNKy3;
    			bool stopChanging = false;
                On_ThueTNCNKy3_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("ThueTNCNKy3");
    			if(!stopChanging)
    			{
    				_thueTNCNKy3 = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("ThueTNCNKy3");
    				On_ThueTNCNKy3_Changed(oldValue, _thueTNCNKy3);//\\
    			}
            }
        }
    	public static String ThueTNCNKy3_PropertyName { get { return "ThueTNCNKy3"; } }
        private Nullable<decimal> _thueTNCNKy3;
        partial void On_ThueTNCNKy3_Changing(Nullable<decimal> currentValue, ref Nullable<decimal> newValue, ref bool stopChanging);
        partial void On_ThueTNCNKy3_Changed(Nullable<decimal> oldValue, Nullable<decimal> currentValue);
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<decimal> ThueTNCNKy2
        {
            get
            {
                return _thueTNCNKy2;
            ...
            set
            {
    			Nullable<decimal> oldValue =  _thueTNCNKy2;
    			bool stopChanging = false;
                On_ThueTNCNKy2_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("ThueTNCNKy2");
    			if(!stopChanging)
    			{
    				_thueTNCNKy2 = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("ThueTNCNKy2");
    				On_ThueTNCNKy2_Changed(oldValue, _thueTNCNKy2);//\\
    			}
            }
        }
    	public static String ThueTNCNKy2_PropertyName { get { return "ThueTNCNKy2"; } }
        private Nullable<decimal> _thueTNCNKy2;
        partial void On_ThueTNCNKy2_Changing(Nullable<decimal> currentValue, ref Nullable<decimal> newValue, ref bool stopChanging);
        partial void On_ThueTNCNKy2_Changed(Nullable<decimal> oldValue, Nullable<decimal> currentValue);
        ...
        public decimal TamThu
        {
            ...
            set
            {
                if (_tamThu != value)
                {
        			decimal oldValue =  _tamThu;
        			bool stopChanging = false;
                    On_TamThu_Changing(oldValue, ref value, ref stopChanging);
                    ReportPropertyChanging("TamThu");
        			if(!stopChanging)
        			{
        				_tamThu = StructuralObject.SetValidValue(value);
        				ReportPropertyChanged("TamThu");
        				On_TamThu_Changed(oldValue, _tamThu);//\\
        			}
                }
            }
        }
    	public static String TamThu_PropertyName { get { return "TamThu"; } }
        private decimal _tamThu;
        partial void On_TamThu_Changing(decimal currentValue, ref decimal newValue, ref bool stopChanging);
        partial void On_TamThu_Changed(decimal oldValue, decimal currentValue);
        ...
        public decimal ThueTamThu
        {
            ...
            set
            {
                if (_thueTamThu != value)
                {
        			decimal oldValue =  _thueTamThu;
        			bool stopChanging = false;
        ...
        private decimal _thueTamThu;
        partial void On_ThueTamThu_Changing(decimal currentValue, ref decimal newValue, ref bool stopChanging);
        partial void On_ThueTamThu_Changed(decimal oldValue, decimal currentValue);
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<decimal> ThucThu
        {
            get
            {
                return _thucThu;
            ...
            set
            {
    			Nullable<decimal> oldValue =  _thucThu;
    			bool stopChanging = false;
                On_ThucThu_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("ThucThu");
    			if(!stopChanging)
    			{
    				_thucThu = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("ThucThu");
    				On_ThucThu_Changed(oldValue, _thucThu);//\\
    			}
            }
        }
    	public static String ThucThu_PropertyName { get { return "ThucThu"; } }
        private Nullable<decimal> _thucThu;
        partial void On_ThucThu_Changing(Nullable<decimal> currentValue, ref Nullable<decimal> newValue, ref bool stopChanging);
        partial void On_ThucThu_Changed(Nullable<decimal> oldValue, Nullable<decimal> currentValue);
