...
namespace PSC_ERP_Business.Main.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="PSC_ERPModel", Name="v_SoTienDaNhapCuaChungTu")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class v_SoTienDaNhapCuaChungTu : PSC_ERP_Core.BaseEntityObject//EntityObject
    {
    	public v_SoTienDaNhapCuaChungTu()
    	{
        ...
        /// <summary>
        /// Create a new v_SoTienDaNhapCuaChungTu object.
        /// </summary>
        /// <param name="maChungTu">Initial value of the MaChungTu property.</param>
        public static v_SoTienDaNhapCuaChungTu Createv_SoTienDaNhapCuaChungTu(long maChungTu)
        {
            v_SoTienDaNhapCuaChungTu v_SoTienDaNhapCuaChungTu = new v_SoTienDaNhapCuaChungTu();
            v_SoTienDaNhapCuaChungTu.MaChungTu = maChungTu;
            return v_SoTienDaNhapCuaChungTu;
        }
