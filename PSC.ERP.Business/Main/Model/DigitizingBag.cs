...
namespace PSC_ERP_Business.Main.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="PSC_ERPModel", Name="DigitizingBag")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class DigitizingBag : PSC_ERP_Core.BaseEntityObject//EntityObject
    {
    	public DigitizingBag()
    	{
        ...
        /// <summary>
        /// Create a new DigitizingBag object.
        /// </summary>
        /// <param name="bagId">Initial value of the BagId property.</param>
        public static DigitizingBag CreateDigitizingBag(System.Guid bagId)
        {
            DigitizingBag digitizingBag = new DigitizingBag();
            digitizingBag.BagId = bagId;
            return digitizingBag;
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("PSC_ERPModel", "FK_DigitizingBag_DigitizingBag", "DigitizingBag1")]
        public EntityCollection<DigitizingBag> DigitizingBag1
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<DigitizingBag>("PSC_ERPModel.FK_DigitizingBag_DigitizingBag", "DigitizingBag1");
            }
            set
            {
                if ((value != null))
                {
    				bool stopChanging = false;
    				On_DigitizingBag1_Changing(ref value, ref stopChanging);//\\//
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<DigitizingBag>("PSC_ERPModel.FK_DigitizingBag_DigitizingBag", "DigitizingBag1", value);
    					On_DigitizingBag1_Changed(this.DigitizingBag1);//\\//
    				}
    			}
            }
        }
    	public static String DigitizingBag1_EntityCollectionPropertyName { get { return "DigitizingBag1"; } }
    	partial void On_DigitizingBag1_Changing(ref EntityCollection<DigitizingBag> newValue, ref bool stopChanging);
    	partial void On_DigitizingBag1_Changed(EntityCollection<DigitizingBag> currentValue);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("PSC_ERPModel", "FK_DigitizingBag_DigitizingBag", "DigitizingBag")]
        public DigitizingBag DigitizingBag2
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<DigitizingBag>("PSC_ERPModel.FK_DigitizingBag_DigitizingBag", "DigitizingBag").Value;
            }
            set
            {
    			bool stopChanging = false;
    			On_DigitizingBag2_Changing(ref value, ref stopChanging);//\\//
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<DigitizingBag>("PSC_ERPModel.FK_DigitizingBag_DigitizingBag", "DigitizingBag").Value = value;
    				On_DigitizingBag2_Changed(this.DigitizingBag2);//\\//
    			}
    	    }
        }
    	public static String DigitizingBag2_ReferencePropertyName { get { return "DigitizingBag2"; } }
    	partial void On_DigitizingBag2_Changing(ref DigitizingBag newValue, ref bool stopChanging);
    	partial void On_DigitizingBag2_Changed(DigitizingBag currentValue);
        /// <summary>
        /// No Metadata Documentation available.
        /// </summary>
        [BrowsableAttribute(false)]
        [DataMemberAttribute()]
        public EntityReference<DigitizingBag> DigitizingBag2Reference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<DigitizingBag>("PSC_ERPModel.FK_DigitizingBag_DigitizingBag", "DigitizingBag");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<DigitizingBag>("PSC_ERPModel.FK_DigitizingBag_DigitizingBag", "DigitizingBag", value);
                }
            }
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("PSC_ERPModel", "FK_DigitizingBag_tblnsBoPhan", "tblnsBoPhan")]
        public tblnsBoPhan tblnsBoPhan
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<tblnsBoPhan>("PSC_ERPModel.FK_DigitizingBag_tblnsBoPhan", "tblnsBoPhan").Value;
            }
            set
            {
    			bool stopChanging = false;
    			...
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<tblnsBoPhan>("PSC_ERPModel.FK_DigitizingBag_tblnsBoPhan", "tblnsBoPhan").Value = value;
        ...
        public EntityReference<tblnsBoPhan> tblnsBoPhanReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<tblnsBoPhan>("PSC_ERPModel.FK_DigitizingBag_tblnsBoPhan", "tblnsBoPhan");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<tblnsBoPhan>("PSC_ERPModel.FK_DigitizingBag_tblnsBoPhan", "tblnsBoPhan", value);
                }
            }
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("PSC_ERPModel", "FK_DigitizingBag_app_users", "app_users")]
        public app_users app_users
        {//test
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<app_users>("PSC_ERPModel.FK_DigitizingBag_app_users", "app_users").Value;
            }
            set
            {
    			bool stopChanging = false;
    			...
    			if(!stopChanging)
    			{
    				((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<app_users>("PSC_ERPModel.FK_DigitizingBag_app_users", "app_users").Value = value;
        ...
        public EntityReference<app_users> app_usersReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<app_users>("PSC_ERPModel.FK_DigitizingBag_app_users", "app_users");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<app_users>("PSC_ERPModel.FK_DigitizingBag_app_users", "app_users", value);
                }
            }
        }
