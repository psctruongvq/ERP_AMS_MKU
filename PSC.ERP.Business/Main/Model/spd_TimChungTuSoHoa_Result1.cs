...
namespace PSC_ERP_Business.Main.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="PSC_ERPModel", Name="spd_TimChungTuSoHoa_Result1")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_TimChungTuSoHoa_Result1 : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new spd_TimChungTuSoHoa_Result1 object.
        /// </summary>
        /// <param name="maChungTu">Initial value of the MaChungTu property.</param>
        public static spd_TimChungTuSoHoa_Result1 Createspd_TimChungTuSoHoa_Result1(long maChungTu)
        {
            spd_TimChungTuSoHoa_Result1 spd_TimChungTuSoHoa_Result1 = new spd_TimChungTuSoHoa_Result1();
            spd_TimChungTuSoHoa_Result1.MaChungTu = maChungTu;
            return spd_TimChungTuSoHoa_Result1;
        }
