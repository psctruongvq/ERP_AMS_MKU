...
namespace PSC_ERP_Business.Main.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="PSC_ERPModel", Name="v_TNCN")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class v_TNCN : PSC_ERP_Core.BaseEntityObject//EntityObject
    {
    	public v_TNCN()
    	{
        ...
        public static v_TNCN Createv_TNCN(long maNhanVien, int maBoPhan)
        {
            v_TNCN v_TNCN = new v_TNCN();
            v_TNCN.MaNhanVien = maNhanVien;
            v_TNCN.MaBoPhan = maBoPhan;
            return v_TNCN;
        }
