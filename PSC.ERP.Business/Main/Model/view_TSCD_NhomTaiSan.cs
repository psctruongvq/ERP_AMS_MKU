...
namespace PSC_ERP_Business.Main.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="PSC_ERPModel", Name="view_TSCD_NhomTaiSan")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class view_TSCD_NhomTaiSan : PSC_ERP_Core.BaseEntityObject//EntityObject
    {
    	public view_TSCD_NhomTaiSan()
    	{
        ...
        /// <summary>
        /// Create a new view_TSCD_NhomTaiSan object.
        /// </summary>
        /// <param name="id">Initial value of the ID property.</param>
        public static view_TSCD_NhomTaiSan Createview_TSCD_NhomTaiSan(int id)
        {
            view_TSCD_NhomTaiSan view_TSCD_NhomTaiSan = new view_TSCD_NhomTaiSan();
            view_TSCD_NhomTaiSan.ID = id;
            return view_TSCD_NhomTaiSan;
        }
