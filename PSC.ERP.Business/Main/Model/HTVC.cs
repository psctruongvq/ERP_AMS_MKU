...
namespace PSC_ERP_Business.Main.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="PSC_ERPModel", Name="HTVC")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class HTVC : PSC_ERP_Core.BaseEntityObject//EntityObject
    {
    	public HTVC()
    	{
        ...
        /// <summary>
        /// Create a new HTVC object.
        /// </summary>
        /// <param name="maBoPhan">Initial value of the MaBoPhan property.</param>
        public static HTVC CreateHTVC(int maBoPhan)
        {
            HTVC hTVC = new HTVC();
            hTVC.MaBoPhan = maBoPhan;
            return hTVC;
        }
