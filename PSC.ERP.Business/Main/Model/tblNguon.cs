...
namespace PSC_ERP_Business.Main.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="PSC_ERPModel", Name="tblNguon")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class tblNguon : PSC_ERP_Core.BaseEntityObject//EntityObject
    {
    	public tblNguon()
    	{
        ...
        public static tblNguon CreatetblNguon(int maNguon, string tenNguon)
        {
            tblNguon tblNguon = new tblNguon();
            tblNguon.MaNguon = maNguon;
            tblNguon.TenNguon = tenNguon;
            return tblNguon;
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("PSC_ERPModel", "FK_tblDieuChinhGiaTri_tblNguon", "tblDieuChinhGiaTri")]
        public EntityCollection<tblDieuChinhGiaTri> tblDieuChinhGiaTris
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<tblDieuChinhGiaTri>("PSC_ERPModel.FK_tblDieuChinhGiaTri_tblNguon", "tblDieuChinhGiaTri");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<tblDieuChinhGiaTri>("PSC_ERPModel.FK_tblDieuChinhGiaTri_tblNguon", "tblDieuChinhGiaTri", value);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("PSC_ERPModel", "FK_tblnsChuongTrinh_tblNguon", "tblnsChuongTrinh")]
        public EntityCollection<tblnsChuongTrinh> tblnsChuongTrinhs
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<tblnsChuongTrinh>("PSC_ERPModel.FK_tblnsChuongTrinh_tblNguon", "tblnsChuongTrinh");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<tblnsChuongTrinh>("PSC_ERPModel.FK_tblnsChuongTrinh_tblNguon", "tblnsChuongTrinh", value);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("PSC_ERPModel", "FK_tblNghiepVuSuaChuaLon_tblNguon", "tblNghiepVuSuaChuaLon")]
        public EntityCollection<tblNghiepVuSuaChuaLon> tblNghiepVuSuaChuaLons
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<tblNghiepVuSuaChuaLon>("PSC_ERPModel.FK_tblNghiepVuSuaChuaLon_tblNguon", "tblNghiepVuSuaChuaLon");
            }
            set
            {
                if ((value != null))
                {
    				...
    				if(!stopChanging)
    				{
    					((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<tblNghiepVuSuaChuaLon>("PSC_ERPModel.FK_tblNghiepVuSuaChuaLon_tblNguon", "tblNghiepVuSuaChuaLon", value);
