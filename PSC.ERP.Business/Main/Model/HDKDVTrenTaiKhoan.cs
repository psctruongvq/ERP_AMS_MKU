...
namespace PSC_ERP_Business.Main.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="PSC_ERPModel", Name="HDKDVTrenTaiKhoan")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class HDKDVTrenTaiKhoan : PSC_ERP_Core.BaseEntityObject//EntityObject
    {
    	public HDKDVTrenTaiKhoan()
    	{
        ...
        /// <summary>
        /// Create a new HDKDVTrenTaiKhoan object.
        /// </summary>
        /// <param name="maHopDong">Initial value of the MaHopDong property.</param>
        public static HDKDVTrenTaiKhoan CreateHDKDVTrenTaiKhoan(long maHopDong)
        {
            HDKDVTrenTaiKhoan hDKDVTrenTaiKhoan = new HDKDVTrenTaiKhoan();
            hDKDVTrenTaiKhoan.MaHopDong = maHopDong;
            return hDKDVTrenTaiKhoan;
        }
        ...
        partial void On_SoTien_Changing(string currentValue, ref string newValue, ref bool stopChanging);
        partial void On_SoTien_Changed(string oldValue, string currentValue);
        ...
        private Nullable<byte> _loai;
        partial void On_Loai_Changing(Nullable<byte> currentValue, ref Nullable<byte> newValue, ref bool stopChanging);
        partial void On_Loai_Changed(Nullable<byte> oldValue, Nullable<byte> currentValue);
