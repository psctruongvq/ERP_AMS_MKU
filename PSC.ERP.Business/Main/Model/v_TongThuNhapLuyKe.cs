...
namespace PSC_ERP_Business.Main.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="PSC_ERPModel", Name="v_TongThuNhapLuyKe")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class v_TongThuNhapLuyKe : PSC_ERP_Core.BaseEntityObject//EntityObject
    {
    	public v_TongThuNhapLuyKe()
    	{
        ...
        /// <summary>
        /// Create a new v_TongThuNhapLuyKe object.
        /// </summary>
        ...
        public static v_TongThuNhapLuyKe Createv_TongThuNhapLuyKe(int maBoPhan, long maNhanVien, string maQLNhanVien, decimal tongThuNhapThang, decimal luongCoBan, decimal luongHeSo, decimal thuLao, decimal phuCap, decimal khenThuong, decimal luongThamNien, decimal phuCapDocHai, decimal phuCapAnTrua, decimal trong200Gio)
        {
            v_TongThuNhapLuyKe v_TongThuNhapLuyKe = new v_TongThuNhapLuyKe();
            v_TongThuNhapLuyKe.MaBoPhan = maBoPhan;
            v_TongThuNhapLuyKe.MaNhanVien = maNhanVien;
            v_TongThuNhapLuyKe.MaQLNhanVien = maQLNhanVien;
            v_TongThuNhapLuyKe.TongThuNhapThang = tongThuNhapThang;
            v_TongThuNhapLuyKe.LuongCoBan = luongCoBan;
            v_TongThuNhapLuyKe.LuongHeSo = luongHeSo;
            v_TongThuNhapLuyKe.ThuLao = thuLao;
            v_TongThuNhapLuyKe.PhuCap = phuCap;
            v_TongThuNhapLuyKe.KhenThuong = khenThuong;
            v_TongThuNhapLuyKe.LuongThamNien = luongThamNien;
            v_TongThuNhapLuyKe.PhuCapDocHai = phuCapDocHai;
            v_TongThuNhapLuyKe.PhuCapAnTrua = phuCapAnTrua;
            v_TongThuNhapLuyKe.Trong200Gio = trong200Gio;
            return v_TongThuNhapLuyKe;
        }
