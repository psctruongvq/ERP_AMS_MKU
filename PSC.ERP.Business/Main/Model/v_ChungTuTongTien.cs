...
namespace PSC_ERP_Business.Main.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="PSC_ERPModel", Name="v_ChungTuTongTien")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class v_ChungTuTongTien : PSC_ERP_Core.BaseEntityObject//EntityObject
    {
    	public v_ChungTuTongTien()
    	{
        ...
        /// <summary>
        /// Create a new v_ChungTuTongTien object.
        /// </summary>
        /// <param name="maChungTu">Initial value of the MaChungTu property.</param>
        public static v_ChungTuTongTien Createv_ChungTuTongTien(long maChungTu)
        {
            v_ChungTuTongTien v_ChungTuTongTien = new v_ChungTuTongTien();
            v_ChungTuTongTien.MaChungTu = maChungTu;
            return v_ChungTuTongTien;
        }
