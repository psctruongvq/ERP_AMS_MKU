...
namespace PSC_ERP_Business.Main.Model
{
    ...
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="PSC_ERPModel", Name="v_CoTaiKhoan1551")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class v_CoTaiKhoan1551 : PSC_ERP_Core.BaseEntityObject//EntityObject
    {
    	public v_CoTaiKhoan1551()
    	{
        ...
        /// <summary>
        /// Create a new v_CoTaiKhoan1551 object.
        /// </summary>
        ...
        public static v_CoTaiKhoan1551 Createv_CoTaiKhoan1551(string soChungTu, int maChuongTrinh, int maButToan)
        {
            v_CoTaiKhoan1551 v_CoTaiKhoan1551 = new v_CoTaiKhoan1551();
            v_CoTaiKhoan1551.SoChungTu = soChungTu;
            v_CoTaiKhoan1551.MaChuongTrinh = maChuongTrinh;
            v_CoTaiKhoan1551.MaButToan = maButToan;
            return v_CoTaiKhoan1551;
        }
        ...
        [EdmScalarPropertyAttribute(EntityKeyProperty=false, IsNullable=true)]
        [DataMemberAttribute()]
        public Nullable<decimal> SoTienCo
        {
            get
            {
                return _soTienCo;
            ...
            set
            {
    			Nullable<decimal> oldValue =  _soTienCo;
    			bool stopChanging = false;
                On_SoTienCo_Changing(oldValue, ref value, ref stopChanging);
                ReportPropertyChanging("SoTienCo");
    			if(!stopChanging)
    			{
    				_soTienCo = StructuralObject.SetValidValue(value);
    				ReportPropertyChanged("SoTienCo");
    				On_SoTienCo_Changed(oldValue, _soTienCo);//\\
    			}
            }
        }
    	public static String SoTienCo_PropertyName { get { return "SoTienCo"; } }
        private Nullable<decimal> _soTienCo;
        partial void On_SoTienCo_Changing(Nullable<decimal> currentValue, ref Nullable<decimal> newValue, ref bool stopChanging);
        partial void On_SoTienCo_Changed(Nullable<decimal> oldValue, Nullable<decimal> currentValue);
