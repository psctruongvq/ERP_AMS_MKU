...
namespace PSC_ERP_Business.Main.Model
{
    ...
    /// </summary>
    [EdmComplexTypeAttribute(NamespaceName="PSC_ERPModel", Name="spd_TimFile_Result")]
    [DataContractAttribute(IsReference=true)]
    [Serializable()]
    public partial class spd_TimFile_Result : ComplexObject
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new spd_TimFile_Result object.
        /// </summary>
        /// <param name="bagId">Initial value of the BagId property.</param>
        public static spd_TimFile_Result Createspd_TimFile_Result(System.Guid bagId)
        {
            spd_TimFile_Result spd_TimFile_Result = new spd_TimFile_Result();
            spd_TimFile_Result.BagId = bagId;
            return spd_TimFile_Result;
        }
